...
## 💡 Supercharge Your LLM Development with Opik: The Open-Source Evaluation Platform

Opik, brought to you by [Comet](https://www.comet.com?from=llm&utm_source=opik&utm_medium=github&utm_content=what_is_opik_link&utm_campaign=opik), is your all-in-one solution for building, evaluating, and optimizing Large Language Model (LLM) applications, from RAG chatbots to complex agentic pipelines.

**Key Features:**

*   **Comprehensive Observability:**
    *   Deeply trace LLM calls, conversation logs, and agent activities for complete insight.
    *   Seamless integration with frameworks such as **Google ADK**, **Autogen**, and **Flowise AI**.
...
*   **Advanced Evaluation:**
    *   Robust prompt evaluation and experiment management to identify top performers.
    *   LLM-as-a-judge metrics for complex tasks such as [hallucination detection](https://www.comet.com/docs/opik/evaluation/metrics/hallucination/?from=llm&utm_source=opik&utm_medium=github&utm_content=hallucination_link&utm_campaign=opik) and RAG assessment.
...
*   **Production-Ready Monitoring and Optimization:**
    *   Scalable dashboards for production monitoring, capable of handling 40M+ traces/day.
    *   Online evaluation rules to identify production issues with LLM-as-a-Judge metrics.
...
Get started with Opik quickly!  Choose your preferred method:

### Option 1: Comet.com Cloud (Easiest & Recommended)

Use Opik instantly without any setup and enjoy hassle-free maintenance.
...
### Option 2: Self-Hosting (Docker & Kubernetes)

Deploy Opik in your environment for full control:
...
3.  Access Opik at [localhost:5173](http://localhost:5173). For detailed instructions, refer to the [Local Deployment Guide](https://www.comet.com/docs/opik/self-host/local_deployment?from=llm&utm_source=opik&utm_medium=github&utm_content=self_host_link&utm_campaign=opik).

#### Self-Hosting with Kubernetes & Helm (Scalable Deployments)

For production environments, install Opik on a Kubernetes cluster using our Helm chart.  See the [Kubernetes Installation Guide](https://www.comet.com/docs/opik/self-host/kubernetes/#kubernetes-installation?from=llm&utm_source=opik&utm_medium=github&utm_content=kubernetes_link&utm_campaign=opik).

[![Kubernetes](https://img.shields.io/badge/Kubernetes-%23326ce5.svg?&logo=kubernetes&logoColor=white)](https://www.comet.com/docs/opik/self-host/kubernetes/#kubernetes-installation?from=llm&utm_source=opik&utm_medium=github&utm_content=kubernetes_link&utm_campaign=opik)

> [!IMPORTANT]
> **Version 1.7.0 Changes**: Check the [changelog](https://github.com/comet-ml/opik/blob/main/CHANGELOG.md) for updates.

## 💻 Opik Client SDK

The Opik Client SDK and REST API allow for seamless integration. SDKs are available for Python, TypeScript, and Ruby (via OpenTelemetry). For references, see the [Opik Client Reference Documentation](apps/opik-documentation/documentation/fern/docs/reference/overview.mdx).
...
2.  **Configure the SDK:**
    ...
    Follow the prompts to configure for self-hosted instances or Comet.com. Alternatively, use  `opik.configure(use_local=True)` in your code for local instances. Refer to the [Python SDK documentation](apps/opik-documentation/documentation/fern/docs/reference/python-sdk/) for more options.

3.  Start logging traces!

### 📝 Logging Traces with Integrations

Simplify tracing with our direct integrations. Opik supports a wide array of frameworks:
...
| xAI Grok       | Log traces for xAI Grok LLM calls                       | [Documentation](https://www.comet.com/docs/opik/tracing/integrations/xai-grok?utm_source=opik&utm_medium=github&utm_content=xai-grok_link&utm_campaign=opik)             | (_Coming Soon_)                                                                                                                                                                                                                            |

> [!TIP]
>  If your framework is not listed, [open an issue](https://github.com/comet-ml/opik/issues) or submit a PR!

Not using a listed framework? Use the `@opik.track` decorator:
...
The Opik SDK includes LLM-as-a-judge metrics. Explore them in the [metrics documentation](https://www.comet.com/docs/opik/evaluation/metrics/overview/?from=llm&utm_source=opik&utm_medium=github&utm_content=metrics_2_link&utm_campaign=opik).
...
Evaluate during development with [Datasets](https://www.comet.com/docs/opik/evaluation/manage_datasets/?from=llm&utm_source=opik&utm_medium=github&utm_content=datasets_2_link&utm_campaign=opik)