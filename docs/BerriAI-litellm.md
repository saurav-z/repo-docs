...
<p align="center">
  <b>Easily call all LLM APIs using the OpenAI format, simplifying LLM integration and management.</b>  <br>
  <a href="https://github.com/BerriAI/litellm">View the original repository</a>
</p>
...
*   **Consistent Output:** Receive text responses in a standardized format: `['choices'][0]['message']['content']`.
*   **Intelligent Routing:** Implement retry/fallback logic across multiple deployments (e.g., Azure/OpenAI).
*   **Budget & Rate Limit Control:** Manage budgets and rate limits per project, API key, and model via the [LiteLLM Proxy Server (LLM Gateway)](https://docs.litellm.ai/docs/simple_proxy).
