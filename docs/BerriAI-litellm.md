...
🚨 **Stable Release:** Use Docker images with the `-stable` tag for rigorously tested versions.  [More on release cycles here](https://docs.litellm.ai/docs/proxy/release_cycle).
