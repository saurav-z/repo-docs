...
**InvenTree is a powerful, open-source solution for managing and tracking your inventory, parts, and stock.** ([View on GitHub](https://github.com/inventree/InvenTree))
...
*   **Mobile App:** Access stock control information and functionality.

Explore our website [https://inventree.org](https://inventree.org/) for more details.
...
InvenTree offers multiple options for seamless integration:
...
Choose from several deployment options to get InvenTree up and running:
...
For a quick installation, run the following command (refer to the [documentation](https://docs.inventree.org/en/latest/start/installer/) for supported distros and more details):

```bash
wget -qO install.sh https://get.inventree.org && bash install.sh
```

For detailed installation and setup instructions, see the [getting started guide](https://docs.inventree.org/en/latest/start/install/).
...
We are committed to providing a safe environment for all users; please review our [Code of Conduct](CODE_OF_CONDUCT.md).  Our [security policy](SECURITY.md) and dedicated security pages within our [documentation](https://docs.inventree.org/en/latest/security/) detail industry best practices for security.

## :wave: Contributing

We welcome and encourage contributions! Learn how to contribute on the [contribution page](https://docs.inventree.org/en/latest/develop/contributing/).

## :scroll: Translation

Help make InvenTree accessible to everyone by contributing native language translations via [Crowdin](https://crowdin.com/project/inventree).

## :money_with_wings: Sponsor

Support the project by [sponsoring](https://github.com/sponsors/inventree) and help us make InvenTree even better.

## :gem: Acknowledgements

We acknowledge [PartKeepr](https://github.com/partkeepr/PartKeepr) as a valuable inspiration. Find a full list of third-party libraries in the license information dialog of your instance.
...
This project is licensed under the [MIT](https://choosealicense.com/licenses/mit/) License. See [LICENSE.txt](https://github.com/inventree/InvenTree/blob/master/LICENSE) for more information.