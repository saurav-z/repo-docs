...
**Unlock the Power of Multimodal AI on Your Device: Introducing MiniCPM-V & MiniCPM-o**

</div>

**MiniCPM-V & MiniCPM-o** are a series of cutting-edge, efficient multimodal Large Language Models (MLLMs) designed for on-device deployment, offering state-of-the-art performance in understanding images, videos, text, and audio. This repository provides access to these powerful models, enabling you to build innovative AI applications for mobile and edge devices. Explore the original repo [here](https://github.com/OpenBMB/MiniCPM-V).

**Key Features:**

*   🚀 **On-Device Performance:** MiniCPM-V & MiniCPM-o are optimized for efficient deployment on mobile phones, tablets, and other edge devices.
*   🖼️ **Multimodal Understanding:** Process images, videos, text, and audio to generate high-quality text and speech outputs.
*   🗣️ **Speech and Audio Capabilities (MiniCPM-o):** Offers bilingual real-time speech conversation with configurable voices, voice cloning, and multimodal live streaming.
*   ⚡ **Efficiency and Speed:** Achieve fast inference and high token density for a smooth user experience.
*   💪 **Strong Performance:** Achieve GPT-4o level performance in various benchmarks.
*   🌐 **Multilingual Support:** Supports more than 30 languages.
*   🛠️ **Easy to Use:** Includes comprehensive documentation and support for popular inference frameworks.
...
**MiniCPM-V 4.5** is the latest iteration of the MiniCPM-V series, offering superior vision-language capabilities and new features designed for efficiency.

*   🔥 **State-of-the-art Vision-Language Capability:** Outperforms GPT-4o-latest, Gemini-2.0 Pro, and Qwen2.5-VL 72B in vision-language capabilities, making it the most performant MLLM under 30B parameters.
*   🎬 **Efficient High-FPS and Long Video Understanding:** Includes a new unified 3D-Resampler for high-FPS and long video understanding.
*   ⚙️ **Controllable Hybrid Fast/Deep Thinking:** Supports both fast and deep thinking modes for diverse use cases.
*   💪 **Strong OCR, Document Parsing and Others:** Achieves leading performance on OCRBench.
*   💫 **Easy Usage:** Easily used with llama.cpp, Ollama, SGLang, and vLLM, as well as the various quantization formats.

### Key Techniques

*   **Architecture: Unified 3D-Resampler for High-density Video Compression:** Processes up to 6 video frames into just 64 tokens.
*   **Pre-training: Unified Learning for OCR and Knowledge from Documents:** Adaptively switches between accurate text recognition and multimodal context-based knowledge reasoning.
*   **Post-training: Hybrid Fast/Deep Thinking with Multimodal RL:** Offers a balanced reasoning experience through two switchable modes: fast thinking for efficient daily use and deep thinking for complex tasks.
...
**MiniCPM-o 2.6** is the most capable model in the MiniCPM-o series, achieving outstanding results in visual understanding, speech, and multimodal live streaming.

*   🔥 **Leading Visual Capability:** Outperforms GPT-4o-202405, Gemini 1.5 Pro, and Claude 3.5 Sonnet for single image understanding.
*   🎙 **State-of-the-art Speech Capability:** Bilingual real-time speech conversation with configurable voices.
*   🎬 **Strong Multimodal Live Streaming Capability:**  Supports real-time speech interaction.
*   💪 **Strong OCR Capability and Others:** Achieves state-of-the-art performance on OCRBench.
*   🚀 **Superior Efficiency:**  Supports multimodal live streaming on end-side devices.
*   💫 **Easy Usage:** Accessible through various methods, including llama.cpp and vLLM.
