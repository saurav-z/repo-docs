# OpenBench: Unleash LLM Performance with Open-Source Benchmarking

**Tired of vendor lock-in for LLM evaluation?** OpenBench is a provider-agnostic, open-source evaluation infrastructure designed to benchmark language models across 30+ evaluation suites. Compare any LLM, from Groq to OpenAI, Anthropic, and local models, and easily push results to Hugging Face. Explore diverse benchmarks and gain deeper insights into model performance.

[![PyPI version](https://badge.fury.io/py/openbench.svg)](https://badge.fury.io/py/openbench)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)

[Visit the OpenBench GitHub Repository](https://github.com/groq/openbench)

**Key Features:**

*   **Provider-Agnostic:** Supports 30+ model providers, including Groq, OpenAI, Anthropic, and local models.
*   **Comprehensive Benchmarks:** Access 35+ benchmarks spanning knowledge, math, reasoning, coding, and more.
*   **Easy-to-Use CLI:** Simple commands for listing, describing, and evaluating models.
*   **Extensible:** Easily add new benchmarks and metrics.
*   **Local Evaluation Support:** Evaluate private models with your own customized benchmarks.
...
*   **New Benchmarks**: DROP (reading comprehension), and experimental benchmarks (with `--alpha` flag).
*   **Enhanced CLI**: Aliases, task/model flags, and a debug mode.
...
OpenBench seamlessly integrates with numerous LLM providers.  Set the appropriate API key environment variable and start evaluating!
...
Explore a diverse range of benchmarks to assess your models' capabilities. For a complete, up-to-date list, use the command `bench list`.
...
Customize your OpenBench experience with environment variables.
...
Access a suite of powerful commands to manage your evaluations.  Run `bench --help` for a comprehensive overview.
...
OpenBench is built on [Inspect AI](https://inspect.aisi.org.uk/), allowing you to create custom evaluations.  Refer to the Inspect AI [documentation](https://inspect.aisi.org.uk/) for details.  Once you've created private evaluations, you can run them with `bench eval <path>`.

## Exporting Logs to Hugging Face

Easily share and analyze your evaluation results by exporting logs to a Hugging Face Hub dataset.
...
This command exports the logs to a Hugging Face Hub dataset with the name `openbench-logs`.
...
OpenBench is a benchmark library built on Inspect AI's foundation.
...
We welcome contributions! See our [Contributing Guide](CONTRIBUTING.md) for instructions.
...
OpenBench aims for faithful benchmark implementations, but minor discrepancies may exist. Compare results within OpenBench versions for accurate comparisons. Contributions are welcome.
