...
**Maximize your LLM potential with MaxText, a cutting-edge, open-source framework engineered for high-performance training and inference on TPUs and GPUs.**

[Link to Original Repo](https://github.com/AI-Hypercomputer/maxtext)

## Key Features

*   **Accelerated Performance:** Achieve exceptional speed and efficiency in LLM training and inference, leveraging the power of JAX and XLA.
*   **Scalability:** Scale effortlessly from single-host setups to massive clusters, optimizing performance across Google Cloud TPUs and GPUs.
*   **Open-Source & Flexible:**  Built in pure Python/Jax, MaxText encourages customization and experimentation, providing a launching point for ambitious LLM projects.
*   **Model Support:** Train and deploy popular LLMs including Llama 2, Llama 3, Llama 4, Mistral, Mixtral, Gemma, DeepSeek, and Qwen3 families.
*   **Training and Inference:** Supports both LLM training and inference workloads.
...
Get started with MaxText by following the specific [instructions](getting_started/First_run.md) for your first run.
...
Find more details on reproducing these results in [MaxText/configs/README.md](MaxText/configs/README.md).
...
MaxText draws inspiration from projects like MinGPT/NanoGPT, while providing comparable or superior Model Flops Utilization (MFU) to Megatron-LM. Unlike other frameworks, MaxText is built in pure Python, relying on the XLA compiler for high performance.
