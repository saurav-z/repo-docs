...
**Maximize your LLM performance with MaxText, a cutting-edge, open-source framework designed for training and inference on TPUs and GPUs.** [View the repository on GitHub](https://github.com/AI-Hypercomputer/maxtext)

MaxText is a high-performance, highly scalable, open-source LLM written in pure Python/Jax and targeting Google Cloud TPUs and GPUs for training and inference. Leveraging the power of JAX and the XLA compiler, MaxText achieves exceptional performance, scaling from single-host to massive clusters while maintaining simplicity.

**Key Features:**

*   **TPU and GPU Support:** Train and run inference on Google Cloud TPUs (v5p, v5e) and GPUs.
*   **Training and Inference:** Comprehensive support for both model training and inference workloads.
*   **Model Compatibility:** Out-of-the-box support for a wide range of open-source models, including:
    *   Llama 2, Llama 3, Llama 4
    *   Mistral and Mixtral family
    *   Gemma, Gemma 2, Gemma 3
    *   DeepSeek
    *   Qwen3 Dense and MoE family
*   **Ahead-of-Time Compilation (AOT):** Improve training startup times and OOM detection with AOT compilation for both TPUs and GPUs.
*   **Comprehensive Diagnostics:** Features for debugging and monitoring your LLM training runs.
*   **Multi-Token Prediction (MTP) Training:** Enhance training efficiency with MTP.
*   **Modular Imports:** Uses an API change for modular imports from `train.py`.
...
*   **[April 7, 2025] 🚨🚨🚨 We support modular imports.**
...
Start your MaxText journey with the [First Run](getting_started/First_run.md) guide. This provides detailed instructions to get you up and running.
...
*   [Gemma (generations 1-3)](https://ai.google.dev/gemma): a family of open-weights Large Language Model (LLM) by [Google DeepMind](https://deepmind.google/), based on Gemini research and technology.
*   [Llama2](https://llama.meta.com/llama2/): a family of open-weights Large Language Model (LLM) by Meta.
*   [Mixtral](https://mistral.ai/news/mixtral-of-experts/): a family of open-weights sparse mixture-of-experts (MoE) models by Mistral AI.
*   [DeepSeek](https://api-docs.deepseek.com/news/news1226): a novel family of open-weights sparse MoE models by DeepSeek AI.

Explore the [end\_to\_end](end_to_end) tests and the [unit tests](.github/workflows/RunTests.yml) for insights into MaxText capabilities.
...
MaxText offers a compelling alternative to other LLM implementations, offering a high MFU and scalability.
