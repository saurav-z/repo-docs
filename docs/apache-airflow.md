# Apache Airflow: The Leading Platform for Workflow Orchestration

**Orchestrate, schedule, and monitor your workflows with Apache Airflow, the leading open-source platform built for programmatic authoring.**
...
Apache Airflow empowers you to define, schedule, and monitor complex data pipelines as code. This makes workflows more maintainable, versionable, testable, and collaborative.
...
*   **Flexible:** Customize your workflows using the powerful Jinja templating engine.
*   **Scalable:** Execute tasks on a distributed array of workers.
*   **User-Friendly UI:** Visualize pipelines, monitor progress, and troubleshoot issues through a rich web interface.

**Dive deeper into this powerful tool at the [official Apache Airflow GitHub repository](https://github.com/apache/airflow).**
...
Airflow excels with mostly static and slowly changing workflows, clarifying the unit of work and continuity.  Similar projects include Luigi, Oozie and Azkaban.

Airflow is commonly used to process data, though tasks should ideally be idempotent, and should not pass large quantities of data from one task to the next (though tasks can pass metadata using Airflow's [XCom feature](https://airflow.apache.org/docs/apache-airflow/stable/concepts/xcoms.html)).
