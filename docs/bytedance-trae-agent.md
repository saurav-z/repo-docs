...
**Trae Agent** is an innovative, open-source LLM-based agent designed to automate and accelerate software engineering tasks, offering a powerful and flexible CLI interface. Check out the original repo for the latest updates: [https://github.com/bytedance/trae-agent](https://github.com/bytedance/trae-agent)
...
Trae Agent offers a **research-friendly design** for building and experimenting with cutting-edge AI agent architectures for software engineering.

## Key Features

*   ✅ **Multi-LLM Support:** Seamlessly integrates with OpenAI, Anthropic, Doubao, Azure, OpenRouter, Ollama, and Google Gemini APIs.
*   🛠️ **Rich Tool Ecosystem:** Equips you with file editing, bash execution, sequential thinking, and a lot more tools.
*   💬 **Interactive Mode:** Engage in conversational development for iterative refinement of your projects.
*   📊 **Trajectory Recording:** Provides detailed logging of all agent actions for in-depth debugging and analysis.
*   ⚙️ **Flexible Configuration:** YAML-based configuration with environment variable support for ease of use.
