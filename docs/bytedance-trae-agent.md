...
**Trae Agent** is an innovative, LLM-based agent designed to streamline software engineering tasks, offering a powerful CLI interface to understand natural language instructions and automate complex workflows. Explore the future of software development with Trae Agent. ([Original Repository](https://github.com/bytedance/trae-agent))
...
Trae Agent's **research-friendly design** makes it an ideal platform for studying AI agent architectures and developing novel agent capabilities.

## Key Features

*   **Short & Concise Summarization**: 🌊 Lakeview provides concise summaries for agent steps.
*   **Multi-LLM Support**: 🤖 Works with OpenAI, Anthropic, Google Gemini, OpenRouter, Doubao, and Ollama APIs.
*   **Rich Tool Ecosystem**: 🛠️ Includes file editing, bash execution, sequential thinking, and more.
*   **Interactive Mode**: 🎯 Conversational interface for iterative development.
*   **Trajectory Recording**: 📊 Detailed logging of agent actions for debugging and analysis.
*   **Flexible Configuration**: ⚙️ YAML-based configuration with environment variable support.
...
Configure API keys using environment variables (store in `.env` file):
...
**Legacy JSON Configuration:** See [docs/legacy_config.md](docs/legacy_config.md) for migration.
