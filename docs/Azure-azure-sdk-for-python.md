...
**Simplify your Python development with the Azure SDK, a comprehensive library for interacting with Microsoft Azure services.** ([Original Repo](https://github.com/Azure/azure-sdk-for-python))
...
This repository is for the active development of the Azure SDK for Python. Leverage the power of Azure with our robust, easy-to-use Python SDK.  For detailed documentation, visit our [Azure SDK for Python documentation](https://aka.ms/python-docs) or versioned [developer docs](https://azure.github.io/azure-sdk-for-python).

## Key Features

*   **Comprehensive Service Coverage:** Access a wide range of Azure services, including storage, compute, networking, and more.
*   **Simplified Development:**  Use intuitive, Pythonic APIs to interact with Azure resources.
*   **Client Libraries:** Utilize dedicated libraries for specific Azure services for a more focused development experience.
*   **Core Functionality:** Benefit from shared features like retries, logging, authentication, and transport protocols.
*   **Management Libraries:** Provision and manage your Azure resources using the latest management libraries, following Azure SDK Design Guidelines.

## Getting Started

Each service has a separate set of libraries that you can choose to use. To get started with a specific library, see the `README.md` (or `README.rst`) file located in the library's project folder. You can find service libraries in the `/sdk` directory.
...
A new set of management libraries that follow the [Azure SDK Design Guidelines for Python](https://azure.github.io/azure-sdk/python/guidelines/) are now available. These new libraries provide a number of core capabilities that are shared amongst all Azure SDKs, including the intuitive Azure Identity library, an HTTP Pipeline with custom policies, error-handling, distributed tracing, and much more. Documentation and code samples for these new libraries can be found [here](https://aka.ms/azsdk/python/mgmt). In addition, a migration guide that shows how to transition from older versions of libraries is located [here](https://github.com/Azure/azure-sdk-for-python/blob/main/doc/sphinx/mgmt_quickstart.rst#migration-guide).
