...
RoboVerse is a comprehensive platform, dataset, and benchmark designed to advance robot learning, offering a robust toolkit for researchers and developers. [Visit the original repository](https://github.com/RoboVerseOrg/RoboVerse).

**Key Features:**

*   **Unified Platform:** Provides a central hub for robot learning research, integrating various simulation environments and tools.
*   **Comprehensive Dataset:** Includes a rich dataset to facilitate training and evaluation of robot learning algorithms.
*   **Benchmarking Capabilities:** Offers standardized benchmarks for comparing and evaluating the performance of different robot learning approaches.
*   **Multiple Simulation Frameworks:** Integrates with popular simulators like Isaac Lab, Isaac Gym, MuJoCo, SAPIEN, PyBullet, and more.
*   **Extensive Integration:** Leverages data from various projects, including RLBench, ManiSkill, Meta-World, and others, for diverse task support.

## 🚀 Getting Started

Explore the [documentation](https://roboverse.wiki/metasim/#) and [tutorials](https://roboverse.wiki/metasim/get_started/quick_start/0_static_scene) to begin using RoboVerse.
...
Share feature requests, new simulator support, or new tasks on the [GitHub Discussions](https://github.com/RoboVerseOrg/RoboVerse/discussions/categories/wish-list) and upvote your favorite ideas.
