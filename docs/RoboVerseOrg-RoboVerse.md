...
*   **Unified Platform:** Provides a single, integrated environment for robot learning research.
*   **Comprehensive Dataset:** Includes a rich dataset to train and evaluate robot learning algorithms.
*   **Robust Benchmark:**  Offers a standardized benchmark for comparing and assessing different approaches.
*   **Supports Multiple Simulators:** Compatible with Isaac Lab, Isaac Gym, MuJoCo, SAPIEN, PyBullet, Genesis, cuRobo, and PyRep.
*   **Integrates with Leading Projects:**  Leverages data and resources from projects like RLBench, Maniskill, Meta-World, and others.
*   **Open Source and Community Driven:** Actively welcomes contributions and feedback to foster collaborative development.

## 🚀 Getting Started

Begin your journey with RoboVerse using the detailed [documentation](https://roboverse.wiki/metasim/#).

Explore our detailed [tutorials](https://roboverse.wiki/metasim/get_started/quick_start/0_static_scene) for a quick start.
...
Share your feature requests on our [GitHub Discussions](https://github.com/RoboVerseOrg/RoboVerse/discussions/categories/wish-list) and upvote those you find most relevant.

## 📖 License and Acknowledgments

RoboVerse is licensed under the Apache License 2.0.

We utilize the following simulation frameworks, renderers, and libraries:
