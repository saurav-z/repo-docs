...
## Mealie: Your Ultimate Self-Hosted Recipe Manager

Mealie is the perfect open-source solution for organizing your recipes, planning meals, and generating shopping lists, all in one convenient platform.  [Check it out on GitHub!](https://github.com/mealie-recipes/mealie)

### Key Features

*   **Recipe Import:** Easily create recipes by importing directly from a URL or by entering data manually.
*   **Meal Planner:**  Plan your weekly meals with the intuitive Meal Planner feature.
*   **Shopping List:** Generate and organize your shopping lists, categorized by supermarket sections.
*   **Cookbooks:**  Group and categorize your recipes into custom cookbooks.
...
- [Report Bug](https://github.com/mealie-recipes/mealie/issues)
...
Contributions are welcome! Whether you're a coder or not, there are ways to get involved.

*   Refer to the [Contributors Guide](https://nightly.mealie.io/contributors/developers-guide/code-contributions/) for information.
*   Use [VSCode Dev Containers](https://code.visualstudio.com/docs/remote/containers) for easy development setup.
*   Financial contributions are appreciated via [Buy Me a Coffee](https://www.buymeacoffee.com/haykot).
*   Contribute to Translations via [Crowdin](https://crowdin.com/project/mealie).
