...
## Mealie: Your All-in-One Recipe Manager

**Mealie is a self-hosted recipe manager and meal planner that simplifies cooking and helps you organize your favorite recipes.**
...
*   **Effortless Recipe Import:** Easily add recipes by importing from a URL or entering data manually.
*   **Meal Planning Made Simple:** Plan your meals for the week with the intuitive Meal Planner.
...
*   **Multilingual Support:** Enjoy Mealie in 35+ languages.

**[Visit the Mealie GitHub Repository](https://github.com/mealie-recipes/mealie) to get started!**

## Contributing

Contributions are welcome and encouraged! Please see the [Contributors Guide](https://nightly.mealie.io/contributors/developers-guide/code-contributions/) for details.

**Ways to Contribute:**

*   **Code Contributions:** Review the [VSCode Dev Containers](https://code.visualstudio.com/docs/remote/containers) guide to get started.
*   **Financial Contributions:** Support the project through [Buy Me a Coffee](https://www.buymeacoffee.com/haykot).
*   **Translations:** Help translate Mealie into new languages on [Crowdin](https://crowdin.com/project/mealie).  See the [translation page](https://nightly.mealie.io/contributors/translating/) for more information.
...
A big thank you to all the sponsors of this project on [Github Sponsors](https://github.com/sponsors/hay-kot) and Buy Me a Coffee.
