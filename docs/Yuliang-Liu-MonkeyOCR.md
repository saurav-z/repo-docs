# MonkeyOCR: Unleash the Power of Advanced Document Parsing

**MonkeyOCR empowers you to effortlessly parse documents with its cutting-edge Structure-Recognition-Relation (SRR) triplet paradigm, delivering superior accuracy and speed in document understanding. [Check out the original repo](https://github.com/Yuliang-Liu/MonkeyOCR)!**
...
*   **Superior Accuracy:** MonkeyOCR excels in accurately parsing both English and Chinese documents.
*   **Fast Performance:** Achieve high-speed document processing with the SRR paradigm, outperforming many competitors.
*   **Optimized Models:** Choose from MonkeyOCR-pro-1.2B and MonkeyOCR-pro-3B for optimal speed and accuracy.
*   **Competitive Benchmarks:** Outperforms leading closed-source and open-source VLMs on various benchmarks.
*   **User-Friendly:** Easy to install, use, and integrate into your projects.
*   **Versatile Deployment:** Supports local installation, Gradio demo, Docker, and FastAPI for flexible usage.

## Performance Highlights

*   MonkeyOCR-pro-1.2B shows significant performance improvements over MonkeyOCR-3B in speed and efficiency.
*   MonkeyOCR models consistently outperform other tools.
*   MonkeyOCR-pro-3B achieves the best overall performance on OmniDocBench across English and Chinese documents, surpassing even advanced VLMs.
...
MonkeyOCR supports a wide range of GPUs, including 3090, 4090, A6000, H800, A100, and even 4060 (for quantized 3B and 1.2B models). The open-source community has also successfully run the model on 50-series GPUs, H200, L20, V100, 2080 Ti, and NPU.

## News

*   **2025.07.10:** 🚀 MonkeyOCR-pro-1.2B released, a leaner, faster version.
*   **2025.06.12:** 🚀 Trending on Hugging Face!
*   **2025.06.05:** 🚀 MonkeyOCR released, supporting English and Chinese document parsing.
...
Parse PDFs or images with the following commands:
...
1.  **Processed Markdown File** (`your.md`):  Markdown format containing text, formulas, tables, and structured elements.
2.  **Layout Results** (`your_layout.pdf`): Layout results drawn on the original PDF.
3.  **Intermediate Block Results** (`your_middle.json`): JSON file with block details, coordinates, and relationships.
