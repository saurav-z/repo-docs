...
**InfiniteTalk revolutionizes video generation by enabling unlimited-length talking videos driven by audio inputs.**  This innovative framework allows users to create videos with accurate lip synchronization, and consistent identity preservation, from audio and video or image inputs.
...
*   ✨ **Stability:** Reduces hand/body distortions compared to other methods, resulting in more reliable video outputs.
*   🚀 **Lip Accuracy:** Offers superior lip synchronization compared to existing solutions.
*   🖼️ **Image-to-Video Generation:** Seamlessly transforms images into talking videos.

## Latest News

*   **August 19, 2025:** Release of the [Technical Report](https://arxiv.org/abs/2508.14033), model weights, and code, including Gradio and [ComfyUI](https://github.com/MeiGen-AI/InfiniteTalk/tree/comfyui) support.
*   **August 19, 2025:** Launch of the [project page](https://meigen-ai.github.io/InfiniteTalk/).

## Community Works

*   [Wan2GP](https://github.com/deepbeepmeep/Wan2GP/): Integration of InfiniteTalk with Wan2GP, optimized for low VRAM and offering various video editing and model integrations.
