# Pycord: A Modern and Feature-Rich Python Library for Discord Bots

**Pycord** is a powerful and easy-to-use Python library designed to help you build sophisticated and engaging Discord bots.  ([View on GitHub](https://github.com/Pycord-Development/pycord))
...
*   **Asynchronous Programming:** Built on `async` and `await` for efficient and responsive bot development.
...
*   **Comprehensive API Support:** Full access to Discord's application API.
...
**Install for aiohttp and JSON speedup**
...
**Important for Voice Support on Linux:** Before installing with voice support, install these packages using your system's package manager:
...
Always keep your bot token secure and never share it. It grants access to your bot.
...
*   [Translations](https://translations.pycord.dev/documentation/)
