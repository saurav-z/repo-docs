# Access a Treasure Trove of Free Public APIs

Looking for a wide variety of free APIs to use in your projects?  **This repository, curated by the community, offers an extensive and up-to-date collection of public APIs spanning numerous domains, from weather and finance to entertainment and social media, with a link to the original repo [here](https://github.com/public-apis/public-apis).** It's a valuable resource for developers, students, and anyone looking to integrate data and functionality into their applications.

## Key Features:

*   **Extensive List:** Access a huge collection of APIs across diverse categories.
*   **Community Curated:** Maintained by a dedicated community, ensuring quality and relevance.
*   **Free to Use:**  Most APIs are free to use, making it easy to experiment and build.
*   **Organized by Category:** Browse and find APIs based on your specific needs.
*   **Constantly Updated:** The repository is regularly updated to include new APIs and keep existing ones current.
...
*   [Join our Discord server](https://discord.com/invite/hgjA78638n/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo) to get updates, ask questions, and connect with the community.
*   [Learn more about Public APIs](CONTRIBUTING.md) and get involved in contributing to the project.
*   [API for this project](https://github.com/davemachado/public-api) to learn more about the backend.
...
| [Mailchimp](https://mailchimp.com/developer/)          | Send marketing campaigns