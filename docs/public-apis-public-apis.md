# Discover and Integrate Public APIs for Free: A Comprehensive Guide

**Unlock a treasure trove of free, publicly available APIs for your next project with the Public APIs repository!** Curated by a dedicated community and supported by [APILayer](https://apilayer.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo), this resource offers an extensive list of APIs from diverse domains, empowering developers to build innovative applications.
...
Looking for a fast and easy way to integrate APIs into any product? Explore [APILayer APIs](https://apilayer.com/products/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo).

Join our [Discord server](https://discord.com/invite/hgjA78638n/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo) for updates, support, community discussions, and more!

## Key Features:

*   **Vast Selection:** Access a wide range of APIs across various categories, catering to diverse development needs.
*   **Free Access:** Explore and integrate public APIs without incurring significant costs, enabling rapid prototyping and experimentation.
*   **Community-Driven:** Benefit from a continuously updated and well-maintained repository, thanks to the active contributions of the developer community.
*   **Diverse Domains:** Discover APIs related to Animals, Anime, Anti-Malware, Art & Design, Authentication & Authorization, Blockchain, Books, Business, Calendar, and more!
*   **Organized Structure:** Easily navigate the categorized list to find the APIs you need quickly.

## Featured APILayer APIs:

*   **IPstack:** [IPstack](https://ipstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) Locate and Identify Website Visitors by IP Address
*   **Marketstack:** [Marketstack](https://marketstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) Delivers worldwide stock market data in JSON format
*   **Weatherstack:** [Weatherstack](https://weatherstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) Retrieve instant, accurate weather information for any location in the world in lightweight JSON format
*   **Numverify:** [Numverify](https://numverify.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers ) Global Phone Number Validation & Lookup JSON API
*   **Fixer:** [Fixer](https://fixer.io/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) Simple and lightweight API for current and historical foreign exchange (forex) rates.
*   **Aviationstack:** [Aviationstack](https://avaitionstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) Real-time flight status and global Aviation data API

## Learn More:

*   [Browse the API list](#index)
*   [Get Involved: Contributing Guide](CONTRIBUTING.md)
