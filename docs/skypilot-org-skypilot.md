...
SkyPilot is an open-source framework that simplifies and optimizes running AI and batch workloads across various cloud providers and infrastructure, saving you time and money.  [**View the original repository**](https://github.com/skypilot-org/skypilot).

**Key Features:**

*   **Unified Infrastructure:** Run workloads on 16+ clouds, Kubernetes, and more through a single interface.
*   **Simplified Deployment:** Easily spin up compute resources with environment and job-as-code portability.
*   **Cost Optimization:**  Leverage auto-stop for idle resources and spot instance support for significant cost savings.
*   **Intelligent Scheduling:**  Automatically run jobs on the most affordable and available infrastructure.
*   **Flexibility and Control:** Supports your existing GPU, TPU, and CPU workloads with no code changes.
...
### Quickstart: Run a PyTorch Training Job

A SkyPilot task defines resource needs, data sync, setup commands, and job commands. Here's how to get a job running in minutes.

1.  **Define your task (e.g., `my_task.yaml`):**
...
1.  Finding the most cost-effective instance across clouds.
2.  Provisioning the VM, with automatic failover.
3.  Syncing your work directory.
4.  Running setup and execution commands.

For more details, see the [Quickstart](https://docs.skypilot.co/en/latest/getting-started/quickstart.html).
...
Find more examples and source files in the [`llm/`](https://github.com/skypilot-org/skypilot/tree/master/llm) and [`examples/`](https://github.com/skypilot-org/skypilot/tree/master/examples) directories.
...
**Community Spotlights:**  [Case studies and integrations](https://blog.skypilot.co/community/)
