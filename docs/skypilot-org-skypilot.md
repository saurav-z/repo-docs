...
## SkyPilot: Run AI on Any Cloud, Faster & Cheaper

SkyPilot is an open-source framework that simplifies running AI workloads across various cloud providers, Kubernetes clusters, and hardware, optimizing cost and accelerating deployment. [**Check out the original repo!**](https://github.com/skypilot-org/skypilot)

**Key Features:**

*   **Unified Cloud Interface:** Run your AI workloads seamlessly across 16+ clouds, Kubernetes, and on-premise infrastructure.
*   **Cost Optimization:** Reduce cloud costs with spot instance support and intelligent scheduling.
*   **Simplified Deployment:** Deploy AI applications quickly with environment and job-as-code.
*   **Flexible Resource Management:** Provision GPUs, TPUs, and CPUs with automatic retries and team deployment features.
*   **Automatic Resource Management:** Autostop idle resources to save costs.
...
SkyPilot simplifies running your AI and batch workloads by providing a unified interface. It supports multiple clusters, clouds, and hardware, allowing you to optimize costs and maximize GPU availability.
...
SkyPilot simplifies your workflow by allowing you to define tasks with resource requirements, data, setup, and commands in a unified YAML or Python API.  These tasks can then be launched on any cloud provider without vendor lock-in.
...
See the [Quickstart](https://docs.skypilot.co/en/latest/getting-started/quickstart.html) to get started.

## Runnable Examples

Explore [SkyPilot examples](https://docs.skypilot.co/en/docs-examples/examples/index.html) covering development, training, serving, LLM models, AI apps, and frameworks.
...
SkyPilot originated at the [Sky Computing Lab](https://sky.cs.berkeley.edu) at UC Berkeley and has a growing list of industry contributors.
