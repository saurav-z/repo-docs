...
CAMEL is an open-source framework designed to facilitate research on multi-agent systems, offering tools and resources to explore agent behaviors, capabilities, and potential risks.  Discover more at the [CAMEL-AI Website](https://www.camel-ai.org/) or explore the source code on [GitHub](https://github.com/camel-ai/camel).

### Key Features

*   **Large-Scale Agent Systems:** Simulate up to a million agents.
*   **Dynamic Communication:** Enable real-time interactions for complex tasks.
*   **Stateful Memory:** Equip agents with historical context for improved decision-making.
*   **Code-as-Prompt:** Leverage clear, readable code for human and agent interpretation.
*   **Extensive Tool Integration:** Easily integrate and utilize external tools within your agent systems.
*   **Community-Driven:** Join a vibrant community of researchers.
...
CAMEL is a community-driven research collective with over 100 researchers dedicated to advancing multi-agent system research. Researchers worldwide choose CAMEL for its advantages:
...
Get started quickly with CAMEL using PyPI:
...
This example shows how to create and use a `ChatAgent` with DuckDuckGo search:
...
CAMEL empowers various real-world applications:

### 1 Infrastructure Automation

| Usecase                                                                              | Description                                                                          |
| :----------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------- |
| **[ACI MCP](https://github.com/camel-ai/camel/tree/master/examples/usecases/aci_mcp)**     | Automate network configurations and management with intelligent agents.                |
| **[Cloudflare MCP CAMEL](https://github.com/camel-ai/camel/tree/master/examples/usecases/cloudfare_mcp_camel)** | Utilize intelligent agents to manage Cloudflare resources, for improved security and performance. |
...
| **[PPTX Toolkit Usecase](https://github.com/camel-ai/camel/tree/master/examples/usecases/pptx_toolkit_usecase)** | Analyze and extract structured insights from PowerPoint documents.               |

### 3 Retrieval-Augmented Multi-Agent Chat

| Usecase                                                                                     | Description                                                                           |
| :------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------ |
| **[Chat with GitHub](https://github.com/camel-ai/camel/tree/master/examples/usecases/chat_with_github)** | Query and understand GitHub codebases using RAG-style workflows.                     |
| **[Chat with YouTube](https://github.com/camel-ai/camel/tree/master/examples/usecases/chat_with_youtube)** | Enable conversational agents to extract and summarize YouTube video transcripts.       |

### 4 Video & Document Intelligence

| Usecase                                                                             | Description                                                                 |
| :---------------------------------------------------------------------------------- | :-------------------------------------------------------------------------- |
| **[YouTube OCR](https://github.com/camel-ai/camel/tree/master/examples/usecases/youtube_ocr)**   | Summarize video content by performing OCR on video screenshots.            |
| **[Mistral OCR](https://github.com/camel-ai/camel/tree/master/examples/usecases/mistral_OCR)** | Analyze documents using OCR with Mistral, enhancing document understanding. |

### 5 Research & Collaboration

| Usecase                                                                                      | Description                                                                    |
| :------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------- |
| **[Multi-Agent Research Assistant](https://github.com/camel-ai/camel/tree/master/examples/usecases/multi_agent_research_assistant)** | Simulate research teams to improve exploratory analysis and reporting efficiency. |
