...
# CAMEL: The Multi-Agent Framework for AI Research & Development

**CAMEL empowers researchers and developers to explore the scaling laws of agents, offering tools and resources to build and study complex multi-agent systems.** Learn more at [https://github.com/camel-ai/camel](https://github.com/camel-ai/camel).
...
*   **Large-Scale Agent Systems:** Simulate and analyze up to 1 million agents to study emergent behaviors and scaling laws.
*   **Dynamic Communication:** Facilitate real-time interactions between agents for seamless collaboration on intricate tasks.
*   **Stateful Memory:** Equip agents with memory to retain context and make informed decisions across interactions.
*   **Code-as-Prompt:** Utilize code and comments as prompts to guide agent actions.
*   **Diverse Agent Types & Benchmarks:** Experiment with various agent roles, tasks, models, environments, and standardized benchmarks.
*   **Data Generation & Tool Integration:** Automate the creation of datasets and integrate with various tools.

<br>

## Why Choose CAMEL?

CAMEL is a community-driven research collective with 100+ researchers dedicated to advancing multi-agent systems. Here's why researchers choose CAMEL:

*   **Large-Scale Agent System:** Simulate up to 1M agents.
*   **Dynamic Communication:** Enable real-time interactions among agents.
*   **Stateful Memory:** Empower agents with historical context.
*   **Multiple Benchmarks:** Utilize standardized benchmarks for rigorous evaluation.
*   **Diverse Agent Types:** Support a variety of agent roles.
*   **Data Generation and Tool Integration:** Streamline synthetic data generation.
...
3.  **Run the Python code:**
    ...
    ```
For more detailed instructions, see the [installation section](https://github.com/camel-ai/camel/blob/master/docs/get_started/installation.md).  Explore the [CAMEL Tech Stack and Cookbooks](https://docs.camel-ai.org) for advanced features and use cases.
...
Core components to build, operate, and enhance CAMEL-AI agents and societies:
...
> Studying agents on a large scale offers valuable insights into their behaviors, capabilities, and potential risks.
...
| **[Customer Service Discord Bot with Local Model](https://docs.camel-ai.org/cookbooks/applications/customer_service_Discord_bot_using_local_model_with_agentic_RAG.html)** | Learn how to build a robust customer service bot for Discord supporting local deployment |
...
| **[3 Ways to Ingest Data from Websites with Firecrawl](https://docs.camel-ai.org/cookbooks/data_processing/ingest_data_from_websites_with_Firecrawl.html)** | Explore three methods for extracting and processing data from websites. |
...
CAMEL's multi-agent framework provides real business value across infrastructure automation, productivity workflows, retrieval-augmented conversations, intelligent document/video analysis, and collaborative research:

### 1 Infrastructure Automation

| Usecase                                                                      | Description                                                                |
| :---------------------------------------------------------------------------- | :------------------------------------------------------------------------- |
| **[ACI MCP](https://github.com/camel-ai/camel/tree/master/examples/usecases/aci_mcp)**  | Intelligent agents for Cisco ACI network configuration and management.      |
...
| Usecase                                                                       | Description                                                     |
| :----------------------------------------------------------------------------- | :-------------------------------------------------------------- |
| **[Chat with GitHub](https://github.com/camel-ai/camel/tree/master/examples/usecases/chat_with_github)**  | Understand GitHub codebases through RAG-style workflows.       |
...
| Usecase                                                                        | Description                                                               |
| :------------------------------------------------------------------------------ | :------------------------------------------------------------------------ |
| **[YouTube OCR](https://github.com/camel-ai/camel/tree/master/examples/usecases/youtube_ocr)**  | Summarize video content through OCR of screenshots.                    |
| **[Mistral OCR](https://github.com/camel-ai/camel/tree/master/examples/usecases/mistral_OCR)** | Analyze documents using OCR with Mistral, reducing manual effort.        |

### 5 Research & Collaboration

| Usecase                                                                        | Description                                                                    |
| :------------------------------------------------------------------------------ | :----------------------------------------------------------------------------- |
| **[Multi-Agent Research Assistant](https://github.com/camel-ai/camel/tree/master/examples/usecases/multi_agent_research_assistant)** | Simulate a team of research agents for literature review and reporting. |
...
> Join us on [Discord](https://discord.com/invite/CNcNpquyDc) or in our [Ambassador Program](https://www.camel-ai.org/ambassador)

## Contributing to CAMEL

Contribute code and help grow the community! See our [contributing guidelines](https://github.com/camel-ai/camel/blob/master/CONTRIBUTING.md) for details. Share CAMEL on social media!🚀
...
*   **WeChat Community:** Scan the QR code to join.
...
Special thanks to [Nomic AI](https://home.nomic.ai/) for providing access to their dataset exploration tool (Atlas).

We appreciate Haya Hammoud for designing the initial logo.

We cite the original works of the following research ideas:
