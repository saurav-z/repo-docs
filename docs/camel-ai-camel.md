...
## CAMEL: Build and Study Multi-Agent Systems with Ease

CAMEL is an open-source framework for building and studying multi-agent systems, enabling researchers and developers to explore the cutting edge of agent capabilities.  Explore the [original CAMEL repo](https://github.com/camel-ai/camel) to get started.
...
*   **Dynamic Communication:** Enable real-time interactions among agents for complex task collaboration.
*   **Stateful Memory:** Equip agents with memory to retain and leverage historical context for improved decision-making.
*   **Code-as-Prompt:**  Leverage code and comments as prompts for clear and effective agent understanding.
*   **Comprehensive Benchmarks:** Evaluate agent performance using standardized benchmarks for reproducibility.
*   **Diverse Agent Types:** Work with various agent roles, tasks, models, and environments, supporting interdisciplinary research.
...
The CAMEL framework offers a powerful and flexible platform for researchers exploring the frontiers of multi-agent systems.  Our community-driven approach ensures that researchers worldwide benefit from:
...
CAMEL empowers you to build a wide array of applications:
...
Get started with CAMEL by following these simple steps:
...
This example demonstrates creating a `ChatAgent` using the CAMEL framework and performing a search query using DuckDuckGo.
...
For detailed instructions and configuration options, explore the [installation section](https://github.com/camel-ai/camel/blob/master/docs/get_started/installation.md).
...
Please reach out to us on [CAMEL discord](https://discord.camel-ai.org/) if you encounter any issues.
...
CAMEL supports a variety of research projects. Explore our research:
...
Explore our datasets for training and evaluation:
...
Explore our comprehensive cookbooks with practical guides and tutorials:
...
| Cookbook | Description |
|:---|:---|
| **[Data Generation with CAMEL and Finetuning with Unsloth](https://docs.camel-ai.org/cookbooks/data_generation/sft_data_generation_and_unsloth_finetuning_Qwen2_5_7B.html)** | Generating data and fine-tuning models with Unsloth. |
| **[Data Gen with Real Function Calls and Hermes Format](https://docs.camel-ai.org/cookbooks/data_generation/data_gen_with_real_function_calls_and_hermes_format.html)** | Data generation with function calls and the Hermes format. |
...
| **[CoT Data Generation and SFT Qwen with Unsolth](https://docs.camel-ai.org/cookbooks/data_generation/cot_data_gen_sft_qwen_unsolth_upload_huggingface.html)** | Generate CoT data with CAMEL and SFT Qwen with Unsolth, and upload your data and model to Huggingface. |
...
| **[Create A Hackathon Judge Committee with Workforce](https://docs.camel-ai.org/cookbooks/multi_agent_society/workforce_judge_committee.html)** | Building a team of agents for judging. |
...
| **[Customer Service Discord Bot with Local Model](https://docs.camel-ai.org/cookbooks/applications/customer_service_Discord_bot_using_local_model_with_agentic_RAG.html)** | Build a customer service bot for Discord with local model support. |
...
| **[Create AI Agents that work with your PDFs](https://docs.camel-ai.org/cookbooks/data_processing/agent_with_chunkr_for_pdf_parsing.html)** | Create AI agents that work with PDFs. |
...
| **[Mistral OCR](https://github.com/camel-ai/camel/tree/master/examples/usecases/mistral_OCR)** | Use OCR with Mistral for document analysis. |
...
> Want to host or participate in a CAMEL event? Join our [Discord](https://discord.com/invite/CNcNpquyDc) or [Ambassador Program](https://www.camel-ai.org/ambassador).

## Contributing to CAMEL

> Review our [contributing guidelines](https://github.com/camel-ai/camel/blob/master/CONTRIBUTING.md) to get involved.🚀
>
...
-   **Discord:** Real-time support and community chat. [Join us](https://discord.camel-ai.org/)
...
If you use any modules, please kindly cite the original works:
...
*   **Concise Title:**  "CAMEL: Build and Study Multi-Agent Systems with Ease" immediately tells the user what the project is about.
*   **One-Sentence Hook:** The opening sentence provides a clear and compelling overview.
*   **Clear Headings:** Use of `##` and `###` for organized structure.
*   **Keyword Optimization:** Includes relevant keywords throughout the document (e.g., "multi-agent systems," "agents," "research," "framework").
*   **Bulleted Lists:** Uses bullet points for key features and benefits, making the information easy to scan.
*   **Action-Oriented Language:**  Uses verbs like "Build," "Study," "Explore" to encourage engagement.
*   **Links Back to Repo:** Includes a link to the original repository.
*   **Complete Coverage:**  Addresses all the content from the original README, and adds headings.
*   **SEO-Friendly Titles and Descriptions:** Clear and concise titles.
*   **Emphasis on Benefits:** Highlights *why* a user should use CAMEL.
*   **Clear Calls to Action:** Encour