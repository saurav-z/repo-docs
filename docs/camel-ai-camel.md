...
**CAMEL** is an open-source framework designed to facilitate research on multi-agent systems built with Large Language Models (LLMs), enabling you to explore the scaling laws of agents. [Explore the CAMEL repository](https://github.com/camel-ai/camel) to build powerful multi-agent systems!
...
<div align="center">
  Join our vibrant community on [Discord](https://discord.camel-ai.org/) or [WeChat](https://ghli.org/camel/wechat.png) to push the boundaries of agent research.
  <br>
  🌟 Star CAMEL on GitHub to stay updated on new releases and projects!
</div>
...
- [Why Use CAMEL?](#why-use-camel-for-your-research)
...
- [Synthetic Datasets](#synthetic-datasets)
    - [1. Utilize Various LLMs as Backends](#1-utilize-various-llms-as-backends)
    - [2. Visualizations of Instructions and Tasks](#2-visualizations-of-instructions-and-tasks)
...
*   **Large-Scale Agent Systems:** Simulate up to millions of agents for emergent behavior and scaling laws research.
*   **Dynamic Communication:** Facilitate real-time interactions and collaboration among agents.
*   **Stateful Memory:** Equip agents with memory for improved decision-making in multi-step interactions.
*   **Code-as-Prompt:** Use clear, readable code to guide and interact with agents.
*   **Diverse Agent Support:** Work with various agent roles, tasks, models, and environments.
*   **Data Generation and Tool Integration:** Automate dataset creation and integrate multiple tools for research workflows.
...
CAMEL is a community-driven research platform with a vibrant community of 100+ researchers. CAMEL provides the following:
...
This example demonstrates how to create a `ChatAgent` and perform a search query.

1.  **Install web tools package:**
...
Encounter issues? Get help on [CAMEL discord](https://discord.camel-ai.org/).
...
Explore our research projects to understand the power of multi-agent systems!
...
> We welcome code contributions! Review our [contributing guidelines](https://github.com/camel-ai/camel/blob/master/CONTRIBUTING.md) to get started.
>
> Also, share CAMEL on social media, at events, or during conferences. Your support matters!
...
*   **Discord:** Real-time support, community chat, and updates. [Join us](https://discord.camel-ai.org/)
...
@inproceedings{li2023camel,
  ...
  author={Li, Guohao and Hammoud, Hasan Abed Al Kader and Itani, Hani and Kh