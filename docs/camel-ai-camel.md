...
**CAMEL is an open-source framework for building and exploring multi-agent systems, providing tools and resources to accelerate your research and development in the field of artificial intelligence.** Explore the original repository at [https://github.com/camel-ai/camel](https://github.com/camel-ai/camel).
...
<div align="center">
  <p style="line-height: 1.5; text-align: center;">
    CAMEL empowers you to build and explore complex multi-agent systems, offering various agents, tasks, prompts, models, and simulated environments. Join our community on
    <a href="https://discord.camel-ai.org/">Discord</a> or <a href="https://ghli.org/camel/wechat.png">WeChat</a>.
  </p>
  <p>🌟 Star CAMEL on GitHub to stay updated on new releases!</p>
</div>
...
The framework facilitates the continuous evolution of multi-agent systems through data generation and interaction with environments, driven by reinforcement learning or supervised learning.
...
Agents possess stateful memory, enabling multi-step interactions with environments and efficient task completion.

### 📖 Code-as-Prompt

Every line of code and comment serves as a prompt for agents. Clear and readable code is crucial for both humans and agents.

<br>

## Why Use CAMEL for Your Research?

CAMEL is a community-driven research collective of 100+ researchers dedicated to advancing multi-agent system research. Here's why researchers choose CAMEL:
...
Get started with CAMEL by installing the package using pip:
...
For more detailed instructions and configuration options, see the [installation section](https://github.com/camel-ai/camel/blob/master/docs/get_started/installation.md).
...
If you need assistance, reach out to us on [CAMEL Discord](https://discord.camel-ai.org/).
...
Explore our research projects focused on understanding agent behaviors and scaling laws:
...
CAMEL's multi-agent framework enables real business value across several areas:

### 1. Infrastructure Automation

| Usecase                                                                              | Description                                                                  |
| :----------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
| **[ACI MCP](https://github.com/camel-ai/camel/tree/master/examples/usecases/aci_mcp)**   | Multi-agent system for managing and optimizing ACI infrastructure.           |
...
| **[PPTX Toolkit Usecase](https://github.com/camel-ai/camel/tree/master/examples/usecases/pptx_toolkit_usecase)** | Analyze PowerPoint documents and extract structured insights via multi-agent collaboration. |
...
| **[Chat with YouTube](https://github.com/camel-ai/camel/tree/master/examples/usecases/chat_with_youtube)** | Extract and summarize video transcripts, enabling faster content understanding.  |
...
Stay engaged with the CAMEL community through:
...
> Want to host or participate in a CAMEL event? Join our
> <a href="https://discord.com/invite/CNcNpquyDc">Discord</a> or become an
> <a href="https://www.camel-ai.org/ambassador">Ambassador</a>.

## Contributing to CAMEL

> We welcome contributions! Please review our
> [contributing guidelines](https://github.com/camel-ai/camel/blob/master/CONTRIBUTING.md)
> to get started. Share CAMEL on social media to support our growth!
...
-   **WeChat Community:** Join our WeChat community by scanning the QR code below:
