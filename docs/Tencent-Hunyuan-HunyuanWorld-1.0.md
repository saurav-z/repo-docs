...
**Explore a new dimension of creativity with HunyuanWorld 1.0, a groundbreaking model that brings your textual descriptions and images to life as immersive 3D worlds.** 
...
<div align="center">
  ...
  <a href=https://3d-models.hunyuan.tencent.com/world/ target="_blank"><img src= https://img.shields.io/badge/Page-bb8a2e.svg?logo=github height=22px alt="Page"></a>
...
*   **Text-to-3D World Generation:** Transform your creative prompts into explorable 3D environments.
*   **Image-to-3D World Conversion:** Reimagine existing images as immersive 3D scenes.
*   **360° Panoramic Experience:** Enjoy fully immersive and explorable worlds.
*   **Mesh Export:** Integrate generated scenes seamlessly into existing 3D pipelines.
*   **Interactive Object Representations:** Disentangled object representations for enhanced interactivity.
*   **Quantization Support:**  HunyuanWorld-1.0-lite supports consumer GPUs (e.g., 4090)
*   **Caching Support:** Accelerate inference with the caching function

## What's New

*   **August 15, 2025:**  Quantization version (HunyuanWorld-1.0-lite) released for consumer-grade GPUs.
*   **July 26, 2025:** Technical report released on [arXiv](https://arxiv.org/abs/2507.21809).
*   **July 26, 2025:**  HunyuanWorld-1.0, the first open-source simulation-capable 3D world generation model, is launched.
...
##  HunyuanWorld 1.0: Generating Immersive 3D Worlds

### Abstract

HunyuanWorld 1.0 provides a novel framework that seamlessly blends the benefits of video-based and 3D-based approaches for generating immersive, explorable, and interactive 3D worlds from text and image conditions. This is achieved by utilizing a semantically layered 3D mesh representation with panoramic images.
...
The generation architecture integrates panoramic proxy generation, semantic layering, and hierarchical 3D reconstruction to generate high-quality scene-scale 360° 3D worlds from text and image inputs.
...
HunyuanWorld 1.0 has achieved state-of-the-art performance in visual quality and geometric consistency when compared to other panorama and 3D world generation methods.
...
HunyuanWorld 1.0 is based on Flux and is adaptable to other image generation models such as Hunyuan Image, Kontext, and Stable Diffusion.
...
# Create a World Scene from the Panorama image
# Specify foreground object labels using --labels_fg1 and --labels_fg2
# Example: --labels_fg1 sculptures flowers --labels_fg2 tree mountains
...
# Generate panorama with quantization
...
Run the provided script for a quick start:
...
Use the ModelViewer tool to visualize your 3D worlds in your web browser.  Open `modelviewer.html`, upload your 3D scene files, and explore!
...
For inquiries, please email tengfeiwang12@gmail.com.
