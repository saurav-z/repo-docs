...
**Unleash your imagination and build explorable 3D worlds with HunyuanWorld 1.0, a revolutionary model from Tencent.**  ([Original Repo](https://github.com/Tencent-Hunyuan/HunyuanWorld-1.0))
...
*   **Text-to-3D and Image-to-3D Generation:** Transform text descriptions or images into detailed, interactive 3D worlds.
*   **Immersive 360° Experience:** Generate panoramic world proxies for a truly immersive exploration.
*   **Mesh Export Capability:**  Seamlessly integrate your creations with existing computer graphics pipelines.
*   **Semantic-Aware World Decomposition:**  Enables versatile applications in VR, game development, and interactive content creation.
*   **High Performance:**  Achieves state-of-the-art performance, surpassing baselines in visual quality and geometric consistency.

## What's New

*   **July 26, 2025:**  HunyuanWorld 1.0 [Technical Report](https://arxiv.org/abs/2507.21809) released!
*   **July 26, 2025:** The first open-source, simulation-capable, immersive 3D world generation model, HunyuanWorld-1.0 is now available!

Join our community to get help and discuss:
...
HunyuanWorld 1.0 tackles the challenge of creating immersive and playable 3D worlds from textual or visual input.  It combines the strengths of video-based and 3D-based methods, overcoming limitations in both approaches.  The core of the framework lies in a semantically layered 3D mesh representation that leverages panoramic images.
...
The generation architecture integrates panoramic proxy generation, semantic layering, and hierarchical 3D reconstruction for high-quality scene-scale 360° 3D world generation from both text and images.
...
HunyuanWorld 1.0 demonstrates superior performance compared to existing methods, as evidenced by the following benchmark results:
...
Explore the available pre-trained models for HunyuanWorld 1.0:
...
Follow these steps to start generating 3D worlds with HunyuanWorld 1.0.
...
# Create a World Scene using the generated Panorama image.  You can specify foreground labels.
...
# Create a World Scene using the generated Panorama image. Specify foreground labels.
...
Run the provided example script for a quick start:
...
Use the ModelViewer tool to quickly visualize your generated 3D worlds in a web browser.
...
_Note:  Scene loading may be affected by hardware limitations._
