...
**Create immersive and explorable 3D worlds from text and images with HunyuanWorld 1.0, the pioneering simulation-capable, open-source model.** ([Original Repository](https://github.com/Tencent-Hunyuan/HunyuanWorld-1.0))
...
*   **360° Immersive Experiences:** Generate panoramic world proxies for a complete, immersive view.
*   **Mesh Export:** Seamlessly integrates with existing computer graphics pipelines for versatile applications.
*   **Disentangled Object Representations:** Enables enhanced interactivity and manipulation of generated objects.
*   **Text-to-3D & Image-to-3D:** Transforms text descriptions or images into explorable 3D environments.
*   **State-of-the-Art Performance:** Achieves superior visual quality and geometric consistency compared to other methods.

## 🔥 What's New?

*   **September 2, 2025:** Released [HunyuanWorld-Voyager](https://github.com/Tencent-Hunyuan/HunyuanWorld-Voyager/), an RGB-D Video Diffusion model for 3D world exploration and reconstruction.
*   **August 15, 2025:** Launched HunyuanWorld-1.0-lite, a quantized version optimized for consumer-grade GPUs (e.g., 4090).
...
### Abstract
HunyuanWorld 1.0 tackles the challenge of creating immersive 3D worlds from text or images, overcoming limitations in existing methods. It combines video-based methods' diversity with 3D-based methods' geometric consistency. This framework generates explorable and interactive 3D worlds using 360° panoramic world proxies for immersive experiences, mesh export capabilities, and disentangled object representations.  HunyuanWorld 1.0 enables applications in virtual reality, physical simulation, game development, and interactive content creation.
...
HunyuanWorld 1.0 demonstrates superior performance in both visual quality and geometric consistency compared to existing open-source methods.
...
Explore the pre-trained models available for generating 3D worlds.
...
**Text to World generation, Quantization & Cache Usage:**
```python
# Step 1:
# To optimize memory usage and speed up inference, quantization is a practical solution.
...
Visualize your generated 3D worlds in a web browser using our ModelViewer tool by opening ```modelviewer.html``` and uploading the generated 3D scene files.
