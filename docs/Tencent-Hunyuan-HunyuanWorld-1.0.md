...
**Create stunning, explorable 3D worlds from text or images with HunyuanWorld 1.0, the cutting-edge model from Tencent.**  Explore the [original repository](https://github.com/Tencent-Hunyuan/HunyuanWorld-1.0) for the code, models, and more!
...
*   **Generate Immersive 3D Worlds:** Create stunning, explorable 3D environments from text prompts or images.
*   **360° Panoramic Experiences:** Experience fully immersive worlds with panoramic proxy generation.
*   **Mesh Export Capabilities:** Easily integrate generated worlds into existing computer graphics pipelines.
*   **Interactive Object Representations:** Enjoy augmented interactivity with disentangled object representations.
*   **High-Quality Results:** Achieve state-of-the-art performance in generating coherent and visually appealing 3D worlds.

## What's New

*   **July 26, 2025:** The technical report of HunyuanWorld-1.0 is now available on [arXiv](https://arxiv.org/abs/2507.21809).
...
Join the community and get help: [Discord](https://discord.gg/dNBrdrGGMa)
...
HunyuanWorld 1.0 addresses the challenge of generating immersive and playable 3D worlds from text or images. The framework combines the strengths of video-based and 3D-based methods to create explorable and interactive 3D worlds. Key advantages include 360° immersive experiences, mesh export capabilities, and disentangled object representations. The core of the framework is a semantically layered 3D mesh representation that leverages panoramic images as 360° world proxies for semantic-aware world decomposition and reconstruction. This enables the generation of diverse 3D worlds.

<p align="center">
  <img src="assets/application.png" alt="HunyuanWorld 1.0 Application Image">
</p>

### Architecture

HunyuanWorld-1.0's architecture integrates panoramic proxy generation, semantic layering, and hierarchical 3D reconstruction for high-quality, scene-scale 360° 3D world generation, supporting both text and image inputs.
...
HunyuanWorld 1.0 achieves state-of-the-art performance compared to other open-source panorama and 3D world generation methods, excelling in visual quality and geometric consistency.
...
Experience the quality and immersion of 3D worlds generated by HunyuanWorld 1.0:
...
The open-source version of HY World 1.0 is based on Flux and can be adapted to other image generation models such as Hunyuan Image, Kontext, and Stable Diffusion.
...
Run the following command to quickly test the examples:
...
Use the ModelViewer tool to visualize your generated 3D worlds in a web browser. Open `modelviewer.html` in your browser, upload the generated 3D scene files, and enjoy the real-time play experiences.
