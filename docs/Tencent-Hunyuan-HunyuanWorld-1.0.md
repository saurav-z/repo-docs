...
HunyuanWorld 1.0 empowers users to generate explorable and interactive 3D worlds from text descriptions or images, opening new possibilities for VR, game development, and content creation.  [Visit the original repository on GitHub](https://github.com/Tencent-Hunyuan/HunyuanWorld-1.0).
...
*   **360° Immersive Worlds:** Generate panoramic proxies for creating fully immersive experiences.
*   **Mesh Export for Compatibility:** Export generated worlds as meshes for seamless integration with existing graphics pipelines.
*   **Disentangled Object Representations:**  Enable augmented interactivity through layered object representation.
*   **Text-to-3D and Image-to-3D:** Supports both text and image inputs for versatile world generation.
*   **High-Quality Results:** Achieves state-of-the-art performance in generating coherent, explorable, and interactive 3D worlds.
*   **Open Source**: Includes inference code, model checkpoints, and a technical report.
...
*   **August 15, 2025:** Released a quantization version of HunyuanWorld-1.0 (HunyuanWorld-1.0-lite) enabling support for consumer-grade GPUs such as the 4090.
*   **July 26, 2025:**  Published the [technical report](https://arxiv.org/abs/2507.21809) detailing the inner workings of HunyuanWorld-1.0.
*   **July 26, 2025:** Launched HunyuanWorld-1.0, the first open-source, simulation-capable, immersive 3D world generation model.

> Join our **[Wechat Group](#)** and **[Discord](https://discord.gg/dNBrdrGGMa)** to discuss and get support.
...
### Abstract
HunyuanWorld 1.0 overcomes limitations in existing 3D world generation by combining the benefits of video-based and 3D-based approaches. The framework uses a semantically layered 3D mesh representation with panoramic images as 360° world proxies for efficient and diverse 3D world generation.
...
### Performance
HunyuanWorld 1.0 demonstrates superior performance in generating high-quality panoramas and 3D worlds compared to existing methods, as shown in the following metrics:
...
# You can indicate the foreground object labels with --labels_fg1 & --labels_fg2
...
# RESULT: The world scene is generated!
```
...
```python
# Step 1: Apply Quantization and/or Cache
...
Use the ModelViewer tool to visualize generated 3D worlds in a web browser:

1.  Open `modelviewer.html`.
