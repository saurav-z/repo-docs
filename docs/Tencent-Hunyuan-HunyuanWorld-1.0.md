...
**Unleash your creativity and explore the world of immersive 3D experiences with HunyuanWorld 1.0, the first open-source model capable of generating explorable 3D worlds from text and images!**  Explore the original repository [here](https://github.com/Tencent-Hunyuan/HunyuanWorld-1.0).
...
<div align="center">
  ...
  <a href=https://3d-models.hunyuan.tencent.com/world/ target="_blank"><img src= https://img.shields.io/badge/Page-bb8a2e.svg?logo=github height=22px alt="3D Models"></a>
...
*   **Text-to-3D and Image-to-3D:** Generate 3D worlds directly from text descriptions or images.
*   **Immersive 360° Experiences:**  Enjoy panoramic world proxies for fully immersive exploration.
*   **Mesh Export:** Compatible with existing computer graphics pipelines.
*   **Interactive Worlds:** Disentangled object representations enable enhanced interactivity.
*   **State-of-the-Art Performance:** Achieve top-tier visual quality and geometric consistency.
*   **Quantization Support**: Run the model on consumer-grade GPUs like the 4090 with the lite version.
*   **RGBD Video Diffusion**: Explore 3D consistency and fast 3D reconstruction with HunyuanWorld-Voyager.

## 🔥 What's New

*   **September 2, 2025:** 🚀  Release of [HunyuanWorld-Voyager](https://github.com/Tencent-Hunyuan/HunyuanWorld-Voyager/), an RGB-D Video Diffusion model for 3D-consistent world exploration and fast 3D reconstruction!
*   **August 15, 2025:** 💡  Release of HunyuanWorld-1.0-lite, a quantized version for consumer-grade GPU compatibility.
*   **July 26, 2025:** 📖  Publication of the [technical report](https://arxiv.org/abs/2507.21809).
*   **July 26, 2025:** 🎉  Initial release of HunyuanWorld-1.0, the first open-source, simulation-capable, immersive 3D world generation model.
...
HunyuanWorld 1.0 introduces a groundbreaking approach to generating explorable and interactive 3D worlds from text and images. By combining the strengths of video-based and 3D-based generation methods, we overcome limitations in 3D consistency, rendering efficiency, and data representation. This framework enables the creation of diverse 3D worlds with:

1.  **360° immersive experiences** via panoramic world proxies.
2.  **Mesh export capabilities** for compatibility with existing graphics pipelines.
3.  **Disentangled object representations** for enhanced interactivity.

The core of HunyuanWorld 1.0 uses a semantically layered 3D mesh representation and panoramic images to generate high-quality, diverse 3D worlds. Experiments demonstrate that our method achieves state-of-the-art performance, opening new avenues for virtual reality, physical simulation, game development, and interactive content creation.
...
The generation architecture of HunyuanWorld-1.0 integrates panoramic proxy generation, semantic layering, and hierarchical 3D reconstruction to generate scene-scale 360° 3D worlds from both text and image inputs.
...
HunyuanWorld 1.0 outperforms existing methods in both visual quality and geometric consistency. Comparative results are presented below:
...
Explore the captivating 360° immersive 3D worlds generated by HunyuanWorld 1.0:
...
# Specify foreground object labels with params labels_fg1 & labels_fg2
...
```python
# Step 1: Quantization for optimized memory/speed
...
# Step 2: Run scenegen with cache
...
3.  Enjoy real-time play experiences.

<p align="left">
  <img src="assets/quick_look.gif" alt="3D World Viewer">
</p>

*   *Note:* Certain scenes may not load due to hardware limitations.
