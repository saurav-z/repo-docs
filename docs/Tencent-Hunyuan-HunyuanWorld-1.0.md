...
**Unleash your imagination: Generate immersive, explorable, and interactive 3D worlds directly from text or images with HunyuanWorld 1.0!**
...
*   **Text-to-3D and Image-to-3D Generation:** Transform your ideas into interactive 3D environments.
*   **360° Immersive Experiences:** Create panoramic worlds for a fully engaging experience.
*   **Mesh Export Capabilities:** Seamlessly integrate generated worlds into existing graphics pipelines.
*   **Disentangled Object Representations:** Enable augmented interactivity within your 3D scenes.
*   **State-of-the-Art Performance:** Achieve superior visual quality and geometric consistency compared to existing methods.
*   **Easy to Use:**  Includes code samples and a quick start guide to get you up and running.

## What's New

*   **July 26, 2025:** [Technical Report](https://arxiv.org/abs/2507.21809) released!  Dive deep into the technical details.
*   **July 26, 2025:**  HunyuanWorld 1.0 is officially open-sourced!
...
HunyuanWorld 1.0 overcomes the limitations of existing 3D world generation methods, offering a novel framework for creating explorable and interactive 3D worlds from text and images.  It leverages a semantically layered 3D mesh representation and panoramic images as 360° world proxies for exceptional results. This innovative approach unlocks versatile applications in VR, simulation, game development, and content creation.
...
HunyuanWorld-1.0's architecture combines panoramic proxy generation, semantic layering, and hierarchical 3D reconstruction to generate high-quality, scene-scale 360° 3D worlds from text or image inputs.
...
HunyuanWorld 1.0 demonstrates superior performance compared to other leading open-source panorama and 3D world generation methods, excelling in visual quality and geometric consistency.  See below for comparative results:
...
HunyuanWorld 1.0 is based on Flux and is easily adaptable to other image generation models like Hunyuan Image, Kontext, and Stable Diffusion.
...
Follow these steps to set up and run HunyuanWorld 1.0:
...
# 2. Create a World Scene using the generated Panorama image.
#  Customize foreground objects with --labels_fg1 & --labels_fg2.
...
# 3. View your WORLD SCENE!
```

**Text to World Generation Example:**

```python
# 1. Generate a Panorama image from a text prompt.
...
Run the example script for a quick introduction:
...
Visualize your generated 3D worlds in your web browser with our ModelViewer tool.
...
<p align="left">
  <img src="assets/quick_look.gif" alt="Model Viewer GIF">
</p>
