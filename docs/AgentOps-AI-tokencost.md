...
# Tokencost: Effortlessly Estimate LLM Costs and Track Token Usage

Accurately estimate the cost of your Large Language Model (LLM) API calls and track token usage with **Tokencost**, a powerful Python library.  Check out the [original repo](https://github.com/AgentOps-AI/tokencost) for the source code.

**Key Features:**

*   **Accurate Token Counting:** Get precise token counts for your prompts and completions using [Tiktoken](https://github.com/openai/tiktoken), OpenAI's official tokenizer, and the Anthropic beta token counting API for Claude models.
*   **LLM Cost Estimation:** Calculate the estimated USD cost of prompts and completions for major LLM providers, including OpenAI and more.
*   **Up-to-Date Pricing:**  Keep track of the latest pricing changes from major LLM providers, with regularly updated cost data.
*   **Easy Integration:**  Integrate cost and token calculations into your AI applications with a single function call.

## Core Functionality

Tokencost simplifies cost calculations.  Whether you're working with simple strings or complex message formats, Tokencost has you covered.

### Cost Calculation

Easily calculate the cost of prompts and completions.
...
Calculate costs directly from string prompts.
...
Count tokens in both message lists and strings.
...
Tokencost leverages [Tiktoken](https://github.com/openai/tiktoken) for tokenization, ensuring accurate counts for OpenAI models. For Anthropic models above version 3 (Sonnet 3.5, Haiku 3.5, and Opus 3), it utilizes the [Anthropic beta token counting API](https://docs.anthropic.com/claude/docs/beta-api-for-counting-tokens).

## LLM Pricing Table

View the comprehensive cost table with pricing information for a wide array of LLM models. This data is regularly updated. All prices can be located [here](pricing_table.md).
