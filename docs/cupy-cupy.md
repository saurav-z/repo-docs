...
**CuPy empowers you to seamlessly accelerate your NumPy and SciPy code on NVIDIA CUDA and AMD ROCm platforms, unlocking significant performance gains.**  [Learn more about CuPy](https://github.com/cupy/cupy)
...
*   **NumPy & SciPy Compatibility:** CuPy offers a familiar API, acting as a drop-in replacement for NumPy and SciPy, so you can leverage your existing Python code with minimal changes.
*   **GPU Acceleration:** Run your numerical computations on NVIDIA GPUs for significantly faster processing speeds.
*   **CUDA & ROCm Support:**  Supports both NVIDIA CUDA and AMD ROCm platforms, providing flexibility in hardware choice.
*   **Low-Level CUDA Access:** Provides access to low-level CUDA features, enabling advanced users to optimize performance further, including RawKernels, Streams, and CUDA Runtime APIs.
*   **Broad Ecosystem:**  Works seamlessly with popular Python libraries and frameworks.
