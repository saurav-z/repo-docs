...
*   **[2025/05/20]** 🎉 Released SkyRL-SQL: A multi-turn RL training pipeline for Text-to-SQL, with SkyRL-SQL-7B, a model trained on only 653 samples that outperforms both GPT-4o and o4-mini!
