...
**Skyvern empowers you to automate complex browser-based tasks using the power of LLMs and computer vision, eliminating the need for brittle, code-heavy automation.**

[Explore the Skyvern project on GitHub](https://github.com/Skyvern-AI/skyvern).

## Key Features

*   🤖 **AI-Powered Automation:** Utilize Large Language Models (LLMs) and computer vision to interact with websites as a human would.
*   🌐 **Website Agnostic:**  Works on websites you've never seen before, adapting to layout changes.
*   🔗 **Workflow Chaining:**  Build complex automation sequences by chaining multiple tasks.
*   💻 **Easy Integration:**  Use a simple API, cloud-based solution, or local deployment.
*   👀 **Real-time Debugging:** Livestream the browser viewport to observe Skyvern's actions.
*   📤 **Data Extraction:**  Extract structured data from websites based on schema.
*   💾 **File Handling:** Download and upload files effortlessly.
*   🔐 **Authentication Support:**  Includes 2FA (TOTP) support and password manager integrations.
*   🤝 **Integrations:** Zapier, Make.com and N8N integrations to connect with other apps.
*   ✅ **SOTA Performance:** Achieves state-of-the-art performance on WebBench benchmarks, especially for WRITE tasks.
...
Skyvern leverages a task-driven autonomous agent design, inspired by projects like BabyAGI and AutoGPT, but with browser automation capabilities using libraries like Playwright. Skyvern uses a swarm of agents to comprehend a website, plan, and execute actions:
...
*   Applies workflows across many sites.
*   Uses LLMs for intelligent interaction, enabling complex scenarios.
...
Skyvern demonstrates state-of-the-art performance on the [WebBench benchmark](webbench.ai) with a 64.4% accuracy. The technical report and evaluation can be found [here](https://blog.skyvern.com/web-bench-a-new-way-to-compare-ai-browser-agents/)
...
Discover how Skyvern automates tasks across various industries. [Book a demo](https://meetings.hubspot.com/skyvern/demo) to see it in action.
...
Find in-depth guides on our [📕 docs page](https://docs.skyvern.com).  Reach out if you need help via [email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
Contributions are welcome! Please see our [contribution guide](CONTRIBUTING.md) and [Help Wanted issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started.

If you have any questions, feel free to reach out via [email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).

For a high-level overview of the structure, building, and usage questions, check out [Code Sage](https://sage.storia.ai?utm_source=github&utm_medium=referral&utm_campaign=skyvern-readme).
...
Skyvern is open source under the [AGPL-3.0 License](LICENSE), with the exception of anti-bot measures in our managed cloud offering. Contact us at [support@skyvern.com] if you have any license questions.
