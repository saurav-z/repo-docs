...
**Skyvern empowers you to automate complex browser-based workflows with the power of Large Language Models (LLMs) and computer vision, eliminating the need for brittle, website-specific scripts.**  Explore the [original repo here](https://github.com/Skyvern-AI/skyvern).

## Key Features

*   **LLM-Driven Automation:** Uses LLMs to understand and interact with websites, adapting to changes.
*   **Vision-Based Interactions:** Leverages computer vision to identify and act on visual elements.
*   **Workflow Automation:**  Create and chain tasks for complex, multi-step processes.
*   **Data Extraction:** Extract structured data from websites using a specified schema.
*   **Form Filling:** Automatically fill out forms with provided information.
*   **File Downloading:** Download files directly from websites.
*   **Authentication Support:** Securely automate tasks behind logins, with 2FA (TOTP) and password manager integrations (Bitwarden).
*   **Advanced LLM Support:** Supports Model Context Protocol (MCP) and a wide range of LLMs.
*   **Integration-Ready:** Seamlessly integrates with Zapier, Make.com, and N8N.
...
Skyvern employs a task-driven autonomous agent design, inspired by [BabyAGI](https://github.com/yoheinakajima/babyagi) and [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT), and enhanced with browser automation. It utilizes a swarm of intelligent agents to understand websites, plan actions, and execute tasks.

Key advantages:

*   **Website Agnostic:** Operates on websites it hasn't seen before, identifying actions based on visual elements.
*   **Resilient to Changes:**  Adapts to website layout changes without requiring code updates.
*   **Scalable Workflows:** Applies a single workflow across numerous websites.
*   **Intelligent Reasoning:** Leverages LLMs to handle complex scenarios, such as inferring driver eligibility for insurance quotes or identifying equivalent products across different e-commerce sites.
...
Skyvern achieves state-of-the-art performance on the [WebBench benchmark](webbench.ai) with a 64.4% accuracy.

*   [WebBench Evaluation](https://blog.skyvern.com/web-bench-a-new-way-to-compare-ai-browser-agents/)
    <p align="center">
...
See how Skyvern is being used in the real world!
...
Find more extensive documentation on our [📕 docs page](https://docs.skyvern.com). Please let us know if something is unclear or missing by opening an issue or reaching out to us [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
We welcome PRs and suggestions!  Reach out to us [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
Please review the [contribution guide](CONTRIBUTING.md) and
