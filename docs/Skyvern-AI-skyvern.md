...
<p align="center">
  <strong>Automate Browser Workflows with LLMs and Computer Vision</strong> - Say goodbye to brittle automation solutions!
</p>
...
[Skyvern](https://github.com/Skyvern-AI/skyvern) empowers you to automate complex, browser-based workflows using the power of Large Language Models (LLMs) and computer vision.  Leverage the full potential of the web without the limitations of traditional automation!

## Key Features

*   **Intelligent Automation:**  Interact with websites you've never seen before without writing custom code, using Vision LLMs.
*   **Resilient to Changes:** Adapt to website layout updates effortlessly, avoiding broken scripts.
*   **Scalable Workflows:** Apply a single workflow across numerous websites.
*   **Advanced Reasoning:** Utilize LLMs for complex scenarios, such as form completion and data extraction.
*   **Workflow Building:** Chain multiple tasks together for complex automation scenarios.
*   **Data Extraction:** Extract structured data from websites.
*   **File Handling:** Download and manage files, with automatic block storage upload.
...
Skyvern leverages a swarm of intelligent agents, inspired by BabyAGI and AutoGPT, to navigate and interact with websites.

**Key advantages:**

*   Works on websites it hasn't encountered before.
*   Resistant to website layout changes.
*   Applies workflows across multiple websites.
*   Leverages LLMs for complex interactions.
...
Tasks are the fundamental building blocks within Skyvern. Each task represents a single instruction to navigate a website and accomplish a specific goal.

*   Require `url`, `prompt`, and optionally `data schema` and `error codes`.
...
Create automated sequences of tasks to handle complex processes.

*   Includes navigation, actions, data extraction, loops, file parsing, and more.
*   Coming soon: conditional logic and custom code blocks.
...
Monitor Skyvern's actions in real-time with live browser viewport streaming.  Useful for debugging.

### Form Filling

Automate form completion on websites with the help of your prompt.

### Data Extraction

Extract structured data using a defined schema from a webpage.

### File Downloading

Download and manage files; they are automatically uploaded to block storage if configured.

### Authentication

Supports various authentication methods to automate tasks behind logins.
...
*   **Job Application Automation:** [Demo](https://app.skyvern.com/tasks/create/job_application)

<p align="center">
  <img src="fern/images/job_application_demo.gif"/>
</p>

*   **Materials Procurement:** [Demo](https://app.skyvern.com/tasks/create/finditparts)

<p align="center">
  <img src="fern/images/finditparts_recording_crop.gif"/>
</p>

*   **Government Website Automation:** [Demo](https://app.skyvern.com/tasks/create/california_edd)

<p align="center">
  <img src="fern/images/edd_services.gif"/>
</p>

*   **Contact Form Filling:** [Demo](https://app.skyvern.com/tasks/create/contact_us_forms)

<p align="center">
  <img src="fern/images/contact_forms.gif"/>
</p>

*   **Insurance Quote Retrieval:** [Demo](https://app.skyvern.com/tasks/create/bci_seguros)

<p align="center">
  <img src="fern/images/bci_seguros_recording.gif"/>
</p>
[Demo](https://app.skyvern.com/tasks/create/geico)
...
Find detailed documentation on our [documentation page](https://docs.skyvern.com).
...
We welcome contributions! See our [contribution guide](CONTRIBUTING.md) and ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started.  Reach out to us via [email](mailto:founders@skyvern.com) or [Discord](https://discord.gg/fG2XXEuQX3).
