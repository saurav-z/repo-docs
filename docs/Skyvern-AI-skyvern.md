...
**Skyvern empowers you to automate browser-based tasks using the power of Large Language Models (LLMs) and computer vision, eliminating the need for brittle, website-specific scripts.**  Visit the [Skyvern GitHub Repository](https://github.com/Skyvern-AI/skyvern) for the source code.
...
*   **Intelligent Automation:** Automates complex browser workflows across websites, even those unseen before.
*   **Resilient to Website Changes:** Adapts to website layout changes without requiring code modifications.
*   **Cross-Website Applicability:** Applies the same workflow to multiple websites, saving significant development time.
*   **Advanced Reasoning:** Uses LLMs to handle complex scenarios, such as inferring information and understanding context.
...
*   **Form Filling & Data Extraction:** Natively handles form inputs and structured data extraction.
*   **Authentication Support:** Securely automates tasks behind logins with 2FA support, including TOTP, and password manager integrations (Bitwarden).
...
Skyvern utilizes a task-driven autonomous agent design inspired by BabyAGI and AutoGPT, enhanced with browser automation via [Playwright](https://playwright.dev/). It uses a swarm of agents to understand a website, plan actions, and execute tasks.  See the system diagram below:
...
Skyvern demonstrates SOTA performance on the [WebBench benchmark](webbench.ai) with 64.4% accuracy, especially excelling at WRITE tasks.
...
Please have a look at our [contribution guide](CONTRIBUTING.md) and ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started!
