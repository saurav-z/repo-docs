...
**Skyvern leverages Large Language Models (LLMs) and computer vision to automate browser-based workflows, eliminating the need for brittle, site-specific scripts.** [Explore the original repository here](https://github.com/Skyvern-AI/skyvern).

## Key Features

*   **Intelligent Automation:**  Understands websites and performs actions without custom code using Vision LLMs.
*   **Resistance to Change:**  Adapts to website layout changes, ensuring ongoing functionality.
*   **Cross-Site Applicability:**  Applies workflows across a wide range of websites with minimal configuration.
*   **Advanced Reasoning:**  Leverages LLMs to handle complex scenarios, such as form filling and data extraction.
*   **Real-time Livestreaming:** View Skyvern interacting on the web, in real-time.
*   **Form Filling:** Native support for automated form submissions.
*   **Data Extraction:** Easily extract structured data from any website.
*   **File Downloading:**  Automated file downloads with block storage integration.
*   **Authentication Support:**  Securely automate tasks behind logins, including 2FA.
...
See Skyvern in action with these real-world automation examples:

*   **Invoice Downloading:** Automated invoice downloads from various websites.
...
*   **Materials Procurement:** Automate materials procurement for a manufacturing company.
    [💡 See it in action](https://app.skyvern.com/tasks/create/finditparts)
    <p align="center">
      <img src="fern/images/finditparts_recording_crop.gif"/>
    </p>
*   **Government Website Navigation:** Automate registration and form filling on government websites.
    [💡 See it in action](https://app.skyvern.com/tasks/create/california_edd)
    <p align="center">
      <img src="fern/images/edd_services.gif"/>
    </p>
*   **Contact Form Filling:** Automate the process of filling out contact us forms.
    [💡 See it in action](https://app.skyvern.com/tasks/create/contact_us_forms)
    <p align="center">
      <img src="fern/images/contact_forms.gif"/>
    </p>
*   **Insurance Quote Retrieval:** Retrieve insurance quotes from various providers in any language.
...
Find detailed documentation on our [📕 docs page](https://docs.skyvern.com). For questions, issues, or suggestions, please [contact us](mailto:founders@skyvern.com) or join our [discord](https://discord.gg/fG2XXEuQX3).
...
Future developments planned for Skyvern:

*   [x] **Open Source:** Open Source Skyvern's core codebase
*   [x] **Workflow Support:**  Chain multiple Skyvern calls together.
*   [x] **Improved Context:** Enhance understanding of content by incorporating relevant label context.
*   [x] **Cost Savings:** Improve stability and reduce running costs through prompt optimization.
*   [x] **Self-serve UI:**  React-based UI for managing tasks.
*   [x] **Workflow UI Builder:** A visual interface for building and analyzing workflows.
*   [x] **Chrome Viewport Streaming:** Real-time viewport streaming to the user's browser.
*   [x] **Past Runs UI:** Visualize past runs and results.
...
*   [x] **Prompt Caching:** Reduce costs by caching LLM calls.
*   [x] **Web Evaluation Dataset:** Integration with public benchmark tests.
*   [ ] **Improved Debug Mode:** Plan actions and get approval before execution for enhanced debugging.
*   [ ] **Chrome Extension:** Interact with Skyvern through a Chrome extension.
*   [ ] **Skyvern Action Recorder:**  Generate workflows automatically based on user actions.
*   [ ] **Interactable Livestream:**  Real-time intervention in the livestream.
...
Contributions are welcome!  Please see our [contribution guide](CONTRIBUTING.md) and ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) for getting started. Reach out via [email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
