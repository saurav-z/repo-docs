...
**Skyvern empowers you to automate browser-based tasks using the power of Large Language Models (LLMs) and computer vision, transforming complex manual workflows into streamlined, automated processes.** [Learn more and explore the project on GitHub](https://github.com/Skyvern-AI/skyvern).

<p align="center">
  <img src="fern/images/geico_shu_recording_cropped.gif" alt="Skyvern in Action: Automating a task"/>
</p>

## Key Features

*   🚀 **Automated Browser Automation:** Automate complex, repetitive tasks across various websites without writing custom code, leveraging LLMs and computer vision.
*   🌐 **Website Agnostic:** Skyvern interacts with websites it has never seen before, adapting to layout changes and handling variations.
*   🔗 **Workflow Automation:** Chain multiple tasks to create comprehensive workflows, automating tasks such as invoice downloading, form filling, and e-commerce purchasing.
*   👁️ **Livestreaming:** View real-time browser interactions for debugging and understanding.
*   ✅ **Data Extraction:** Easily extract structured data from websites using schema definitions.
*   🔐 **Authentication Support:** Automate tasks behind logins with various authentication methods, including 2FA (TOTP, email, SMS), and password manager integrations.
*   📦 **Cloud and Local Deployment:** Utilize Skyvern Cloud for a managed experience or run it locally.
*   💻 **Extensive LLM Support:** Supports a wide range of LLMs including OpenAI, Anthropic, Gemini, and more, providing flexibility for your needs.
*   🔌 **Integrations:** Easily integrate with tools like Zapier, Make.com, and N8N to connect with other applications.
...
Skyvern utilizes a task-driven, autonomous agent design inspired by BabyAGI and AutoGPT. It employs a swarm of agents that interact with websites using browser automation libraries. This approach allows Skyvern to:

*   Operate on previously unseen websites
*   Resist website layout changes
*   Apply workflows across multiple sites
*   Leverage LLMs for intelligent reasoning

For detailed technical insights, refer to the technical report [here](https://blog.skyvern.com/skyvern-2-0-state-of-the-art-web-navigation-with-85-8-on-webvoyager-eval/).
...
*   **Invoice Downloading:** Automate invoice downloads from various websites. [Book a demo to see it live](https://meetings.hubspot.com/skyvern/demo)
    <p align="center">
...
*   **Materials Procurement:** Automate material procurement for manufacturing.
...
*   **Government Website Navigation:** Automate account registration and form filling on government websites.
...
*   **Contact Form Automation:** Automate the process of filling out contact forms.
    [💡 See it in action](https://app.skyvern.com/tasks/create/contact_us_forms)
    <p align="center">
    <img src="fern/images/contact_forms.gif" alt="Contact Form Automation"/>
    </p>
*   **Insurance Quote Retrieval:** Retrieve insurance quotes from different providers.
...
Find comprehensive documentation on our [📕 docs page](https://docs.skyvern.com). Contact us with any questions or feedback [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
Our planned roadmap for the next few months. Share suggestions or feature requests via [email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
Consult our [contribution guide](CONTRIBUTING.md) and ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started!

If you want to chat with the skyvern repository to get a high level overview of how it is structured, how to build off it, and how to resolve usage questions, check out [Code Sage](https://sage.storia.ai?utm_source=github&utm_medium=referral&utm_campaign=skyvern-readme).

## Telemetry

By default, Skyvern collects basic usage statistics to help us understand how Skyvern is being used. Opt-out by setting the `SKYVERN_TELEMETRY` environment variable to `false`.

## License

Skyvern's open source repository is licensed under the [AGPL-3.0 License](LICENSE), with the exception of anti-bot measures available in our managed cloud offering.

For licensing inquiries, please [contact us](mailto:support@skyvern.com).
