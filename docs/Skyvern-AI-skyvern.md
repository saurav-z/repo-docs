...
**Tired of repetitive manual tasks in your browser? Skyvern uses Large Language Models (LLMs) and Computer Vision to automate browser-based workflows, giving you the power to replace brittle automation with a smarter, more adaptable solution. 🐉**
...
Skyvern leverages the power of LLMs and computer vision to automate complex browser-based tasks, such as filling forms, downloading files, and navigating websites. Unlike traditional automation tools that rely on brittle DOM parsing, Skyvern uses a swarm of intelligent agents to understand and interact with websites, adapting to changes and handling a wide range of scenarios.
...
*   **Intelligent Automation:** Uses LLMs and Computer Vision to understand and interact with websites.
*   **Resilient to Website Changes:** Adapts to website layout changes without requiring code modifications.
*   **Cross-Website Compatibility:** Applies workflows across a large number of websites.
*   **Advanced Reasoning:** Handles complex scenarios, such as inferring information and understanding product variations.
*   **Workflow Builder:** Chain multiple tasks together to form cohesive unit of work, including navigation, data extraction, loops, and more.
*   **Livestreaming:** Stream the browser viewport to monitor the tasks.
*   **Form Filling:** Native support for filling out form inputs.
*   **Data Extraction:** Extract structured data from websites with schema definitions.
*   **File Downloading:** Download files from websites and automatically store them.
*   **Authentication:** Support for various authentication methods, including 2FA.
*   **Model Context Protocol (MCP) Support:** Use any LLM supporting MCP.
*   **Integrations:** Connect with Zapier, Make.com, and N8N.
...
Skyvern employs a task-driven, autonomous agent design, similar to BabyAGI and AutoGPT, but with the added ability to interact with websites using browser automation libraries like Playwright. It leverages a "swarm of agents" to:

1.  **Comprehend:** Understand a website's layout and content.
2.  **Plan:** Determine the necessary actions to complete a task.
3.  **Execute:** Perform actions within the browser to achieve the desired outcome.

This architecture offers key advantages:

*   Works on websites never seen before, mapping visual elements to actions.
*   Resilient to website layout changes.
*   Applies a single workflow to many websites.
*   Leverages LLMs for complex reasoning, such as filling out forms or comparing products.
...
See how Skyvern is automating tasks across various industries.  Contribute your own examples!
...
Find detailed information on using Skyvern on our [📕 docs page](https://docs.skyvern.com).  For questions or issues, contact us [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
We are constantly improving Skyvern.  Reach out with your suggestions!
...
Skyvern is licensed under the [AGPL-3.0 License](LICENSE). Anti-bot measures in the managed cloud offering are excluded.
