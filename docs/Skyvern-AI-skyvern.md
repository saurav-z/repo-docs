...
[Skyvern](https://www.skyvern.com) is a powerful AI-driven platform that automates browser-based workflows using Large Language Models (LLMs) and computer vision.  Eliminate brittle, code-based automation and effortlessly interact with any website.  For more details, visit the [original repository](https://github.com/Skyvern-AI/skyvern).

## Key Features

*   **Automated Browser Interactions:**  Control browsers with simple prompts, eliminating the need for custom scripting.
*   **LLM-Powered Automation:** Leverages LLMs and computer vision to understand and interact with websites, adapting to layout changes.
*   **Workflow Automation:** Chain multiple tasks together to build complex, automated workflows.
*   **Data Extraction & Form Filling:** Extract data, fill forms, and download files seamlessly.
*   **2FA and Password Manager Support:**  Integrates with various authentication methods, including 2FA and popular password managers.
*   **Livestreaming:** See real-time browser actions for debugging and monitoring.
*   **Flexible Deployment:** Deploy on our [Skyvern Cloud](https://app.skyvern.com) or run locally.
*   **Integrations:**  Connect to other apps with integrations like Zapier, Make.com, and N8N.
...
Skyvern uses an advanced, task-driven agent design inspired by BabyAGI and AutoGPT, but with the crucial ability to interact with websites through browser automation libraries like Playwright.

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="fern/images/skyvern_2_0_system_diagram.png" alt="Skyvern System Diagram Dark Mode">
  <img src="fern/images/skyvern_2_0_system_diagram.png" alt="Skyvern System Diagram" />
</picture>

Key advantages of this approach:

*   **Website Agnostic:** Operates on any website, even those it hasn't seen before, without custom code.
*   **Resilient to Changes:**  Adapts to website layout changes without requiring script updates.
*   **Scalable Workflows:** Apply single workflows to multiple websites.
*   **Intelligent Interactions:** Uses LLMs to reason through complex scenarios.

For more technical details, see the [technical report](https://blog.skyvern.com/skyvern-2-0-state-of-the-art-web-navigation-with-85-8-on-webvoyager-eval/).
...
See how Skyvern is transforming automation.  Open PRs to share your own examples!
...
Comprehensive documentation is available on our [📕 docs page](https://docs.skyvern.com).  For assistance, open an issue or contact us [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
Our planned features for the coming months. We welcome your suggestions! Reach out [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
We welcome contributions! Please review our [contribution guide](CONTRIBUTING.md) and check the ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started.  Contact us with any questions [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
