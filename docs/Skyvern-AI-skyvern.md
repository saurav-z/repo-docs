...
[Skyvern](https://www.skyvern.com) empowers you to automate complex browser-based tasks using Large Language Models (LLMs) and computer vision, bypassing the limitations of traditional automation methods.  This allows you to automate manual workflows on any website. See the original repo [here](https://github.com/Skyvern-AI/skyvern).

## Key Features

*   **Automated Browser Workflows:** Automate tasks like form filling, data extraction, and more.
*   **LLM-Powered:**  Leverages LLMs to understand and interact with websites intelligently.
*   **Computer Vision Integration:**  Uses computer vision to identify and act on visual elements.
*   **Resilient to Website Changes:**  Adapts to website layout updates, reducing the need for constant script adjustments.
*   **Cross-Website Automation:** Apply a single workflow across numerous websites.
*   **Workflow Building:** Chain multiple tasks together with a complete workflow builder.
*   **Form Filling:** Fill form inputs with data via the `navigation_goal`
...
*   **Model Context Protocol (MCP) support:** Use the model that works best for you.
*   **Integration with other apps:** Zapier, Make.com, and N8N integration.
...
Skyvern utilizes a task-driven approach inspired by projects like BabyAGI and AutoGPT, but with the critical advantage of browser interaction through libraries like Playwright.  It employs a swarm of agents to:

1.  **Comprehend Websites:** Map visual elements to actions.
2.  **Plan Actions:** Determine the steps required to complete a task.
3.  **Execute Workflows:** Interact with websites using the browser.

Advantages of this approach:

*   Operates on unseen websites without custom code.
*   Resistant to website layout changes.
*   Applies single workflows across many websites.
*   Leverages LLMs for complex scenarios (e.g., insurance quotes, competitor analysis).
    For more in-depth information, see the technical report [here](https://blog.skyvern.com/skyvern-2-0-state-of-the-art-web-navigation-with-85-8-on-webvoyager-eval/).
...
Skyvern achieves state-of-the-art performance on the [WebBench benchmark](webbench.ai) with a 64.4% accuracy. The technical report + evaluation can be found [here](https://blog.skyvern.com/web-bench-a-new-way-to-compare-ai-browser-agents/)
...
Explore how Skyvern is used to automate workflows:
...
Comprehensive documentation is available on our [📕 docs page](https://docs.skyvern.com).  For questions or feedback, contact us [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
We welcome contributions!  See the [contribution guide](CONTRIBUTING.md) and ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started.

Check out [Code Sage](https://sage.storia.ai?utm_source=github&utm_medium=referral&utm_campaign=skyvern-readme) for a high level overview.

## Telemetry

Skyvern collects basic usage data (opt-out via `SKYVERN_TELEMETRY=false`).

## License

The core Skyvern code is AGPL-3.0 licensed ([LICENSE](LICENSE)), excluding anti-bot measures in our managed cloud.  Contact us at [support@skyvern.com](mailto:support@skyvern.com) with licensing questions.
