<h1 align="center">
 ...
 <br />
  <b>Skyvern: Automate Browser Workflows with AI</b>
</h1>
...
[Skyvern](https://www.skyvern.com) is a powerful framework that leverages Large Language Models (LLMs) and computer vision to automate browser-based workflows, offering a modern alternative to brittle and website-dependent automation solutions.  This enables you to automate manual tasks on numerous websites with a simple API. For more details, see the original repo:  [https://github.com/Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern).

## Key Features

*   **Intuitive Automation:** Automate complex workflows with natural language prompts.
*   **Website-Agnostic:** Works on websites you've never seen before, adapting to layout changes.
*   **Form Filling:** Easily fill out web forms.
*   **Data Extraction:**  Extract structured data from websites with schema definitions.
*   **Workflow Orchestration:** Chain multiple tasks together to create complex workflows.
*   **Livestreaming:**  View live browser interactions for debugging and monitoring.
*   **2FA Support:** Supports various 2FA methods, including TOTP, for secure automation.
*   **Password Manager Integration:** Integrates with Bitwarden, with more coming soon.
*   **Model Context Protocol (MCP):** Supports the Model Context Protocol to allow you to use any LLM that supports MCP.
*   **Integration with popular tools:** Zapier, Make.com, and N8N integration for wider application

<p align="center">
  <img src="fern/images/geico_shu_recording_cropped.gif" alt="Geico Automation Example"/>
</p>
...
### 2. Run Skyvern - Cloud vs. Local

*   **Skyvern Cloud:**  A managed, cloud-based solution ([app.skyvern.com](https://app.skyvern.com)) offering parallel instance execution, anti-bot mechanisms, and CAPTCHA solving. Create an account to start.
*   **Local Installation:** Run Skyvern on your local machine.
...
Access the UI at [http://localhost:8080](http://localhost:8080) to run and manage tasks.
...
The code example starts a task in a browser, which automatically closes after completion.  View task history at [http://localhost:8080/history](http://localhost:8080/history).

You can also configure Skyvern to run on different targets:
...
Skyvern is inspired by the Task-Driven autonomous agent design with browser automation capabilities.

*   **Agent-Based Approach:** Skyvern utilizes a swarm of intelligent agents to understand, plan, and execute actions on websites.
*   **Resilience:**  It's designed to handle website layout changes without breaking.
*   **Scalability:** A single workflow can be applied across many websites.
*   **LLM-Driven Reasoning:** Leverages LLMs for complex interactions, such as contextually understanding questions and inferring information.
...
Skyvern achieves SOTA performance on the [WebBench benchmark](webbench.ai) with a 64.4% accuracy. The technical report and evaluation is [here](https://blog.skyvern.com/web-bench-a-new-way-to-compare-ai-browser-agents/)
...
<p align="center">
  <img src="fern/images/invoice_downloading_workflow_example.png" alt="Invoice Downloading Workflow"/>
</p>
...
See how Skyvern is automating real-world tasks:
...
Find comprehensive documentation on our [📕 docs page](https://docs.skyvern.com). For questions or suggestions, reach out [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
...
Planned features for the upcoming months:
...
We welcome contributions! Open a PR/issue or reach out [via email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3). Consult our [contribution guide](CONTRIBUTING.md) and ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22).
...
The open-source core is licensed under the [AGPL-3.0 License](LICENSE), with anti-bot measures available in our managed cloud offering. For licensing questions, [contact us](mailto:support@skyvern.com).
