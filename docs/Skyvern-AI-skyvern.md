...
[Skyvern](https://github.com/Skyvern-AI/skyvern) empowers you to automate complex browser-based tasks using Large Language Models (LLMs) and computer vision, streamlining your workflow with intelligent automation.  Skyvern provides a simple API endpoint to fully automate manual workflows on a large number of websites, replacing brittle or unreliable automation solutions.
...
*   ✨ **Intelligent Automation:** Automates tasks without requiring custom scripts for each website.
*   🌐 **Website Agnostic:** Works on websites it's never seen before, adapting to layout changes.
*   🔗 **Workflow Flexibility:** Applies a single workflow to numerous websites.
*   🧠 **LLM-Powered Reasoning:** Handles complex scenarios, like inferring information and understanding context.
*   🚀 **Rapid Development:** Easily create tasks, automate workflows, and extract data.
*   ⚙️ **Advanced Integration:** Integrates with various password managers, 2FA methods, and popular platforms like Zapier, Make.com, and N8N.
*   💻 **Flexible Deployment:** Run locally, in the cloud, or integrate with remote browsers.
...
Skyvern leverages a task-driven agent design inspired by [BabyAGI](https://github.com/yoheinakajima/babyagi) and [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT). It utilizes browser automation libraries like [Playwright](https://playwright.dev/) to interact with websites.
...
>   ⚠️ WARNING: Since [Chrome 136](https://developer.chrome.com/blog/remote-debugging-port), Chrome refuses any CDP connect to the browser using the default user\_data\_dir. In order to use your browser data, Skyvern copies your default user\_data\_dir to `./tmp/user_data_dir` the first time connecting to your local browser. ⚠️
...
Tasks are the fundamental building blocks in Skyvern. Each task represents a single instruction to navigate a website and achieve a specific objective.

Tasks require a `url`, a `prompt`, and optionally a `data schema` (for structured output) and `error codes` (to stop execution under certain conditions).
...
Workflows allow you to chain multiple tasks together to create complex, cohesive automation processes.

For instance, download all invoices newer than January 1st: navigate to the invoices page, filter by date, extract invoice details, and download each.

Another example is Automate purchasing products from an e-commerce store, you could create a workflow that first navigated to the desired product, then added it to a cart. Second, it would navigate to the cart and validate the cart state. Finally, it would go through the checkout process to purchase the items.
...
See how Skyvern is being used to automate real-world workflows. Open PRs to add your examples!
...
<p align="center">
  <img src="fern/images/job_application_demo.gif" alt="Job Application">
</p>
...
<p align="center">
  <img src="fern/images/geico_shu_recording_cropped.gif" alt="Geico">
</p>
...
Our planned roadmap for the next few months. Reach out with suggestions!
...
We welcome PRs and suggestions!  [Contribute](CONTRIBUTING.md) or reach out via [email](mailto:founders@skyvern.com) or [discord](https://discord.gg/fG2XXEuQX3).
Check out ["Help Wanted" issues](https://github.com/skyvern-ai/skyvern/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) to get started!
