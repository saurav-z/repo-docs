...
**Quickly search and explore YouTube video content using full-text and semantic search capabilities.** ([Back to Original Repo](https://github.com/NotJoeMartinez/yt-fts))
...
*   **Full-Text Search:** Easily find specific keywords and phrases within YouTube video transcripts using SQLite's Enhanced Query Syntax.
*   **Semantic Search:** Utilize OpenAI and Gemini embedding APIs for intelligent, context-aware search results.
*   **LLM Chat Bot:** Converse with a chatbot that uses your semantic search results as context for more informed answers.
*   **Video Summarization:** Quickly get summarized overviews of videos, complete with timestamped links.
*   **Channel & Playlist Support:** Download and search transcripts from entire channels or playlists.
*   **Flexible Exporting:** Export search results to CSV files and transcripts to TXT or VTT format.
