...
## PostHog: The Open-Source Product Analytics and A/B Testing Platform

**PostHog is an open-source product analytics platform that provides all the tools you need to build better products, faster.** This repository contains the source code for the core PostHog platform.  For the latest updates and full documentation, visit the official [PostHog website](https://posthog.com/).

**Key Features:**

*   **Product Analytics:** Understand user behavior with event-based analytics, visualizations, and SQL-based querying.
*   **Web Analytics:** Monitor website traffic, user sessions, conversions, web vitals, and revenue in an intuitive dashboard.
...
*   **Experiments (A/B Testing):** Test changes and measure their impact on key metrics, with no-code setup options.
*   **Error Tracking:** Identify, track, and resolve errors to improve product stability.
*   **Surveys:**  Gather user feedback with pre-built survey templates or create custom surveys.
*   **Data Warehouse:** Sync data from external tools (Stripe, HubSpot, data warehouses, etc.) and query it alongside your product data.
*   **Data Pipelines (CDP):**  Transform and route your incoming data to 25+ tools or any webhook in real-time or batch.
*   **LLM Observability:** Capture traces, generations, latency, and cost for your LLM-powered applications.

PostHog offers a [generous monthly free tier](https://posthog.com/pricing) for all of the above features!

### Table of Contents

*   [Getting Started with PostHog Cloud](#getting-started-with-posthog-cloud-recommended)
*   [Self-hosting the Open-Source Platform](#self-hosting-the-open-source-hobby-deploy-advanced)
...
The quickest and most reliable way to get started is by signing up for a free account on [PostHog Cloud US](https://us.posthog.com/signup) or [PostHog Cloud EU](https://eu.posthog.com/signup). Enjoy a generous free tier including 1 million events, 5k recordings, 1M flag requests, 100k exceptions, and 250 survey responses per month.

## Self-hosting the Open-Source Platform (Advanced)

You can self-host PostHog with a Docker deployment (4GB memory recommended):

```bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/posthog/posthog/HEAD/bin/deploy-hobby)"
```

Self-hosted instances are best suited for 100k events per month or fewer. Beyond this, [migrating to PostHog Cloud](https://posthog.com/docs/migrate/migrate-to-cloud) is recommended.

*Support and guarantees are not provided for open source deployments.*  Consult the [self-hosting docs](https://posthog.com/docs/self-host), [troubleshooting guide](https://posthog.com/docs/self-host/deploy/troubleshooting), and [disclaimer](https://posthog.com/docs/self-host/open-source/disclaimer) for further information.

## Setting Up PostHog

Integrate PostHog with your product by installing the [JavaScript web snippet](https://posthog.com/docs/getting-started/install?tab=snippet), one of our [SDKs](https://posthog.com/docs/getting-started/install?tab=sdks), or our [API](https://posthog.com/docs/getting-started/install?tab=api).

**SDKs and Libraries:**

We offer SDKs for popular languages and frameworks:
...
After installation, explore our [product documentation](https://posthog.com/docs/product-os) to learn how to utilize [product analytics](https://posthog.com/docs/product-analytics/capture-events), [web analytics](https://posthog.com/docs/web-analytics/getting-started), [session replays](https://posthog.com/docs/session-replay/how-to-watch-recordings), [feature flags](https://posthog.com/docs/feature-flags/creating-feature-flags), [experiments](https://posthog.com/docs/experiments/creating-an-experiment), [error tracking](https://posthog.com/docs/error-tracking/installation#setting-up-exception-autocapture), [surveys](https://posthog.com/docs/surveys/installation), and [data warehouse](https://posthog.com/docs/cdp/sources).

## Learning More about PostHog

Our open-source approach extends beyond code – we also open-source our [company handbook](https://posthog.com/handbook). This resource details our [strategy](https://posthog.com/handbook/why-does-posthog-exist), [culture](https://posthog.com/handbook/company/culture), and [processes](https://posthog.com/handbook/team-structure).

To get the most out of PostHog, check out our guide on [winning with PostHog](https://posthog.com/docs/new-to-posthog/getting-hogpilled) which walks you through the basics of [measuring activation](https://posthog.com/docs/new-to-posthog/activation), [tracking retention](https://posthog.com/docs/new-to-posthog/retention), and [capturing revenue](https://posthog.com/docs/new-to-posthog/revenue).

## Contributing

We appreciate all contributions!

*   Vote on features and get early access to beta functionality via our [roadmap](https://posthog.com/roadmap).
*   Submit a PR following our [local development instructions](https://posthog.com/handbook/engineering/developing-locally).
*   Submit a [feature request](https://github.com/PostHog/posthog/issues/new?assignees=&labels=enhancement%2C+feature&template=feature_request.md) or [bug report](https://github.com/PostHog/posthog/issues/new?assignees=&labels=bug&template=bug_report.md).

## Open-source vs. Paid

This repository uses the [MIT expat license](https://github.com/PostHog/posthog/blob/master/LICENSE), excluding the `ee` directory (which has its own [license](https://github.com/PostHog/posthog/blob/master/ee/LICENSE)).

Need a completely free and open-source version? Explore our [posthog-foss](https://github.com/PostHog/posthog-foss) repository.

Transparent pricing details are available on [our pricing page](https://posthog.com/pricing).

## We’re Hiring!

Do you enjoy reading READMEs?  Consider joining our growing team!  We're looking for talented individuals - check out our [careers page](https://posthog.com/careers) for opportunities.
