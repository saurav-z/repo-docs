...
**PostHog is a comprehensive, open-source platform empowering you to build successful products with powerful analytics and product management tools.**  Explore the source code and contribute on [GitHub](https://github.com/PostHog/posthog)!

### Key Features

*   **Product Analytics:** Understand user behavior with event-based analytics, autocapture, and data visualization.
*   **Web Analytics:** Monitor website traffic, track conversions, and analyze web vitals with an intuitive dashboard.
*   **Session Replays:**  Watch user sessions to diagnose issues and gain insights into user interactions.
*   **Feature Flags:** Safely roll out new features to specific user segments using feature flags.
*   **Experiments:** A/B test changes and measure their impact on key metrics without any code.
*   **Error Tracking:**  Track, alert on, and resolve errors to improve your product's stability.
*   **Surveys:** Gather user feedback with no-code survey templates.
*   **Data Warehouse Integration:** Sync data from various sources to analyze it alongside your product data.
*   **Data Pipelines:**  Transform and route your data to 25+ tools or your data warehouse.
*   **LLM Observability:** Monitor your LLM-powered applications by capturing traces, generations, latency, and cost.

**Get Started Free:** Enjoy a generous free tier! Sign up for [PostHog Cloud US](https://us.posthog.com/signup) or [PostHog Cloud EU](https://eu.posthog.com/signup).
...
The easiest and most reliable way to start is by signing up for free to [PostHog Cloud](https://us.posthog.com/signup) or [PostHog Cloud EU](https://eu.posthog.com/signup). You get 1 million events, 5k recordings, 1M flag requests, 100k exceptions, and 250 survey responses free every month. After that, you pay based on usage.

## Self-hosting the open-source hobby deploy (Advanced)

To self-host PostHog, deploy a hobby instance on Linux with Docker (recommended 4GB memory):

```bash 
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/posthog/posthog/HEAD/bin/deploy-hobby)" 
```

Open source deployments should scale to approximately 100k events per month.  For larger needs, we recommend [migrating to a PostHog Cloud](https://posthog.com/docs/migrate/migrate-to-cloud). 
...
Integrate PostHog by installing our [JavaScript web snippet](https://posthog.com/docs/getting-started/install?tab=snippet), one of [our SDKs](https://posthog.com/docs/getting-started/install?tab=sdks), or [using our API](https://posthog.com/docs/getting-started/install?tab=api).

We have SDKs and libraries for popular languages and frameworks:
...
Find more docs and guides for [Go](https://posthog.com/docs/libraries/go), [.NET/C#](https://posthog.com/docs/libraries/dotnet), [Django](https://posthog.com/docs/libraries/django), [Angular](https://posthog.com/docs/libraries/angular), [WordPress](https://posthog.com/docs/libraries/wordpress), [Webflow](https://posthog.com/docs/libraries/webflow), and more.

After installation, explore the [product docs](https://posthog.com/docs/product-os) for details on [product analytics](https://posthog.com/docs/product-analytics/capture-events), [web analytics](https://posthog.com/docs/web-analytics/getting-started), [session replays](https://posthog.com/docs/session-replay/how-to-watch-recordings), [feature flags](https://posthog.com/docs/feature-flags/creating-feature-flags), [experiments](https://posthog.com/docs/experiments/creating-an-experiment), [error tracking](https://posthog.com/docs/error-tracking/installation#setting-up-exception-autocapture), [surveys](https://posthog.com/docs/surveys/installation), [data warehouse](https://posthog.com/docs/cdp/sources), and more.

## Learning more about PostHog

Our open-source approach extends to our documentation too 😳.  Explore our [company handbook](https://posthog.com/handbook) to learn about our [strategy](https://posthog.com/handbook/why-does-posthog-exist), [culture](https://posthog.com/handbook/company/culture), and [processes](https://posthog.com/handbook/team-structure).

Need help using PostHog? Check out our guide to [winning with PostHog](https://posthog.com/docs/new-to-posthog/getting-hogpilled) which walks you through [measuring activation](https://posthog.com/docs/new-to-posthog/activation), [tracking retention](https://posthog.com/docs/new-to-posthog/retention), and [capturing revenue](https://posthog.com/docs/new-to-posthog/revenue).
...
For a completely open-source experience, see our [posthog-foss](https://github.com/PostHog/posthog-foss) repository.

Transparency is key, our pricing is available on [our pricing page](https://posthog.com/pricing). 

## We’re hiring!

If you've reached this point, you might be a great fit for our team!

We're growing fast [and would love for you to join us](https://posthog.com/careers).
