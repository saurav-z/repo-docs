...
PostHog is an all-in-one, open-source product analytics platform, empowering you to build and grow successful products. With PostHog, you gain comprehensive insights into user behavior and product performance, all in one place.

**Key Features:**

*   **Product Analytics:** Understand user behavior with event-based analytics, autocapture, and data analysis through visualizations and SQL.
*   **Web Analytics:** Monitor web traffic, user sessions, conversions, web vitals, and revenue with a GA-like dashboard.
*   **Session Replays:** Watch real user sessions to diagnose issues and understand user interactions on your website or mobile app.
*   **Feature Flags:** Safely roll out features to select users or cohorts with feature flags.
*   **Experiments:** Test changes and measure their statistical impact on goal metrics, setup experiments without code.
*   **Error Tracking:** Track errors, receive alerts, and resolve issues to improve your product.
*   **Surveys:** Gather user feedback with no-code survey templates or build custom surveys.
*   **Data Warehouse:** Sync data from external tools (e.g., Stripe, HubSpot) and your data warehouse, querying it alongside your product data.
*   **Data Pipelines:** Run custom filters and transformations on your incoming data and send it to 25+ tools or any webhook in real-time or batch export large amounts to your warehouse.
*   **LLM Observability:** Capture traces, generations, latency, and cost for your LLM-powered app.

**Ready to get started?**

*   **[Sign up for PostHog Cloud US](https://us.posthog.com/signup)**
*   **[Sign up for PostHog Cloud EU](https://eu.posthog.com/signup)**

PostHog offers a [generous monthly free tier](https://posthog.com/pricing) to help you get started.

**Find out more!**
*   **[See what PostHog can do for your business!](https://posthog.com/why)**
...
The fastest and most reliable way to get started with PostHog is by signing up for free to [PostHog Cloud](https://us.posthog.com/signup) or [PostHog Cloud EU](https://eu.posthog.com/signup). Enjoy a generous free tier with 1 million events, 5k recordings, 1M flag requests, 100k exceptions, and 250 survey responses monthly.

## Self-hosting (Advanced)

If you want to self-host PostHog, you can deploy a hobby instance in one line on Linux with Docker (4GB memory recommended):

```bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/posthog/posthog/HEAD/bin/deploy-hobby)"
```

Open-source deployments should scale to approximately 100k events per month. For larger usage, we recommend [migrating to PostHog Cloud](https://posthog.com/docs/migrate/migrate-to-cloud).

*We do not* provide customer support or guarantees for open-source deployments. See our [self-hosting docs](https://posthog.com/docs/self-host), [troubleshooting guide](https://posthog.com/docs/self-host/deploy/troubleshooting), and [disclaimer](https://posthog.com/docs/self-host/open-source/disclaimer) for more info.

## Setting Up PostHog

Get started by installing the [JavaScript web snippet](https://posthog.com/docs/getting-started/install?tab=snippet), using one of our [SDKs](https://posthog.com/docs/getting-started/install?tab=sdks), or by [using our API](https://posthog.com/docs/getting-started/install?tab=api).

We provide SDKs and libraries for popular languages and frameworks:
...
Explore our comprehensive documentation for [Go](https://posthog.com/docs/libraries/go), [.NET/C#](https://posthog.com/docs/libraries/dotnet), [Django](https://posthog.com/docs/libraries/django), [Angular](https://posthog.com/docs/libraries/angular), [WordPress](https://posthog.com/docs/libraries/wordpress), [Webflow](https://posthog.com/docs/libraries/webflow), and more.

Once installed, consult our [product docs](https://posthog.com/docs/product-os) to learn how to configure [product analytics](https://posthog.com/docs/product-analytics/capture-events), [web analytics](https://posthog.com/docs/web-analytics/getting-started), [session replays](https://posthog.com/docs/session-replay/how-to-watch-recordings), [feature flags](https://posthog.com/docs/feature-flags/creating-feature-flags), [experiments](https://posthog.com/docs/experiments/creating-an-experiment), [error tracking](https://posthog.com/docs/error-tracking/installation#setting-up-exception-autocapture), [surveys](https://posthog.com/docs/surveys/installation), [data warehouse](https://posthog.com/docs/cdp/sources), and more.

## Learning More About PostHog

Our open-source approach extends beyond code. Explore our open-source [company handbook](https://posthog.com/handbook) to learn about our [strategy](https://posthog.com/handbook/why-does-posthog-exist), [ways of working](https://posthog.com/handbook/company/culture), and [processes](https://posthog.com/handbook/team-structure).

Want to maximize your PostHog experience? Read our guide, "[Winning with PostHog](https://posthog.com/docs/new-to-posthog/getting-hogpilled)," to master [measuring activation](https://posthog.com/docs/new-to-posthog/activation), [tracking retention](https://posthog.com/docs/new-to-posthog/retention), and [capturing revenue](https://posthog.com/docs/new-to-posthog/revenue).
...
This repository is available under the [MIT expat license](https://github.com/PostHog/posthog/blob/master/LICENSE), excluding the `ee` directory, which has its own [license](https://github.com/PostHog/posthog/blob/master/ee/LICENSE).
...
Our [pricing page](https://posthog.com/pricing) provides transparent details on our paid plans.

## We're Hiring!

If you're reading this, you likely enjoy reading and are great at it!

You might just be the perfect addition to our growing team.  See open positions at [PostHog](https://posthog.com/careers).
