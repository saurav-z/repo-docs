...
<div align="center">
  <em>The ultimate observability and developer tool platform for AI Agents, helping you build, evaluate, and monitor your agents with ease.</em>
</div>
...
## AgentOps: AI Agent Observability & DevTools

AgentOps empowers developers to build, evaluate, and monitor AI agents from prototype to production. Get started with AgentOps - the go-to platform for debugging, cost management, and more.  [Learn More](https://github.com/AgentOps-AI/agentops)
...
*   **Framework Integrations**: Seamless integrations with CrewAI, AG2 (AutoGen), Camel AI, and LangChain.
...
Refer to our [documentation](http://docs.agentops.ai) for detailed examples and usage.
...
AgentOps seamlessly integrates with the OpenAI Agents SDKs, for both Python and TypeScript, enabling powerful multi-agent system monitoring.
...
Add observability to CrewAI agents in just two lines of code! Automatic monitoring on the AgentOps dashboard is enabled simply by setting an `AGENTOPS_API_KEY` in your environment.
...
Get full observability and monitoring for AG2 (formerly AutoGen) agents with just two lines of code. Set an `AGENTOPS_API_KEY` in your environment and call `agentops.init()`.
...
Track and analyze CAMEL agents with comprehensive observability. Set an `AGENTOPS_API_KEY` and initialize AgentOps to start.
...
AgentOps is your all-in-one solution for building, testing, and monitoring AI agents, enabling you to go from prototype to production.
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/64493665?s=40&v=4" width="20" height="20" alt="">  &nbsp; [ton