...
<div align="center">
  <em>**Supercharge your AI Agent Development with AgentOps: Build, Monitor, and Evaluate with Ease**</em>
</div>
...
*   **Seamless Framework Integrations:** Native integrations with CrewAI, AG2 (AutoGen), LangGraph, and more.
*   **Self-Hosting Option:** Run AgentOps on your own infrastructure for complete control.
...
1.  [Get an API key](https://app.agentops.ai/settings/projects)
2.  Insert API key in your code:
...
AgentOps seamlessly integrates with the most popular agent frameworks and LLM providers, accelerating your development workflow.
...
Explore the power of AgentOps with these detailed sections:
...
AgentOps provides first-class developer experience with intuitive decorators to add observability to your agents, tools, and functions.

Refer to our [documentation](http://docs.agentops.ai) for detailed guides.
...
AgentOps offers seamless integration with many frameworks.

### OpenAI Agents SDK 🖇️

AgentOps integrates with the OpenAI Agents SDKs for Python and TypeScript.
...
Easily monitor your CrewAI agents.
...
Add full observability to AG2 (formerly AutoGen) agents with two lines of code.
...
AgentOps supports Langchain applications.
...
AgentOps provides the necessary tools to make AI agents faster, more efficient, and reliable. 
...
*   **Failure Detection**: Quickly identify and resolve agent and multi-agent interaction issues.
*   **Tool Usage Statistics**: Understand how your agents utilize external tools with detailed analytics.
*   **Session-Wide Metrics**: Obtain a holistic view of agent sessions through comprehensive statistics.
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/140554352?s=40&v=4" width="20" height="20" alt="">  &nbsp; [AgentOps-AI](https://github.com/AgentOps-AI) / [Jaiqu](https://github