...
<div align="center">
  <em>The ultimate observability and devtool platform for AI agents, helping you build, evaluate, and monitor your agents from prototype to production.</em>
</div>
...
AgentOps provides a powerful platform for building, evaluating, and monitoring AI agents, helping developers bring their agents from prototype to production.

**[Visit the AgentOps GitHub Repository](https://github.com/AgentOps-AI/agentops)**

### Key Features

*   📊 **Replay Analytics and Debugging:** Step-by-step agent execution graphs for easy debugging.
*   💸 **LLM Cost Management:** Track and manage spending with detailed LLM usage data.
*   🤝 **Framework Integrations:** Native integrations with CrewAI, AG2 (AutoGen), Agno, LangGraph, and more.
*   🛠️ **Self-Host:** Run AgentOps on your own cloud infrastructure.
*   🚀 **Real-time Monitoring:** Monitor agents with session replays and live metrics.
*   ⚙️ **Cost Control:** Monitor your API and LLM spend with ease.
*   🐞 **Failure Detection:** Quickly identify and respond to agent failures.
*   🛠️ **Tool Usage Insights:** Get statistics on tool usage to refine your agent design.
*   📊 **Session Metrics:** Gain a holistic view of your agent's performance with session-wide stats.
...
3.  **Initialize and End a Session:**
...
4.  **View Your Sessions:** All your sessions can be viewed on the [AgentOps dashboard](https://app.agentops.ai?ref=gh)

### Self-Hosting

Run the full AgentOps application (Dashboard + API backend) on your infrastructure.  Follow the setup guide in `app/README.md`:
...
Add powerful observability to your agents, tools, and functions with minimal code.
...
Build Crew agents with observability in just 2 lines of code by simply setting an `AGENTOPS_API_KEY` in your environment, and your crews will get automatic monitoring on the AgentOps dashboard.
...
AgentOps works seamlessly with applications built using Langchain. Install the Langchain extra for seamless integration.
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/18406448?s=40&v=4" width="20" height="20" alt="">  &