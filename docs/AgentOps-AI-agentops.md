...
<div align="center">
  <em>**Supercharge your AI agents with AgentOps: the ultimate observability and devtool platform!**</em>
</div>
...
AgentOps empowers developers to build, evaluate, and monitor AI agents, from prototype to production.

## Key Features 🚀

*   **Replay Analytics and Debugging:** Visualize agent execution with step-by-step graphs.
*   **LLM Cost Management:** Track and manage spending with LLM providers.
...
*   **Framework Integrations:** Built-in support for CrewAI, AG2 (AutoGen), Camel AI, LangChain, and more.
...
Initialize the AgentOps client to automatically get analytics on your LLM calls.
...
Refer to our [documentation](http://docs.agentops.ai) for in-depth guides.
...
Seamlessly integrate with the OpenAI Agents SDK for Python and TypeScript.
...
Get CrewAI observability with just two lines of code. Set `AGENTOPS_API_KEY` in your environment.
...
Add full observability to AG2 (formerly AutoGen) agents with just two lines of code. Set `AGENTOPS_API_KEY` in your environment and call `agentops.init()`.
...
AgentOps integrates seamlessly with Langchain applications. Install the Langchain extra:
...
Integrate with the Langchain callback handler:
...
AgentOps supports LiteLLM(>=1.3.1), calling 100+ LLMs using the same Input/Output format.
...
AgentOps integrates seamlessly with LlamaIndex.
...
Without the right tools, AI agents can be slow, expensive, and unreliable. AgentOps is here to help you bring your agent from prototype to production. Here's why AgentOps stands out:
...
Discover how AgentOps is powering top AI projects:
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/3074263?s=40&v=4" width="20" height="20" alt="">  &nbsp; [strnad](https://github.com/strnad/CrewAI-Studio) | 134 |
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u