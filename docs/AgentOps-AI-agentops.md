...
<div align="center">
  <em>**AgentOps: Build, Evaluate, and Monitor Your AI Agents from Prototype to Production**</em>
</div>
...
**AgentOps** is an open-source observability and developer tool platform designed for AI agent development. This allows developers to rapidly build, evaluate, and monitor their AI agents, from the initial prototype to full production deployment. Visit the [AgentOps GitHub repository](https://github.com/AgentOps-AI/agentops) to learn more and get started.

## Key Features

*   **Replay Analytics and Debugging:** Step-by-step agent execution graphs for deep dives.
*   **LLM Cost Management:** Track and control spending with LLM providers.
*   **Framework Integrations:** Native support for CrewAI, AG2 (AutoGen), LangGraph, Camel AI, OpenAI Agents and more.
...
Initialize the AgentOps client to automatically track and analyze your LLM calls. Get your API key from the [AgentOps Dashboard](https://app.agentops.ai/settings/projects).
...
View all of your sessions and analyses in the [AgentOps dashboard](https://app.agentops.ai?ref=gh).

## Self-Hosting

For running the complete AgentOps app (dashboard + API backend) on your own machine, follow the setup guide in the `app/README.md` file:
...
AgentOps' decorators make it easy to add observability to your agents, tools, and functions with minimal code:
...
Integrate CrewAI agents with observability in just two lines of code. Set an `AGENTOPS_API_KEY` in your environment, and your crews will get automatic monitoring on the AgentOps dashboard.
...
Add full observability and monitoring to AG2 (formerly AutoGen) agents in two lines of code. Set an `AGENTOPS_API_KEY` in your environment and call `agentops.init()`.
...
Track and analyze CAMEL agents with full observability. Initialize AgentOps after setting the `AGENTOPS_API_KEY` in your environment.
...
Seamlessly integrate with Langchain applications.  Install the Langchain dependency to enable the AgentOps callback handler:
...
AgentOps is built to bring your AI agent from prototype to production. Here's why:
...
A list of popular projects using AgentOps:
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/