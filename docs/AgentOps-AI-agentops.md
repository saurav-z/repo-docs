...
<div align="center">
  <em>**Debug, Monitor, and Optimize Your AI Agents with AgentOps: The Observability Platform**</em>
</div>
...
AgentOps empowers developers to build, evaluate, and monitor AI agents, transforming them from prototype to production.

## Key Features

*   ✅ **Replay Analytics & Debugging:** Step-by-step agent execution graphs.
*   💸 **LLM Cost Management:** Track spend with LLM providers.
*   🤝 **Framework Integrations:** Seamless integration with CrewAI, AG2 (AutoGen), LangGraph, and more.
*   ⚒️ **Self-Host:**  Run AgentOps on your own infrastructure.

**[Explore the AgentOps Platform](https://github.com/AgentOps-AI/agentops)**

## Get Started Quickly

Install AgentOps and add observability to your AI agents with just a few lines of code!
...
AgentOps seamlessly integrates with the OpenAI Agents SDK for Python and Typescript to build multi-agent systems with tools, handoffs, and guardrails.
...
Get automatic agent monitoring for your CrewAI agents with AgentOps in just 2 lines of code.
...
Add full observability and monitoring to AG2 (formerly AutoGen) agents with two lines of code.
...
AgentOps integrates with Langchain, providing detailed observability.
...
AgentOps supports LiteLLM(>=1.3.1) to call 100+ LLMs with the same Input/Output Format.
...
AgentOps provides seamless integration with LlamaIndex to build context-augmented generative AI applications with LLMs.
...
| 🚧 Success validators (external)          | 🔜 Execution containers                                                             | 🚧 Token limit overflow flags             | 🔜 Generative code validators                     |
...
AgentOps provides comprehensive observability, testing, and monitoring to accelerate your AI agent development.
...
-   **Tool Usage Statistics**: Understand agent tool utilization with detailed analytics.
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/109994880?s=40&v=4" width="20" height="20" alt="">  &nbsp; [bhancockio](https://github