...
**Supercharge your AI-powered development experience with AWS MCP Servers, providing intelligent context and automation to streamline your cloud workflows. Explore the original repo [here](https://github.com/awslabs/mcp).**
...
*   **Enhanced AI Integration:** Seamlessly connect your AI tools (like IDEs and chatbots) to AWS services.
*   **Real-Time AWS Knowledge:** Access up-to-date AWS documentation, API references, and best practices directly within your development environment.
*   **Workflow Automation:** Automate complex cloud tasks with support for CDK, Terraform, and other AWS-specific tools.
*   **Domain-Specific Expertise:** Get accurate, contextual knowledge about AWS services to improve your cloud development.
*   **One-Click Installation:** Easily install MCP servers directly within popular IDEs and coding assistants like Cursor and VS Code.
...
| Server Name                                                    | Description                                                                                                                                                                          | Install                                                                                                                                                                                                                                                                   |
| :------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AWS Serverless MCP Server](src/aws-serverless-mcp-server)       | Complete serverless application lifecycle with SAM CLI                                                                                                                             | [![Install](https://img.shields.io/badge/Install-Cursor-blue?style=flat-square&logo=cursor)](https://cursor.com/en/install-mcp?name=awslabs.aws-serverless-mcp-server&config=eyJjb21tYW5kIjoidXZ4IGF3c2xhYnMuYXdzLXNlcnZlcmxlc3MtbWNwLXNlcnZlckBsYXRlc3QgLS1hbGxvdy13cml0ZSAtLWFsbG93LXNlbnNpdGl2ZS1kYXRhLWFjY2VzcyIsImVudiI6eyJBV1NfUFJPRkl