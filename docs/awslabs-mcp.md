<!--
  Title: AWS MCP Servers: Enhance Your AI-Powered Development with AWS
  Description: Leverage the power of AWS within your AI-driven development environment using AWS MCP Servers. Integrate with your favorite tools, boost code generation accuracy, and access the latest AWS documentation.
  Keywords: AWS, MCP, Model Context Protocol, AI, development, code generation, AWS Documentation, serverless, containerization, cloud computing, Amazon Q, Cline, Cursor, Codeium, VS Code, Terraform, CDK
-->

# AWS MCP Servers: Enhance Your AI-Powered Development with AWS

**Supercharge your AI-assisted development with specialized AWS MCP Servers, bringing the power of AWS directly to your coding and development workflows.**
...
*   **Seamless Integration:** Directly connect your AI tools (IDEs, chatbots, etc.) to AWS services.
*   **Enhanced Code Generation:** Improve the accuracy and relevance of AI-generated code with context-aware AWS information.
*   **Up-to-Date Documentation:** Access the latest AWS documentation, API references, and best practices.
*   **Workflow Automation:** Convert common cloud development workflows into tools for AI assistants.
*   **Diverse Server Selection:** Servers for Infrastructure as Code, Serverless, Containerization, Data & Analytics, and more.
*   **Easy Installation:** One-click installation buttons for popular IDEs like Cursor and VS Code.
...
MCP is an open protocol designed to facilitate connections between Large Language Models (LLMs) and external resources, tools, and data. AWS MCP Servers provide an extension of this by enabling AI-powered applications to interact with AWS services within your development environment.  These servers act as intermediaries, providing real-time access to AWS documentation, API references, code examples, best practices, and up-to-date information. Through the standardized MCP client-server architecture, AWS capabilities become an intelligent extension of your development environment or AI application.

By using the MCP protocol, developers can utilize their existing AI tools to access, manage, and optimize their cloud infrastructure and application development workflows using AWS services.
...
| Server Name                       | Description                                                    | Install                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| :-------------------------------- | :------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [AWS Serverless MCP Server](src/aws-serverless-mcp-server) | Complete serverless application lifecycle with SAM CLI | [![Install](https://img.shields.io/badge/Install-Cursor-blue?style=flat-square&logo=cursor)](https://cursor.com/en/install-mcp?name=awslabs.aws-serverless-mcp-server&config=eyJjb21tYW5kIjoidXZ4IGF3c2xhYnMuYXdzLXNlcnZlcmxlc3MtbWNwLXNlcnZlckBsYXRlc3QgLS1hbGxvdy13cml0ZSAtLWFsbG93LX