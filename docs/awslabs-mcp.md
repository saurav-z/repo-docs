...
# AWS MCP Servers: Unlock AI-Powered Cloud Development 

**Supercharge your AI-assisted cloud development with AWS MCP Servers, providing intelligent context and streamlined workflows for a more efficient and accessible AWS experience. Explore the [original repo](https://github.com/awslabs/mcp) for in-depth information.**
...
*   **Enhanced LLM Context:** Provide foundation models (FMs) with up-to-date AWS documentation, API references, and best practices.
*   **Streamlined Workflows:** Convert common AWS tasks into tools for AI-assisted execution, improving efficiency.
*   **Real-time AWS Insights:** Access the latest information on AWS services, releases, and features.
*   **Developer Tool Integration:** Seamlessly integrate with AI coding assistants and IDEs.
*   **Wide Range of Servers:** Support for infrastructure, AI/ML, data analytics, developer tools, and more.
*   **One-Click Installation:** Easily install and configure servers for tools like Cursor and VS Code.
...
AWS MCP Servers extend the capabilities of the Model Context Protocol (MCP) by providing AI applications with access to AWS documentation, contextual guidance, and best practices. They act as lightweight programs exposing specific functionalities through the standardized MCP, allowing host applications such as chatbots, IDEs, and other AI tools to connect and enhance their output. By leveraging the client-server architecture of MCP, AWS capabilities become intelligent extensions of your development environment or AI application, enabling enhanced cloud-native development, infrastructure management, and streamlined workflows.

The Model Context Protocol is an open-source project run by Anthropic, PBC, and welcomes contributions from the community. For more information, explore the [MCP documentation](https://modelcontextprotocol.io/introduction).
