# AWS MCP Servers: Supercharge Your AWS Development with AI

**Enhance your cloud development with AI-powered assistance using AWS MCP Servers, bringing AWS expertise directly into your coding environment.  [Explore the GitHub repository](https://github.com/awslabs/mcp) for the latest updates and contributions.**
...
*   **AI-Powered Assistance:** Integrate AWS knowledge and best practices directly into your AI coding tools.
*   **Up-to-Date Documentation:** Access the latest AWS documentation and API references, ensuring your AI assistant always has current information.
*   **Workflow Automation:** Automate common tasks like CDK, Terraform, and other AWS workflows.
*   **Specialized Domain Knowledge:** Get deep contextual knowledge about AWS services, improving the accuracy and helpfulness of responses for cloud development.
*   **One-Click Install:** Seamlessly integrate MCP servers with popular IDEs and AI assistants (Cursor, VS Code, and more).

## Table of Contents

1.  [What is the Model Context Protocol (MCP) and how does it work with AWS MCP Servers?](#what-is-the-model-context-protocol-mcp-and-how-does-it-work-with-aws-mcp-servers)
2.  [Server Sent Events Support Removal](#server-sent-events-support-removal)
    *   [Why AWS MCP Servers?](#why-aws-mcp-servers)
3.  [Available MCP Servers: Quick Installation](#available-mcp-servers-quick-installation)
...
4.  [MCP AWS Lambda Handler Module](#mcp-aws-lambda-handler-module)
5.  [When to use Local vs Remote MCP Servers?](#when-to-use-local-vs-remote-mcp-servers)
    *   [Local MCP Servers](#local-mcp-servers)
    *   [Remote MCP Servers](#remote-mcp-servers)
6.  [Use Cases for the Servers](#use-cases-for-the-servers)
...
AWS MCP Servers leverage the Model Context Protocol (MCP) to enhance the capabilities of your AI-powered tools by providing them with tailored access to AWS resources and information, empowering developers to accelerate cloud application development. These specialized servers expose specific functionalities through MCP, a standardized protocol facilitating seamless integration between LLM applications, such as AI-powered IDEs, chat interfaces, and other AI tools, and external data sources and tools. Common MCP clients include agentic AI coding assistants (like Q Developer, Cline, Cursor, Windsurf) as well as chatbot applications like Claude Desktop, with more clients coming soon. By connecting through MCP, these clients can access local data sources and remote services to provide additional context that improves the generated outputs from the models.

AWS MCP servers enhance cloud-native development, infrastructure management, and development workflows, making AI-assisted cloud computing more accessible and efficient.
...
| [AWS Lambda Tool MCP Server](src/lambda-tool-mcp-server) | Execute Lambda functions as AI tools for private resource access | [![Install](https://img.shields.io/badge/Install-Cursor-blue?style=flat-square&logo=cursor)](https://cursor.com/en/install-m