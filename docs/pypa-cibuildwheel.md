# cibuildwheel: Effortless Cross-Platform Python Wheel Builds

**Build Python wheels for macOS, Linux, and Windows with ease using cibuildwheel - [View on GitHub](https://github.com/pypa/cibuildwheel)!**
...
*   **Cross-Platform Compatibility:** Build wheels for Mac, Linux, and Windows.
*   **Multiple Python Versions:** Supports various Python versions, including CPython, PyPy, and GraalPy.
*   **CI/CD Integration:** Seamlessly integrates with GitHub Actions, Azure Pipelines, Travis CI, CircleCI, and GitLab CI.
...
*   **Platform Support:** Includes manylinux, musllinux, macOS, Windows, Android and iOS.

## What cibuildwheel Does

cibuildwheel automates the process of building and testing Python wheels across different operating systems and Python versions on your CI server. It supports a wide range of platforms and Python interpreters, allowing you to create robust and compatible wheels for your projects.
...
cibuildwheel runs within a CI service. The supported platforms depend on your CI service:
...
For comprehensive setup instructions, including deployment to PyPI, consult the [documentation](https://cibuildwheel.pypa.io) and explore the [examples](https://github.com/pypa/cibuildwheel/tree/main/examples).
...
See how other projects are using cibuildwheel:
...
>  Explore more examples on the [Working Examples](https://cibuildwheel.pypa.io/en/stable/working-examples) page in the docs.

## Legal Note

`cibuildwheel` uses `delocate` or `auditwheel` to repair wheels, potentially bundling dynamically linked libraries, similar to static linking. Check the licenses of any bundled code to ensure compatibility with your project's license.
...
For details, see the [Changelog](https://cibuildwheel.pypa.io/en/stable/changelog/).

---

## Contributing

To contribute to cibuildwheel, see the [docs](https://cibuildwheel.pypa.io/en/latest/contributing/).
...
`cibuildwheel` builds on the work of many:
...
*   @czaki for many contributions and support.
*   @mattip for PyPy support.

## See Also

Consider [matthew-brett/multibuild](http://github.com/matthew-brett/multibuild) or for Rust wheels: [maturin-action](https://github.com/PyO3/maturin-action).