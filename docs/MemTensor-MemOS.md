...
<h1 align="center">
  <img src="https://statics.memtensor.com.cn/logo/memos_color_m.png" alt="MemOS Logo" width="50"/> MemOS: Long-Term Memory for Large Language Models <img src="https://img.shields.io/badge/status-Preview-blue" alt="Preview Badge"/>
</h1>
...
MemOS revolutionizes Large Language Models by equipping them with robust long-term memory capabilities.  

**[Check out the MemOS source code on GitHub!](https://github.com/MemTensor/MemOS)**

## Key Features

*   **Memory-Augmented Generation (MAG):** Utilize a unified API for memory operations, integrating seamlessly with LLMs to enhance chat and reasoning through contextual memory retrieval.
*   **Modular Memory Architecture (MemCube):** Benefit from a flexible and modular architecture (MemCube) that allows for easy integration and management of different memory types, fostering adaptability.
*   **Multiple Memory Types:** Leverage various memory types for diverse needs:
    *   **Textual Memory:** Store and retrieve both unstructured and structured text knowledge.
    *   **Activation Memory:** Optimize LLM inference and context reuse by caching key-value pairs.
...
Here's an example of how to use the Memory Operating System (MOS):
...
Ensure you have [PyTorch](https://pytorch.org/get-started/locally/) installed (CUDA version recommended for GPU acceleration).
...
*   **GitHub Discussions:** Engage in discussions and share ideas [here](https://github.com/MemTensor/MemOS/discussions).
...
We welcome contributions! Refer to our [contribution guidelines](https://memos-docs.openmem.net/contribution/overview) for details.
