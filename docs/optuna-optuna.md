...
**Optimize your machine learning models with Optuna, a powerful and flexible hyperparameter optimization framework.**
...
Optuna is an open-source framework for automating hyperparameter optimization, designed to make machine learning model tuning efficient and easy. Its define-by-run API allows for flexible and dynamic search space construction. Access the [original repo](https://github.com/optuna/optuna) for more information.
...
*   **Efficient Optimization Algorithms:** Leverages state-of-the-art algorithms for hyperparameter sampling and efficient pruning of unpromising trials.
*   **Easy Parallelization:** Scale your studies across multiple workers with minimal code changes.
*   **Quick Visualization:** Visualize optimization histories with a variety of plotting functions.
*   **Lightweight and Versatile:** Lightweight, versatile, and platform-agnostic architecture.
...
The goal of a *study* is to find the optimal set of hyperparameter values through multiple *trials*.
...
Optuna integrates with various popular machine learning libraries.
...
Visualize your optimization studies in real-time with the [Optuna Dashboard](https://github.com/optuna/optuna-dashboard).
...
[OptunaHub](https://hub.optuna.org/) is a feature-sharing platform.
...
Contributions to Optuna are welcome! Check the [good first issues](https://github.com/optuna/optuna/labels/good%20first%20issue) for beginner-friendly tasks. For general guidelines, see [CONTRIBUTING.md](./CONTRIBUTING.md).
...
Optuna uses codes from SciPy and fdlibm (see [LICENSE\_THIRD\_PARTY](./LICENSE\_THIRD\_PARTY)).