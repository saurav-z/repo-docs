...
Tired of running out of tokens mid-session? **Claude Code Usage Monitor** is your real-time terminal companion, providing advanced analytics and intelligent predictions for your Claude AI token usage, saving you time and money. Check out the original repo [here](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor).
...
*   **Real-time Monitoring:** Track token consumption, burn rate, and cost analysis in real time.
*   **ML-Powered Predictions:** Get intelligent session limit detection and P90 percentile calculations.
*   **Rich Terminal UI:**  Beautiful color-coded progress bars, tables, and layouts.
...
*   **Customizable Configuration:**  Adjust refresh rates, themes, and time zones.
*   **Save Flags Feature**: Your configuration is automatically saved for next use.

### 🚀 v3.0.0 Key Updates

*   **Complete Architecture Rewrite:** A modular design with SRP compliance.
*   **P90 Analysis:** Machine learning-based limit detection.
*   **Updated Plan Limits:** Pro (19k), Max5 (88k), Max20 (220k), Custom (P90-based).
*   **Rich UI**: WCAG-compliant themes with automatic terminal background detection.
*   **New CLI Options**: Adjust refresh rates, time format, logging, and more.

## 🚀 Installation

### ⚡ Modern Installation with uv (Recommended)

uv is the easiest and fastest way to install the monitor.
