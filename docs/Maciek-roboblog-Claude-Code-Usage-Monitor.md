...
**Effortlessly monitor your Claude AI token consumption with real-time insights, intelligent predictions, and advanced analytics. ([View on GitHub](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor))**
...
Tired of unexpected charges or hitting token limits?  The Claude Code Usage Monitor is a powerful terminal tool that provides real-time monitoring, advanced analytics, and ML-powered predictions to optimize your Claude AI usage. Get detailed insights into your token consumption, burn rate, and cost analysis, plus smart warnings about session limits.

![Claude Token Monitor Screenshot](https://raw.githubusercontent.com/Maciek-roboblog/Claude-Code-Usage-Monitor/main/doc/scnew.png)

## 🔑 Key Features

*   📊 **Real-time Monitoring:** Track your token usage with configurable refresh rates (0.1-20 Hz) and an intelligent, responsive UI.
*   🔮 **ML-Based Predictions:**  Get P90 percentile calculations and intelligent session limit detection to avoid overages.
*   🤖 **Smart Auto-Detection:**  Automatic plan switching with custom limit discovery ensures you're always using the right plan.
*   📈 **Advanced Analytics:** Analyze your usage with cost analytics that accounts for model-specific pricing.
*   🎨 **Rich Terminal UI:**  Enjoy a beautiful, color-coded UI with progress bars, tables, and WCAG-compliant contrast for optimal readability.
*   ⚠️ **Advanced Warning System:** Multi-level alerts provide cost and time predictions to prevent surprises.
*   📦 **Easy Installation:** Simple setup using `uv` or `pip`.
...
[![Star History Chart](https://api.star-history.com/svg?repos=Maciek-roboblog/Claude-Code-Usage-Monitor&type=Date)](https://www.star-history.com/#Maciek-roboblog