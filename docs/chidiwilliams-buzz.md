...
**Effortlessly transcribe and translate audio files offline on your computer with Buzz, utilizing the power of OpenAI's Whisper.**  Learn more at the [original repository](https://github.com/chidiwilliams/buzz).
...
*   **Offline Translation:** Translate transcriptions into different languages without relying on the internet.
*   **Powered by Whisper:** Leverages the robust speech recognition capabilities of OpenAI's Whisper.
*   **Cross-Platform Compatibility:** Available for macOS, Windows, and Linux.
*   **Various Installation Methods:** Install using pip, brew, winget, Flatpak, or Snap.
*   **GPU Support (Optional):** Accelerate transcription on Nvidia GPUs for faster processing (PyPI installation).

**Get the Native Mac App for Enhanced Features:**
