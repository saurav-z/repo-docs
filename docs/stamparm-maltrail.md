<div align="center">
  <a href="https://github.com/stamparm/maltrail">
    <img src="https://i.imgur.com/3xjInOD.png" alt="Maltrail Logo" width="400"/>
  </a>
</div>
...
## Maltrail: Detect and Track Malicious Network Traffic

Maltrail is a powerful, open-source network intrusion detection system that leverages public and user-defined threat intelligence to identify and alert on malicious activity. 

**[View the Original Repo](https://github.com/stamparm/maltrail)**

### Key Features:

*   **Real-Time Threat Detection:** Monitors network traffic for known malicious indicators.
*   **Comprehensive Threat Intelligence:** Utilizes a wide range of blacklists, including:
    *   Various public feeds (e.g., AbuseIPDB, AlienVault, Emerging Threats).
    *   Static trails from malware reports and AV analysis.
    *   Custom user-defined lists for tailored threat detection.
*   **Heuristic Analysis:** Employs advanced techniques to identify unknown and emerging threats.
*   **Flexible Architecture:**
    *   **Sensor:** Standalone component to monitor traffic and detect threats.
    *   **Server:** Centralized component to store event details and provide a reporting interface.  Can be skipped if standalone sensor use is desired.
    *   **Client:** Reporting web application for easy threat analysis.
*   **User-Friendly Reporting Interface:**  Provides interactive dashboards, visualizations, and detailed event information.
*   **Extensive Blacklist and Trail Support:**  Constantly updated with malicious domains, URLs, IPs, and user-agent strings.
*   **Integration with Third-Party Tools:** Compatible with a variety of security platforms.
*   **Containerization:** Docker images are available for easy deployment.
...
Event details (e.g. `src_port`, `dst_port`, `proto`, etc.) that differ inside same threat entry are condensed in form of a bubble