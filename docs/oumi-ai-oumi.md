...
**Oumi empowers you to build, train, evaluate, and deploy powerful foundation models, from data preparation to production.**  Explore the [Oumi GitHub Repository](https://github.com/oumi-ai/oumi) to get started!
...
*   **Comprehensive Platform:** Manage the entire foundation model lifecycle, from data preparation to deployment.
*   **Wide Model Support:** Train and fine-tune a vast range of models, including text and multimodal architectures (Llama, DeepSeek, Qwen, Phi, and more).
*   **State-of-the-Art Techniques:** Utilize cutting-edge training methods (SFT, LoRA, QLoRA, DPO, etc.).
*   **Flexible Deployment:** Deploy efficiently with popular inference engines (vLLM, SGLang).
*   **Robust Evaluation:** Evaluate models comprehensively across standard benchmarks.
*   **Cloud Agnostic:** Run on laptops, clusters, and cloud platforms (AWS, Azure, GCP, Lambda, etc.).
*   **Easy Integration:** Integrate with open models and commercial APIs (OpenAI, Anthropic, Vertex AI, Together, Parasail, ...).
*   **Community Driven:**  Benefit from an active open-source community with production-grade reliability and research flexibility.
...
Quickly learn and experiment with Oumi using our Colab notebooks:
...
Get up and running with Oumi in a few simple steps:
...
Run jobs remotely on cloud platforms with `oumi launch`:
...
Oumi is an excellent choice if you need a comprehensive platform for training, evaluating, and deploying foundation models.
...
*   **Research Ready:** Perfect for reproducible experiments and customization.
*   **Broad Model Support:** Works with a wide range of models, text-only to multimodal.
*   **SOTA Performance:** Supports distributed training and optimized inference engines.
...
Explore the expanding library of configurations for state-of-the-art models and training workflows.  Find more supported [models](https://oumi.ai/docs/en/latest/resources/models/supported_models.html), [datasets](https://oumi.ai/docs/en/latest/resources/datasets/sft_datasets.html), and more in the official documentation.
...
Oumi seamlessly integrates with the [🤗 Transformers](https://github.com/huggingface/transformers) library, providing extensive model support.

**Click to see more supported models (base, instruct, code, math, vision-language):**
...
| Command R | 35B/104B | [Blog](https://cohere.com/