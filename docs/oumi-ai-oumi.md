...
Oumi seamlessly integrates with the [🤗 Transformers](https://github.com/huggingface/transformers) library, supporting a vast array of models. Refer to the comprehensive documentation for the full list of models.
...
Oumi uses many open-source libraries. We thank the contributors of these projects! ✨ 🌟 💫  [See Acknowledgments](https://oumi.ai/docs/en/latest/about/acknowledgements.html)
