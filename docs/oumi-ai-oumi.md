...
## Oumi: Build and Deploy Cutting-Edge Foundation Models End-to-End

Oumi is a fully open-source platform streamlining the complete lifecycle of foundation models, empowering you to build, train, evaluate, and deploy state-of-the-art models. **[Check out the original Oumi repository here.](https://github.com/oumi-ai/oumi)**

### Key Features

*   **Train & Fine-tune:** Models from 10M to 405B parameters using SFT, LoRA, QLoRA, DPO, and more.
*   **Model Support:** Works with both text and multimodal models (Llama, DeepSeek, Qwen, Phi, and others).
...
*   **Community Focused:** 100% open source with an active community.

### What's New

*   **Inference Support:** Inference support for OpenAI's `gpt-oss-20b` and `gpt-oss-120b`: [recipes here](https://github.com/oumi-ai/oumi/tree/main/configs/recipes/gpt_oss)
*   **Webinar:** Aug 14 Webinar - [OpenAI's gpt-oss: Separating the Substance from the Hype](https://youtu.be/g1PkAV7fXn0).
*   **Release:** [Oumi v0.3.0 released](https://github.com/oumi-ai/oumi/releases/tag/v0.3.0) with model quantization (AWQ), an improved LLM-as-a-Judge API, and Adaptive Inference
*   **Recipes:** Recipe for [Qwen3 235B](https://github.com/oumi-ai/oumi/blob/main/configs/recipes/qwen3/inference/235b_a22b_together_infer.yaml)
*   **Webinar:** July 24 webinar: ["Training a State-of-the-art Agent LLM with Oumi + Lambda"](https://youtu.be/f3SU_heBP54)
*   **Release:** [Oumi v0.2.0 released](https://github.com/oumi-ai/oumi/releases/tag/v0.2.0) with support for GRPO fine-tuning, a plethora of new model support, and much more
*   **Competition:** Announcement of [Data Curation for Vision Language Models (DCVLR) competition](https://oumi.ai/blog/posts/announcing-dcvlr) at NeurIPS2025
*   **Recipes:** Recipes for training, inference, and eval with the newly released [Falcon-H1](https://github.com/oumi-ai/oumi/tree/main/configs/recipes/falcon_h1) and [Falcon-E](https://github.com/oumi-ai/oumi/tree/main/configs/recipes/falcon_e) models
*   **Support:** Support and recipes for [InternVL3 1B](https://github.com/oumi-ai/oumi/tree/main/configs/recipes/vision/internvl3)
*   **Llama 4 Support:** Added support for training and inference with Llama 4 models: Scout (17B activated, 109B total) and Maverick (17B activated, 400B total) variants, including full fine-tuning, LoRA, and QLoRA configurations
*   **Qwen3 Support:** Recipes for [Qwen3 model family](https://github.com/oumi-ai/oumi/tree/main/configs/recipes/qwen3)
*   **HallOumi:** Introducing HallOumi: a State-of-the-Art Claim-Verification Model [(technical overview)](https://oumi.ai/blog/posts/introducing-halloumi)
...
Quickly understand and use Oumi through these resources:
...
Find further options in the [installation guide](https://oumi.ai/docs/en/latest/get_started/installation.html).

### CLI Usage

Use the `oumi` command for training, evaluation, and inference:
...
Explore more in the [training](https://oumi.ai/docs/en/latest/user_guides/train/train.html), [evaluation](https://oumi.ai/docs/en/latest/user_guides/evaluate/evaluate.html), [inference](https://oumi.ai/docs/en/latest/user_guides/infer/infer.html), and [llm-as-a-judge](https://oumi.ai/docs/en/latest/user_guides/judge/judge.html) guides.
...
**Note:** Oumi is in beta and under active development.

### Why Use Oumi?

Oumi is the ideal platform for:

*   **Zero Boilerplate:** Get started in minutes with pre-built recipes.
*   **Enterprise-Grade:** Built for scaling by those training models at scale.
*   **Research Ready:** Experiment-friendly with reproducible results and customizable interfaces.
*   **Broad Model Support:** Works with a wide array of models, text-based to multimodal.
*   **SOTA Performance:** Native support for distributed training and optimized inference engines.
*   **Community-Driven:** 100% open source with no vendor lock-in.

### Examples & Recipes

Access ready-to-use configurations:
...
Thanks to 🤗 Transformers, Oumi integrates with and supports a vast array of models, including those listed below.
...
| Falcon-Instruct | 7B/40B | [Paper](https://arxiv.org/abs/2306.01