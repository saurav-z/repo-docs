...
## Oumi: Build, Train, and Deploy State-of-the-Art Foundation Models with Ease

Oumi is a comprehensive, open-source platform that empowers you to build, train, and deploy foundation models from start to finish. Explore the [original repository](https://github.com/oumi-ai/oumi) for more information.

**Key Features:**

*   **End-to-End Solution:** Streamlines the entire model lifecycle, from data preparation and training to evaluation and deployment.
*   **Flexible & Versatile:** Train and fine-tune models ranging from 10M to 405B parameters, supporting various architectures including Llama, DeepSeek, Qwen, and Phi.
*   **Advanced Training Techniques:** Supports state-of-the-art techniques like SFT, LoRA, QLoRA, and DPO for optimal model performance.
*   **Multimodal Model Support:** Works seamlessly with both text and multimodal models.
*   **Data Curation:** Synthesize and curate training data efficiently using LLM judges.
*   **Efficient Deployment:** Deploy models using popular inference engines such as vLLM and SGLang.
*   **Comprehensive Evaluation:** Evaluate models using standard benchmarks for thorough performance analysis.
*   **Run Anywhere:** Supports deployment on various platforms, including laptops, clusters, and cloud providers like AWS, Azure, GCP, and Lambda.
*   **Extensive Integration:** Integrates with open models and commercial APIs, including OpenAI, Anthropic, Vertex AI, and Together.
*   **Community-Driven:** Benefit from a 100% open-source platform with an active and supportive community.
...
Get up and running with Oumi using these helpful resources:
...
Install Oumi with these simple commands:
...
Use the `oumi` command to train, evaluate, and infer models using existing [recipes](/configs/recipes):
...
```
Refer to the [training](https://oumi.ai/docs/en/latest/user_guides/train/train.html), [evaluation](https://oumi.ai/docs/en/latest/user_guides/evaluate/evaluate.html), [inference](https://oumi.ai/docs/en/latest/user_guides/infer/infer.html), and [llm-as-a-judge](https://oumi.ai/docs/en/latest/user_guides/judge/judge.html) guides for advanced options.

### Running Jobs Remotely

Run jobs remotely on cloud platforms (AWS, Azure, GCP, Lambda, etc.) using the `oumi launch` command:
...
**Note:** Oumi is currently in beta and is under active development.

## Why Use Oumi?

Oumi is a powerful platform for training, evaluating, and deploying models.
...
*   **Broad Model Support:** Works with a wide variety of models, from small to large, text-only to multimodal.
...
Explore the extensive collection of pre-configured recipes for various state-of-the-art models and training workflows.

**Note:** These configurations are examples, with a more exhaustive list in the [oumi documentation](https://oumi.ai/docs/en/latest/resources/models/supported_models.html).
...
Oumi offers extensive model support, thanks to integration with [🤗 Transformers](https://github.com/huggingface/transformers).
...
| ✅ Llama 4 Scout Instruct | 17B (Activated) 109B (Total) | [Paper](https://arxiv.org/abs/2407.2178