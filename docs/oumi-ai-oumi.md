...
## Oumi: Your Complete Toolkit for Building Cutting-Edge Foundation Models

Oumi provides an open-source platform for the entire lifecycle of foundation models, from data preparation to deployment. **[Explore the original repo](https://github.com/oumi-ai/oumi) to start building your models today!**
...
*   **Simplified Model Training:** Train and fine-tune models from 10M to 405B parameters using cutting-edge techniques like SFT, LoRA, and QLoRA.
*   **Broad Model Support:** Works seamlessly with both text and multimodal models, including Llama, DeepSeek, Qwen, and Phi families.
*   **Data Curation with LLM Judges:** Synthesize and curate training data using built-in LLM judges to enhance your models.
*   **Efficient Deployment:** Deploy models efficiently with popular inference engines like vLLM and SGLang.
*   **Comprehensive Evaluation:** Evaluate models thoroughly across standard benchmarks to measure performance accurately.
*   **Run Anywhere:** Execute your models on any environment, from laptops to clusters and cloud platforms such as AWS, Azure, and GCP.
*   **Easy Integration:** Integrate with both open models and commercial APIs like OpenAI, Anthropic, and Vertex AI.

## What's New

*   **Model Quantization (AWQ):** [Oumi v0.3.0](https://github.com/oumi-ai/oumi/releases/tag/v0.3.0) offers model quantization for more efficient model usage.
*   **Improved LLM-as-a-Judge API:** Enhance your data curation process with a refined LLM-as-a-Judge API.
*   **Adaptive Inference:** Experience enhanced inference performance with Adaptive Inference.
*   **Qwen3 Recipes:** Utilize updated recipes for Qwen3 235B model training and inference.
*   **Falcon Model Support:** Access updated recipes for training, inference, and evaluation using Falcon-H1 and Falcon-E models.
*   **InternVL3 Support:** Leverage recipes and support for InternVL3 1B.

## Getting Started

Get up and running with Oumi quickly using these interactive Colab notebooks:
...
For more detailed installation instructions, see the [installation guide](https://oumi.ai/docs/en/latest/get_started/installation.html).

## Command-Line Interface (CLI)

Use the `oumi` CLI for streamlined model training, evaluation, and inference using existing [recipes](/configs/recipes):
...
Execute jobs remotely on cloud platforms using the `oumi launch` command:
...
**Note:** Oumi is in beta and under active development. While the core features are stable, some advanced features may change.

## Why Choose Oumi?

Oumi is the ideal platform for building and deploying your foundation models.

*   **Zero Boilerplate:** Get started in minutes with ready-to-use recipes.
*   **Enterprise-Grade:** Built and validated by teams training models at scale.
*   **Research-Ready:** Perfect for ML research with reproducible experiments and flexible interfaces.
*   **Broad Model Support:** Works with various model architectures, text-only to multimodal.
...
Explore pre-configured setups for cutting-edge models:

**Note:** Refer to the [Oumi documentation](https://oumi.ai/docs) for a complete list of [supported models](https://oumi.ai/docs/en/latest/resources/models/supported_models.html), [datasets](https://oumi.ai/docs/en/latest/resources/datasets/sft_datasets.html), and more.
...
Oumi integrates seamlessly with the [🤗 Transformers](https://github.com/huggingface/transformers) library. This section highlights additional models supported by Oumi.
