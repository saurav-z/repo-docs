...
yt-dlp is a feature-rich command-line program for downloading audio and video from **thousands of websites**; a fork of youtube-dl. [Check out the original repository for more details.](https://github.com/yt-dlp/yt-dlp)

**Key Features:**

*   **Wide Site Support:** Download from thousands of video and audio streaming sites.
*   **Format Selection:** Choose your desired video and audio quality and formats.
*   **Playlist Downloads:** Easily download entire playlists.
*   **Subtitles:** Download and embed subtitles in multiple languages.
*   **Metadata:** Write and modify video metadata.
*   **SponsorBlock Integration:** Remove sponsored segments automatically.
*   **Browser Cookie Support:** Download from sites that require authentication, or save and restore your cookies automatically.
*   **Cross-Platform:** Works on Windows, Linux, and macOS.
*   **Plugins:** Extend functionality with custom plugins.
*   **Updates:** Stay up-to-date with easy self-updating.
...
## Network Options:
    ...
    -4, --force-ipv4                Make all connections via