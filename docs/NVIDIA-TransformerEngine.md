...
**Supercharge your Transformer model training and inference on NVIDIA GPUs with the power of 8-bit floating point (FP8) precision, achieving significant performance gains and reduced memory usage. [View the original repo](https://github.com/NVIDIA/TransformerEngine)**

Transformer Engine (TE) is a library designed to accelerate Transformer models on NVIDIA GPUs, especially by utilizing FP8 precision on Hopper, Ada, and Blackwell GPUs. It offers optimized building blocks for popular Transformer architectures and an automatic mixed-precision-like API, integrating seamlessly with your existing deep learning frameworks.

**Key Features:**

*   **FP8 Acceleration:** Leverage FP8 precision for faster training and inference on NVIDIA Hopper, Ada, and Blackwell GPUs.
...
*   **Automatic Mixed Precision:** An API for simplified mixed-precision training.
*   **Broad Precision Support:** Optimizations available across all precisions (FP16, BF16).
*   **Ease of Use:** Simple APIs that integrate with Large Language Model (LLM) libraries.
...
[View Previous News](#previous-news)

## What is Transformer Engine?

Transformer Engine (TE) accelerates Transformer models on NVIDIA GPUs. It incorporates FP8 precision on Hopper, Ada, and Blackwell GPUs. This results in better performance and lower memory utilization for both training and inference. TE offers optimized building blocks for popular Transformer architectures and an automated mixed-precision-like API.

As the number of parameters in Transformer models grows, training and inference for architectures like BERT, GPT, and T5 become memory and compute-intensive. TE addresses FP8 support by integrating APIs with Large Language Model (LLM) libraries, providing a Python API for building Transformer layers. It provides a framework-agnostic library in C++ for FP8 support.
...
| :--------- | :--------------- | :------------------------------------------------------------------------------------------------------ |
| T5-770M    | JAX/T5x          | [Convergence and Performance](https://github.com/NVIDIA/JAX-Toolbox/tree/main/rosetta/rosetta/projects/t5x#convergence-and-performance) |
| MPT-1.3B   | Mosaic Composer  | [CoreWeave-Nvidia-H100](https://www.mosaicml.com/blog/coreweave-nvidia-h100-part-1)                                           |
...
| LLama2-7B  | Alibaba Pai      | [Alibaba Pai Link](https://mp.weixin.qq.com/s/NQT0uKXLbXyh5031zBdeBQ)                                                   |
| T5-11B     | JAX/T5x          | Available on request                                                                                    |
| MPT-13B    | Mosaic Composer  | [Turbocharged Training](https://www.databricks.com/blog/turbocharged-training-optimizing-databricks-mosaic-ai-stack-fp8)                                    |
| GPT-22B    | NeMo Framework   | Available on request                                                                                    |
| LLama2-70B | Alibaba Pai      | [Alibaba Pai Link](https://mp.weixin.qq.com/s/NQT0uKXLbXyh5031zBdeBQ)                                                   |
