...
**LLaMA Factory empowers you to easily fine-tune over 100 large language models, offering a versatile and efficient solution for your NLP projects.**  Visit the [original repo](https://github.com/hiyouga/LLaMA-Factory) for more details.

### Key Features

*   **Extensive Model Support:** Fine-tune LLaMA, LLaVA, Mistral, Mixtral-MoE, Qwen, DeepSeek, and many more.
*   **Comprehensive Training Methods:** Supports (continuous) pre-training, (multimodal) supervised fine-tuning, reward modeling, PPO, DPO, and more.
*   **Flexible Optimization:** Utilize 16-bit full-tuning, freeze-tuning, LoRA, and 2/3/4/5/6/8-bit QLoRA for efficient training.
*   **Advanced Algorithms:**  Integrates cutting-edge techniques like GaLore, BAdam, APOLLO, and Muon.
*   **Practical Enhancements:** Includes FlashAttention-2, Unsloth, RoPE scaling, and NEFTune for improved performance.
*   **Wide Applicability:** Adaptable for multi-turn dialogue, tool usage, image understanding, video recognition, and audio processing.
*   **Comprehensive Monitoring:** Integrates with LlamaBoard, TensorBoard, Wandb, MLflow, and SwanLab.
*   **Faster Inference:**  Offers OpenAI-style API, Gradio UI, and CLI with vLLM or SGLang for rapid results.

### Model Support and Updates

*   **Day-N Support:** We continuously update to support the latest models:
    *   Qwen3 / Qwen2.5-VL / Gemma 3 / GLM-4.1V / InternLM 3 / MiniCPM-o-2.6 (Day 0)
    *   Llama 3 / GLM-4 / Mistral Small / PaliGemma2 / Llama 4 (Day 1)

### Quickstart: Fine-Tuning, Inference & Merging with Ease
...
| [Llama 3.2 Vision](https://huggingface.co/meta-llama)             | 11B/90