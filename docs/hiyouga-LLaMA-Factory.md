...
**Easily fine-tune 100+ large language models with a code-free CLI and Web UI; [Explore the original repo](https://github.com/hiyouga/LLaMA-Factory).**
...
*   **Extensive Model Support:** Fine-tune a wide variety of LLMs, including LLaMA, Mistral, Qwen, Gemma, and many more.
*   **Flexible Training Approaches:** Utilize pre-training, supervised fine-tuning, reward modeling, PPO, DPO, and more.
*   **Efficient Training:** Leverage 16-bit full-tuning, freeze-tuning, LoRA, and QLoRA (2/3/4/5/6/8-bit) for scalability.
*   **Cutting-Edge Optimization:** Integrate advanced algorithms like GaLore, BAdam, APOLLO, Adam-mini, and Muon.
*   **Practical Enhancements:** Includes FlashAttention-2, Unsloth, RoPE scaling, NEFTune and rsLoRA for improved performance.
*   **Comprehensive Task Coverage:** Support for multi-turn dialogue, tool usage, image understanding, and more.
*   **Experiment Tracking:** Integrate with LlamaBoard, TensorBoard, Wandb, MLflow, and SwanLab for monitoring.
*   **Fast Inference:** Deploy with OpenAI-style API, Gradio UI, and CLI, with vLLM or SGLang backends.
