...
**LLaMA Factory is your one-stop solution for efficiently fine-tuning a vast range of large language models (LLMs) with minimal code and maximum flexibility.** This open-source project empowers you to customize models like LLaMA, Mistral, Qwen, and many more, making cutting-edge LLMs accessible to everyone.  [Explore the original repo!](https://github.com/hiyouga/LLaMA-Factory)
...
### Fine-tune large language models with ease using zero-code [CLI](#quickstart) and [Web UI](#fine-tuning-with-llama-board-gui-powered-by-gradio)
...
**Unlock the power of LLMs with just a few commands!**
...
*   **Broad Model Support**: Compatibility with a wide range of LLMs including LLaMA, Mistral, Qwen, and more.
*   **Flexible Training Methods**: Includes pre-training, supervised fine-tuning, reward modeling, and reinforcement learning (PPO, DPO, KTO, ORPO, SimPO).
*   **Efficient Optimization**: Supports 16/8/4/2-bit quantization (QLoRA, etc.), LoRA, and advanced algorithms like GaLore, BAdam, and APOLLO for efficient training.
*   **Advanced Techniques**: Integrates cutting-edge features like FlashAttention-2, Unsloth, RoPE scaling, and NEFTune for improved performance.
*   **Versatile Applications**:  Suitable for diverse tasks such as multi-turn dialogue, tool usage, image understanding, and more.
*   **Comprehensive Monitoring**:  Integrates with LlamaBoard, TensorBoard, Wandb, MLflow, and SwanLab for experiment tracking.
...
| [LLaVA-1.5](https://huggingface.co/llava-hf)                      | 7B/13B                           | ll