...
LLaMA Factory empowers you to easily and efficiently fine-tune over 100 large language models. Discover the full power of this open-source project on [GitHub](https://github.com/hiyouga/LLaMA-Factory).

## Key Features:

*   **Extensive Model Support:** Fine-tune LLaMA, Mistral, Mixtral-MoE, Qwen, Gemma, and many more.
*   **Versatile Training Approaches:** Utilize (continuous) pre-training, (multimodal) supervised fine-tuning, reward modeling, PPO, DPO, KTO, ORPO, and more.
*   **Efficient Training Techniques:** Leverage 16-bit full-tuning, freeze-tuning, LoRA and 2/3/4/5/6/8-bit QLoRA via AQLM/AWQ/GPTQ/LLM.int8/HQQ/EETQ.
*   **Advanced Optimization Algorithms:** Benefit from GaLore, BAdam, APOLLO, Adam-mini, and Muon.
*   **Practical Enhancements:** Explore FlashAttention-2, Unsloth, Liger Kernel, RoPE scaling, NEFTune, and rsLoRA.
*   **Diverse Task Support:** Tackle multi-turn dialogue, tool usage, image understanding, and more.
