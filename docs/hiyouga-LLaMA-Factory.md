...
## **LLaMA Factory: Effortlessly Fine-Tune Large Language Models**

**LLaMA Factory is your go-to solution for efficiently fine-tuning over 100 different large language models with ease, offering both code-free and advanced options.** Explore the original repository at [https://github.com/hiyouga/LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) for in-depth information.

## **Key Features**

*   **Broad Model Support:** Fine-tune LLaMA, LLaVA, Mistral, Mixtral-MoE, Qwen, DeepSeek, Yi, Gemma, ChatGLM, Phi, and more.
*   **Versatile Training Methods:** Supports (continuous) pre-training, (multimodal) supervised fine-tuning, reward modeling, PPO, DPO, KTO, and ORPO.
*   **Flexible Optimization:** Utilize 16-bit full-tuning, freeze-tuning, LoRA, and 2/3/4/5/6/8-bit QLoRA for scalable resource usage.
*   **Advanced Algorithms:** Integrate cutting-edge algorithms like GaLore, BAdam, APOLLO, Adam-mini, Muon, DoRA, LongLoRA, LLaMA Pro, and more.
*   **Performance Enhancements:** Benefit from practical optimizations such as FlashAttention-2, Unsloth, Liger Kernel, and RoPE scaling.
*   **Wide-Ranging Tasks:** Address a variety of tasks including multi-turn dialogue, tool usage, image understanding, and video/audio understanding.
*   **Experiment Tracking:** Monitor your experiments with LlamaBoard, TensorBoard, Wandb, MLflow, and SwanLab.
*   **Faster Inference:** Utilize OpenAI-style API, Gradio UI, and CLI with vLLM or SGLang backends for faster inference.
...
Comprehensive support for a wide variety of models, including:
...
| [Mistral/Mixtral](https://huggingface.co/mistralai)               | 7B