...
**LLaMA Factory empowers you to easily fine-tune over 100 large language models with a code-free CLI and web interface.**
...
<!-- Example GIF -->
<p align="center">
  <img src="https://github.com/user-attachments/assets/3991a3a8-4276-4d30-9cab-4cb0c4b9b99e" alt="LLaMA Factory Demo" width="80%"/>
</p>

## Key Features

*   **Broad Model Support:** Fine-tune LLaMA, Mistral, Qwen, Gemma, and many more.  Full list in [Supported Models](#supported-models)
*   **Versatile Training Methods:** Includes (Continuous) pre-training, (multimodal) supervised fine-tuning, reward modeling, PPO, DPO, KTO, ORPO, and more.
*   **Efficient Training:**  Supports 16-bit full-tuning, freeze-tuning, LoRA, and 2/3/4/5/6/8-bit QLoRA for resource optimization.
*   **Cutting-Edge Algorithms:** Integrated with GaLore, BAdam, APOLLO, Adam-mini, Muon, OFT, DoRA, LongLoRA, LLaMA Pro, Mixture-of-Depths, LoRA+, LoftQ, and PiSSA.
*   **Performance Enhancements:**  Incorporates FlashAttention-2, Unsloth, Liger Kernel, RoPE scaling, NEFTune and rsLoRA for improved speed and efficiency.
*   **Diverse Task Support:** Designed for multi-turn dialogue, tool use, image understanding, and more.
*   **Experiment Tracking:** Integrates with LlamaBoard, TensorBoard, Wandb, MLflow, and [SwanLab](https://github.com/SwanHubX/SwanLab) for monitoring.
*   **Fast Inference:**  Offers OpenAI-style API, Gradio UI, and CLI with [vLLM](https://github.com/vllm-project/vllm) or [SGLang](https://github.com/sgl-project/sglang) backends.
