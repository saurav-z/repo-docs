...
Need to download videos from YouTube and many other sites? [youtube-dl](https://github.com/ytdl-org/youtube-dl) is the versatile, cross-platform command-line tool you need.

**Key Features:**

*   **Wide Site Support:** Download videos from YouTube, Vimeo, and hundreds of other video platforms.
*   **Format Selection:** Choose your preferred video and audio formats with flexible selection options.
*   **Playlist & Channel Downloads:** Easily download entire playlists, channels, or individual videos.
*   **Customizable Output:** Control filenames, output directories, and more with output templates.
*   **Subtitle Support:** Download and embed subtitles in various formats.
*   **Cross-Platform:** Works seamlessly on Windows, macOS, and Linux.
*   **Open Source & Free:** Released into the public domain, modify, and redistribute as you wish!
...
*   [Installation](#installation)
    ...
    *   [macOS (Homebrew & MacPorts)](#installation)
