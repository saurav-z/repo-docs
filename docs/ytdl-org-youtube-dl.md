...
# youtube-dl: Download Videos from YouTube and Hundreds of Other Sites

Tired of buffering?  **youtube-dl is your go-to command-line tool for effortlessly downloading videos from YouTube and a vast array of other online video platforms.**  This versatile program empowers you to save your favorite content for offline viewing, archiving, and more.  For more information, including download instructions, check out the original project on [GitHub](https://github.com/ytdl-org/youtube-dl).

## Key Features

*   **Wide Site Support:** Download videos from YouTube, Facebook, Instagram, Twitter, and hundreds of other sites. [See the full list.](https://ytdl-org.github.io/youtube-dl/supportedsites.html)
*   **Format Selection:** Choose from various video and audio formats to optimize download quality and file size.
*   **Playlist and Channel Downloads:** Easily download entire playlists, channels, or individual videos.
*   **Metadata Extraction:**  Automatically retrieves video titles, descriptions, thumbnails, and other metadata.
*   **Customizable Output:** Control filenames, output directories, and video conversion options.
*   **Cross-Platform:** Works seamlessly on Linux, macOS, and Windows.
*   **Active Community:** Benefit from a constantly updated project with a vibrant and helpful user base.
...
*   [FAQ](#faq)
    ...
    *   [ExtractorError: Could not find JS function u'OF'](#extractorerrore-could-not-find-js-function-uof)
...
*   [Why do I need to go through that much red tape when filing bugs?](#why-do-i-need-to-go-through-that-much-red-tape-when-filing-bugs-1)
*   [Copyright](#copyright)
...
To install youtube-dl on Unix-like systems (Linux, macOS, etc.), open your terminal and run the following commands.  These will download the latest version, make it executable, and place it in `/usr/local/bin/`, which is in most users' `PATH`:
...
Windows users can download the executable from [the download page](https://yt-dl.org/latest/youtube-dl.exe) and place it in any directory included in your [PATH](https://en.wikipedia.org/wiki/PATH_%28variable%29) (e.g., `C:\Windows`).  *Do not* put it in `%SYSTEMROOT%\System32`.

### Using pip

You can also install/upgrade youtube-dl using pip, the Python package installer:
...
macOS users with [Homebrew](https://brew.sh/) installed can use:
...
**youtube-dl** is a command-line tool written in Python designed to download videos from YouTube and many other video hosting websites.  It's a versatile, platform-independent program that allows users to save videos for offline viewing. You can find out more about the program [here](https://github.com/ytdl-org/youtube-dl).
...
Here's a breakdown of the available options, grouped by category:
...
*   **--playlist-items ITEM_SPEC:** Playlist video items to download. Specify indices of the videos in the playlist separated by commas like: "--playlist-items 1,2,5,8" if you want to download videos indexed 1, 2, 5, 8 in the playlist. You can specify range: "--playlist-items 1-3,7,10-13", it will download the videos at index 1, 2, 3, 7, 10, 11, 12 and 13.
