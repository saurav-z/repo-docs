...
AG2 is your open-source AgentOS, empowering developers to create and orchestrate AI agents for complex tasks, learn more and contribute at the [original repository](https://github.com/ag2ai/ag2).
...
AG2, evolved from AutoGen, is an open-source framework designed for building AI agents and facilitating collaboration among multiple agents to solve diverse problems.

## Key Features

*   **Multi-Agent Collaboration:** Easily create and manage interactions between multiple AI agents.
*   **LLM & Tool Integration:** Seamlessly integrate various Large Language Models (LLMs) and support tool usage within agents.
*   **Flexible Workflows:** Build both autonomous and human-in-the-loop workflows.
*   **Conversational Patterns:** Utilize built-in conversation patterns for efficient multi-agent communication.
*   **Open Source & Community Driven:** Benefit from a vibrant community and contribute to the development of agentic AI.

## Getting Started

Get up and running quickly with AG2. See the documentation for a step-by-step guide to AG2 concepts and code: [Basic Concepts](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/installing-ag2/).
...
Store your API keys by using the `OAI_CONFIG_LIST` file.
...
Explore a wide range of example applications to jumpstart your projects:
...
AG2 provides several agent concepts for building your AI agents:

*   **Conversable Agent:** Agents that can send, receive, and generate responses using GenAI models, non-GenAI tools, or human input.
*   **Human-in-the-Loop:** Incorporate human oversight and input into agent workflows.
*   **Orchestrating Multiple Agents:** Design multi-agent systems using built-in patterns or custom orchestration.
*   **Tools:** Equip agents with tools to access external data, APIs, and functions.
*   **Advanced Concepts:** Leverage structured outputs, Retrieval Augmented Generation (RAG), code execution, and more.

### Conversable Agent

The [ConversableAgent](https://docs.ag2.ai/latest/docs/api-reference/autogen/ConversableAgent) is the foundation for creating agents that communicate seamlessly.
...
Integrate human input and oversight into your agent workflows.
...
Create sophisticated multi-agent collaborations using built-in patterns like GroupChat and Swarm.
...
Empower agents by integrating tools to access external data, APIs, and custom functionality.
...
AG2 supports advanced concepts to build robust agent workflows.
...
*   The original code from https://github.com/microsoft/autogen is licensed under the MIT License. See the [LICENSE\_original\_MIT](./license\_original/LICENSE\_original\_MIT) file for details.
