...
<p align="center">
  <!-- Badges for PyPI downloads, PyPI version, Python versions, and build status -->
  ...
  <a href="https://x.com/ag2oss">
    <img src="https://img.shields.io/twitter/url/https/twitter.com/cloudposse.svg?style=social&label=Follow%20%40ag2ai" alt="Follow @ag2ai">
  </a>
</p>
...
<p align="center">
  AG2 is an open-source platform designed to empower you to create and collaborate with AI agents.
</p>

# AG2: Your Open-Source AgentOS for AI Agent Development

AG2 (formerly AutoGen) is a powerful open-source framework that simplifies building AI agents and fostering cooperation between multiple agents to solve complex tasks. Streamline your AI agent development and research with AG2's innovative features.

**Key Features:**

*   **Multi-Agent Collaboration:** Enable agents to interact and work together seamlessly.
*   **LLM Integration:** Easily utilize various Large Language Models (LLMs).
*   **Tool Use Support:** Equip agents with the ability to leverage tools for enhanced functionality.
*   **Autonomous and Human-in-the-Loop Workflows:** Design workflows that operate autonomously or with human oversight.
*   **Flexible Conversation Patterns:** Implement diverse multi-agent communication strategies.

[View the original repository for more details.](https://github.com/ag2ai/ag2)
...
*   [Contributors](#contributors-wall)
*   [Code Style & Linting](#code-style-and-linting)
*   [Related Papers](#related-papers)
*   [Citing AG2](#cite-the-project)
*   [License](#license)

## Getting Started

To begin, explore the [Basic Concepts](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/installing-ag2/) in our documentation for a guided introduction to AG2.
...
Organize your LLM API keys using the `OAI_CONFIG_LIST` file. A sample template is provided.
...
Create a Python script or Jupyter Notebook and execute your first agent.
...
Explore a diverse range of example applications in our dedicated repository to kickstart your projects or find inspiration in our collection of Jupyter notebooks.
...
Explore the core agent concepts within AG2 to construct your AI agents effectively.

*   **Conversable Agent:** Agents capable of exchanging messages, receiving responses, and generating replies using GenAI models, non-GenAI tools, or human input.
*   **Human-in-the-Loop:** Integrate human input for crucial decision-making.
*   **Orchestrating Multiple Agents:** Orchestrate agents using built-in conversation patterns or customize your own.
*   **Tools:** Equip agents with tools for enhanced capabilities.
*   **Advanced Concepts:** AG2 also supports structured outputs, RAG, code execution, etc.

### Conversable Agent

The [ConversableAgent](https://docs.ag2.ai/latest/docs/api-reference/autogen/ConversableAgent) is the foundation of AG2, designed for seamless AI entity communication. This core agent handles message exchange and response generation.
...
Integrate human oversight into your AI workflows, particularly for critical decisions. AG2 facilitates this integration with the `human_input_mode` parameter.
...
AG2 allows for advanced multi-agent collaboration using patterns like `GroupChat` and `Swarm`.
...
Equip agents with tools for enhanced capabilities and access to external functionalities.
...
Explore these advanced AG2 concepts:
...
*   📄 **License:**  Adopted the Apache 2.0 license from v0.3 for open-source collaboration.
...
See the [NOTICE](./NOTICE.md) file for details.