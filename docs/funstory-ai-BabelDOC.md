---
title: BabelDOC: Translate PDF Documents with AI-Powered Precision
description: Translate PDF documents with ease using BabelDOC, a powerful AI-driven library for scientific paper translation and bilingual comparison.  Get started with our online service or self-deploy.
keywords: PDF translation, AI translation, document translator, scientific paper translation, bilingual comparison, OpenAI, PDFMathTranslate, Zotero
---
...
## BabelDOC: AI-Powered PDF Translation for Scientific Papers

**BabelDOC is a powerful Python library for translating and comparing PDF documents, specifically designed for scientific papers.**  Unlock the power of AI to translate your documents with ease! Explore our online service or self-deploy for advanced control.  See the original repo at [https://github.com/funstory-ai/BabelDOC](https://github.com/funstory-ai/BabelDOC).

### Key Features

*   **AI-Driven Translation:** Leverages AI for accurate and context-aware translations.
*   **Bilingual Comparison:**  Generates bilingual PDFs for easy comparison of original and translated text.
...
*   **Self-Deployment:**  Integrates with [PDFMathTranslate 2.0](https://github.com/PDFMathTranslate/PDFMathTranslate-next) for self-hosting and customization.
*   **Command-Line Interface (CLI):**  Provides a simple CLI for quick translations.
*   **Python API:**  Allows seamless integration into other Python projects.
*   **Zotero Integration:**  Integrate with Zotero using the [immersive-translate/zotero-immersivetranslate](https://github.com/immersive-translate/zotero-immersivetranslate) plugin or the [guaguastandup/zotero-pdf2zh](https://github.com/guaguastandup/zotero-pdf2zh) plugin with self-deployed setups.
*   **Supported Languages:**  [Check the supported languages](https://funstory-ai.github.io/BabelDOC/supported_languages/).
...
*   `--no-watermark`: \[DEPRECATED] Use --watermark-output-mode=no\_watermark instead.
...
This project is built with inspiration from the following projects:
