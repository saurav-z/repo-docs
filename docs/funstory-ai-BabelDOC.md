...
description: Translate scientific papers with ease using BabelDOC, a powerful PDF translation library. Key features include online service, self-deployment options, and a Python API.
keywords: PDF translation, scientific paper translator, document translation, bilingual PDF, OpenAI translation, PDFMathTranslate, Immersive Translate
---

# BabelDOC: Your AI-Powered PDF Translator

> Unlock instant multilingual access to scientific knowledge! BabelDOC translates PDF documents, making research accessible across language barriers. ([View the Original Repo](https://github.com/funstory-ai/BabelDOC))
...
*   **Accurate PDF Translation:**  Translate scientific papers, preserving layout and formatting.
...
*   **Self-Deployment Options:** Utilize [PDFMathTranslate 2.0](https://github.com/PDFMathTranslate/PDFMathTranslate-next) for self-hosting and WebUI with more translation services.
*   **Command Line Interface (CLI):** Easily translate documents from your terminal.
*   **Python API:** Integrate BabelDOC into your Python projects for automated translation workflows.
*   **Bilingual Output:** Generate both bilingual (original + translated) and monolingual PDFs.
*   **OpenAI Integration:** Leverage OpenAI for high-quality translations.
*   **Glossary Support:**  Customize translations with your own glossaries.
*   **Offline Assets:**  Generate offline packages for use in environments without internet access.
...
BabelDOC addresses the need for efficient document translation, focusing on PDF documents.  It offers a standard pipeline and interface for PDF parsing and rendering, built upon a plugin-based system, making it adaptable to diverse needs.
...
This project uses Semantic Versioning combined with Pride Versioning.  The format is "0.MAJOR.MINOR":

*   MAJOR: API incompatible changes or major feature/proud improvements.
