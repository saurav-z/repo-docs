# SuperClaude Framework: Enhance Your Claude Code Experience with AI-Powered Development Tools

**Supercharge your development workflow with SuperClaude, a framework that expands Claude Code with specialized commands, smart personas, and external tool integration.** ([View on GitHub](https://github.com/SuperClaude-Org/SuperClaude_Framework))
...
*   **Specialized Commands:** SuperClaude offers 16 pre-defined commands to automate common development tasks, streamlining your workflow.
*   **Smart Personas:** Leverage AI-powered personas, such as architect, frontend, and backend, to automatically select the most relevant expert for different tasks.
*   **External Tool Integration:** Seamlessly integrate with MCP servers and external tools for enhanced capabilities, including documentation retrieval, UI component generation, and browser automation.
*   **Token Optimization:** SuperClaude optimizes your conversations to help with longer conversations.
*   **Task Management:** It tries to keep track of progress.

## What's New in SuperClaude v3?

*   **Enhanced Installation:** A completely rewritten installation suite for a more reliable and user-friendly setup.
*   **Core Framework:** Contains 9 key documentation files.
*   **Commands:** Included 16 essential slash commands for various development tasks.
*   **MCP Integration:** The integration has been improved to enhance the user experience.
*   **Unified CLI Installer:** A simple setup with the unified CLI installer.

## Current Status

*   **Installation:** A new rewritten installation suite from the ground up
*   **Core Framework:** Included 9 essential documentation files
*   **Commands:** Implemented with 16 essential slash commands.
*   **MCP Integration:** Enhanced external tools integration.
*   **Unified CLI Installer:** Easy-to-use CLI installer.

## Known Issues

*   This is an initial release - bugs may occur
*   Some features might not work perfectly yet
*   Documentation is still being improved
*   Hooks system was removed (coming back in v4)

## Upgrading from v2? Important!

If you are upgrading from v2, you'll need to perform a cleanup before installation.
...
SuperClaude enhances Claude Code by integrating the following:
...
We plan to implement the following features in the next version:
