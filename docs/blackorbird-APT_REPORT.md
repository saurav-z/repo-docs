# APT Report: Collection of Advanced Persistent Threat Intelligence

**Stay informed about the latest Advanced Persistent Threats (APTs) with this curated collection of reports, samples, and malware analysis.** This repository, maintained by [@blackorbird](https://x.com/blackorbird), provides valuable insights into APT groups, their tactics, techniques, and procedures (TTPs).  Find the original repository here: [https://github.com/blackorbird/APT_REPORT](https://github.com/blackorbird/APT_REPORT).

## Key Features

*   **Comprehensive Threat Intelligence:**  Stay updated on the evolving landscape of APT groups.
*   **Curated Reports:** Access links to reports, analysis, and research from leading cybersecurity organizations.
*   **Malware Samples & Analysis:** Learn from real-world examples of APT campaigns.
*   **Focus on Key APT Groups:**  Track prominent threat actors and their activities.

## APT Groups by Country/Region

This section categorizes APT groups by their geographical focus or origin, helping you understand the landscape of cyber threats targeting specific regions.

### **APT Group for Country**

**Resource:** Threat Actor Groups Tracked by Palo Alto Networks Unit 42
...
This section focuses on APT groups known for targeting the financial sector.
