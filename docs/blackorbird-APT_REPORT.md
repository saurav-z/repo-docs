...
**Stay informed about the latest APT campaigns, malware analysis, and threat intelligence with this curated collection of reports and samples.  Explore the evolving landscape of cyber threats and the techniques used by sophisticated threat actors.**

[Original Repository](https://github.com/blackorbird/APT_REPORT)

**Key Features:**

*   **Comprehensive APT Coverage:**  Includes reports on various Advanced Persistent Threat (APT) groups, including their tactics, techniques, and procedures (TTPs).
*   **Malware Analysis:** Provides links to detailed analyses of malware samples used in APT campaigns.
*   **Threat Intelligence:** Offers insights into the latest threat intelligence reports, helping you stay ahead of emerging threats.
*   **Categorized by Groups and Regions:** Organized by APT groups (e.g., Group123, Kimsuky, Lazarus) and geographical regions to facilitate research.

## APT Groups Tracked

This repository tracks the activities of various APT groups, with a focus on those impacting specific countries and sectors. The information below is provided to assist in understanding and researching APT threats.

*   **[Palo Alto Networks Unit 42 Threat Actor Groups](https://unit42.paloaltonetworks.com/threat-actor-groups-tracked-by-palo-alto-networks-unit-42/)**
...
*   ▶ Oceanlotus in the first quarter of 2019 for the attack technology of China.(April 24, 2019)
    *   https://mp.weixin.pp.com/s/xPsEXp2J5IE7wNSMEVC24A
...
**Disclaimer:** This information is provided for educational purposes only. Use this data responsibly and ethically. Always stay informed about the latest cybersecurity threats and best practices.