...
> **SimpleTuner** empowers you to fine-tune various diffusion models, offering a straightforward and efficient approach to model training. **[Original Repo](https://github.com/bghira/SimpleTuner)**

SimpleTuner is designed for simplicity and ease of understanding, making it an excellent choice for both beginners and experienced users. Contributions are welcome!

**Key Features:**

*   **Versatile Model Support:** Train a wide range of models, including HiDream, Flux.1, Stable Diffusion 3, PixArt Sigma, LTX Video, and more.
*   **Efficient Training:** Utilize features like aspect bucketing, cached image/video features, and optional EMA for faster and more memory-efficient training.
*   **Cutting-Edge Techniques:** Incorporates proven techniques like LoRA, LyCORIS, ControlNet, and Mixture of Experts for enhanced model performance.
*   **Hardware Flexibility:** Optimized for NVIDIA, AMD, and Apple hardware, with detailed hardware requirements provided.
*   **Hugging Face Hub Integration:** Seamlessly upload and manage your models with integration with the Hugging Face Hub.
*   **Extensive Documentation:** Detailed guides for setup, troubleshooting, and specific model training configurations.
*   **Optional Third-Party Integrations:** Safe by default, with opt-in support for features like reporting, model uploads, and webhooks.
...
*   **Simplicity:** Prioritizing user-friendly defaults to reduce the need for complex configurations.
*   **Versatility:** Designed to handle a wide range of image quantities, from small to very large datasets.
*   **Cutting-Edge:** Incorporating features and techniques that have proven efficacy.

## Tutorials and Quickstarts

*   **Tutorial:** Please explore the full README for essential information before beginning the tutorial found in [the Tutorial](/TUTORIAL.md).
*   **Quickstart:** A quick guide for rapid setup and training is available [here](/documentation/QUICKSTART.md).
*   **DeepSpeed:** For memory-constrained systems, refer to [the DeepSpeed documentation](/documentation/DEEPSPEED.md) for details.
*   **Multi-Node Training:** For distributed training setups, see [this guide](/documentation/DISTRIBUTED.md).
