# SimpleTuner: Effortless Training for Cutting-Edge Diffusion Models

SimpleTuner simplifies the process of training and finetuning various diffusion models, offering a streamlined experience for both beginners and experienced users. **[Explore the SimpleTuner Repository](https://github.com/bghira/SimpleTuner) for powerful model training.**

**Key Features:**

*   **Simplified Setup:** Easy installation and configuration with comprehensive documentation.
*   **Broad Model Support:** Train and fine-tune popular models like SDXL, Stable Diffusion 3, Flux.1, HiDream, and more!
*   **Hardware Flexibility:** Optimized for various GPUs, including NVIDIA, AMD, and Apple Silicon.
*   **Memory Efficiency:** Utilizes techniques like LoRA, quantization, and DeepSpeed for training on resource-constrained hardware.
*   **Advanced Techniques:** Integrates cutting-edge features like ControlNet, Mixture of Experts, and masked loss training.
*   **Customization Options:** Supports aspect bucketing, EMA, S3 storage, and webhook notifications.
*   **Hugging Face Hub Integration:** Seamlessly upload and manage your trained models on the Hugging Face Hub.
...
-   [Hardware Requirements](#hardware-requirements)
    ...
    -   [Flux.1 [dev, schnell]](#flux-1-dev-schnell)
    -   [Auraflow](#auraflow)
...
-   **Cutting-Edge Features:** Only proven features are implemented.

## Tutorial

Begin your training journey with the [Tutorial](/TUTORIAL.md), which contains vital information that you might need to know first.

For a quick start, refer to the [Quick Start](/documentation/QUICKSTART.md) guide.

To address memory constraints, consult the [DeepSpeed document](/documentation/DEEPSPEED.md) for instructions on utilizing 🤗Accelerate with Microsoft's DeepSpeed for optimizer state offloading.

For multi-node distributed training, the [guide](/documentation/DISTRIBUTED.md) helps tailor configurations for multi-node setups and optimizing for extensive image datasets.
