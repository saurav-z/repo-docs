---
# 💡 LightRAG: Supercharge Your LLMs with Fast and Simple Retrieval-Augmented Generation

**LightRAG is a lightweight and efficient framework designed to enhance Large Language Models (LLMs) by integrating Retrieval-Augmented Generation (RAG) techniques for improved accuracy and contextual understanding.** Explore the original repository on [GitHub](https://github.com/HKUDS/LightRAG) to learn more.
...
*   **Simple & Fast RAG**: Designed for efficiency and ease of use.
*   **Multimodal Document Processing (RAG-Anything Integration)**: Process diverse document types with seamless integration with [RAG-Anything](https://github.com/HKUDS/RAG-Anything).
*   **Knowledge Graph Management**: Create, edit, and delete entities and relations.
*   **Flexible Storage Options**: Support for various storage backends including Json, PostgreSQL, Neo4J, Redis, and MongoDB.
*   **Hugging Face and Ollama Models Support**: Seamless integration with Hugging Face and Ollama models, offering flexibility in model selection.
...
-   **\[2025.01.06]** 🎯📢 Added PostgreSQL support.
-   **\[2024.12.31]** 🎯📢 Added deletion by document ID.
-   **\[2024.11.25]** 🎯📢 Added custom knowledge graphs integration.
...
-   **\[2024.11.04]** 🎯📢 Added Neo4J support.
-   **\[2024.10.29]** 🎯📢 Added multi-file type support (PDF, DOC, PPT, CSV).
...
LightRAG requires a capable Large Language Model (LLM), suitable Embedding and Reranker models for optimal performance.

-   **LLM Selection**:
    -   Recommended to use an LLM with at least 32 billion parameters.
    -   A context length of at least 32KB, with 64KB being recommended.
-   **Embedding Model**:
