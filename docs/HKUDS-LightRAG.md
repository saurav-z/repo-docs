...
**LightRAG is a simple, fast, and powerful framework that simplifies and accelerates Retrieval-Augmented Generation (RAG) for more intelligent and efficient AI applications.**

[View the original repository on GitHub](https://github.com/HKUDS/LightRAG)

<div align="center">
  <a href="https://trendshift.io/repositories/13043" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/13043" alt="HKUDS%2FLightRAG | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
</div>
...
*   **Simple & Fast**: Designed for ease of use and optimal performance.
*   **Multimodal Support**: Enhanced with [RAG-Anything](https://github.com/HKUDS/RAG-Anything) for processing text, images, tables, and formulas.
*   **Knowledge Graph Management**: Comprehensive tools for creating, editing, and deleting entities and relationships.
*   **Flexible Storage Options**: Support for various storage backends, including JSON, PostgreSQL, Neo4J, and more.
*   **Advanced Querying**: Hybrid search, conversation history, and user prompt customization for tailored results.
*   **Multilingual Support**: Provides both Chinese and English versions of the documentation.
*   **Token Usage Tracking**: Monitor and manage token consumption for LLM cost optimization.
*   **Data Export & Import**: Export knowledge graph data in multiple formats.
*   **Caching**: Efficient cache for LLM results to improve speed.
...
*   **[2025.06.05]** 🎯📢 Comprehensive multimodal data handling through [RAG-Anything](https://github.com/HKUDS/RAG-Anything) integration
...
*   **[2025.01.06]** 🎯📢 Added support for PostgreSQL storage.
*   **[2024.12.31]** 🎯📢 Support for deletion by document ID.
*   **[2024.11.25]** 🎯📢 Support for custom knowledge graphs.
*   **[2024.11.19]** 🎯📢 Comprehensive guide to LightRAG is available on [LearnOpenCV](https://learnopencv.com/lightrag).
...
*   **[2024.11.04]** 🎯📢 Support for Neo4J storage.
*   **[2024.10.29]** 🎯📢 Support for multiple file types via `textract`.
...
*   **[2024.10.16]** 🎯📢 Support for Ollama models.
*   **[2024.10.15]** 🎯📢 Support for Hugging Face models.
