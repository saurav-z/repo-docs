...
LightRAG is a simple yet powerful framework for building Retrieval-Augmented Generation (RAG) systems, empowering you to create intelligent applications that can answer complex questions using external knowledge.  [Explore the original repository here](https://github.com/HKUDS/LightRAG).
...
*   **Customizable:**  Offers flexibility in choosing LLMs, embedding models, and Rerankers.
*   **Knowledge Graph Integration:**  Built-in support for creating, editing, and deleting entities and relationships.
*   **Multimodal Capabilities:** Seamless integration with RAG-Anything for handling text, images, tables, and formulas.
...
*   **Comprehensive Deletion:** Robust functions for deleting documents, entities, and relations.
*   **Entity Merging:** Powerful features for merging entities and their relationships.
...
*   **Low RAM GPUs**
    ...
    In order to run this experiment on low RAM GPU you should select small model and tune context window (increasing context increase memory consumption). For example, running this ollama example on repurposed mining GPU with 6Gb of RAM required to set context size to 26k while using `gemma2:2b`. It was able to find 197 entities and