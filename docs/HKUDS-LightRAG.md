...
LightRAG revolutionizes LLM performance by providing a simple and efficient Retrieval-Augmented Generation framework. Explore the power of RAG with LightRAG – [view the original repository](https://github.com/HKUDS/LightRAG).
...
*   **Simple and Fast RAG:** Easily integrate retrieval-augmented generation into your projects.
*   **Multimodal Support:**  Leverage the power of [RAG-Anything](https://github.com/HKUDS/RAG-Anything) for handling PDFs, Office documents, images, and more.
*   **Flexible Storage Options:**  Choose from a variety of storage solutions, including JSON, PostgreSQL, Redis, MongoDB, Neo4J, and Faiss.
*   **Customizable:**  Customize LLMs, embedding models, and rerankers to suit your needs.
*   **Comprehensive Data Management:** Edit, delete, and merge entities and relationships within your knowledge graph.
*   **Token Usage Tracking:** Monitor and manage token consumption for cost control and optimization.
*   **Data Export and Cache Management:** Export your knowledge graph and clear the LLM response cache.
*   **Integration with LlamaIndex:** Use the llama-index library with ease.
*   **Graph Visualization:** Visualize the knowledge graph.
*   **Citation Functionality**: Ensure proper source attribution.
*   **Multimodal Document Processing:** Handle various document types.
...
from lightrag.llm.llama_index_impl import llama_index_complete_