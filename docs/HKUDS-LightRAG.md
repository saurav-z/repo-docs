...
**LightRAG empowers you to build smarter, more accurate, and context-aware LLM applications by seamlessly integrating information retrieval.** Explore the [original repository](https://github.com/HKUDS/LightRAG) for more details.
...
*   **Flexible Storage**: Supports a variety of storage backends (JSON, Postgres, Redis, Neo4j, MongoDB, Faiss, Qdrant).
*   **Advanced Retrieval Modes**: Offers hybrid and global retrieval for comprehensive results.
*   **Knowledge Graph Integration**: Built-in knowledge graph for enhanced context and relationships.
*   **Multimodal Document Processing**: Seamlessly integrates with [RAG-Anything](https://github.com/HKUDS/RAG-Anything) for processing PDFs, images, tables, and more.
*   **Comprehensive Data Management**:  Supports creating, editing, and deleting entities and relations.
*   **Easy Integration**: Provides both a Core and Server (API) for easy integration into your projects.
*   **Extensive Functionality**: Including batch insert, deletion by document ID, entity merging, and data export.
*   **Token Tracking**:  Monitor LLM token usage for cost optimization.
*   **Community Supported**: Active community via Discord and WeChat.
...
The LightRAG Server provides Web UI and API support for document indexing, knowledge graph exploration, and a simple RAG query interface. LightRAG Server also provide an Ollama compatible interfaces, aiming to emulate LightRAG as an Ollama chat model. This allows AI chat bot, such as Open WebUI, to access LightRAG easily.
...
*   **Increasing context size**
    ...
    *   **Setup `num_ctx` via Ollama API**
        ...
        rag = LightRAG(
            ...
            llm_model_func=ollama_model_complete,  # Use Ollama model for text generation
            llm_model_name='your_model_name', # Your model name
            llm_model_kwargs={"options": {"num_ctx": 32