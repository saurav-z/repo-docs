...
LightRAG is a powerful and efficient framework designed to simplify and accelerate Retrieval-Augmented Generation (RAG) for advanced question answering and knowledge graph applications.  [Visit the original repo](https://github.com/HKUDS/LightRAG) to learn more.
...
*   **Simplified RAG Implementation**:  Easy-to-use framework for building RAG systems.
*   **Fast Performance**: Optimized for speed and efficiency in both indexing and querying.
*   **Flexible Storage Options**: Supports various storage backends including JSON, PostgreSQL, Redis, Neo4J, Faiss, Memgraph, and MongoDB, allowing you to tailor your setup to your specific needs.
*   **Advanced Knowledge Graph Capabilities**:  Create, edit, and delete entities and relationships, as well as integration with custom knowledge graphs.
*   **Multimodal Document Processing**: Seamless integration with [RAG-Anything](https://github.com/HKUDS/RAG-Anything) to handle diverse document formats including PDFs, images, Office documents, and more.
*   **Comprehensive Deletion Functions**: Delete documents, entities, and relationships with efficient and consistent knowledge graph maintenance.
*   **Entity Merging**:  Merge multiple entities into a single entity, preserving and managing all relationships intelligently.
*   **Token Usage Tracking**: Monitor and manage LLM token consumption with the TokenTracker tool.
*   **Data Export**: Export knowledge graph data in various formats (CSV, Excel, Markdown, etc.)
*   **LLM and Embedding Injection**: Supports popular LLMs (OpenAI, Hugging Face, Ollama, LlamaIndex)
*   **Reranker Support**:  Integrates with rerank models (Cohere, Jina AI, Aliyun) to enhance retrieval quality.
*   **API and UI**: Provides both API and web UI support.
...
- See [LlamaIndex Documentation](lightrag/llm/Readme.md)