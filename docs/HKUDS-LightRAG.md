...
LightRAG empowers you to build powerful, efficient, and customizable Retrieval-Augmented Generation (RAG) systems for enhanced AI applications.  [Check out the original repo for more details!](https://github.com/HKUDS/LightRAG)
...
*   **Fast and Efficient RAG:** Build high-performance RAG systems with ease.
*   **Flexible Data Storage:** Supports various storage backends, including JSON, PostgreSQL, Neo4j, and more.
*   **Multimodal Document Processing:** Seamless integration with [RAG-Anything](https://github.com/HKUDS/RAG-Anything) for handling diverse document formats (PDF, DOCX, PPTX, etc.).
*   **Comprehensive KG Management:**  Create, edit, and delete entities and relations for enhanced knowledge graph integration.
*   **Entity Merging:** Effortlessly merge entities and their relationships.
*   **Token Usage Tracking:** Monitor and manage token consumption for cost control and performance optimization.
*   **Advanced Querying:**  Hybrid and customizable query modes for optimized retrieval.
*   **Extensive Documentation:**  Detailed examples and API reference to get you started quickly.
*   **Active Community Support:** Join the [Discord channel](https://discord.gg/yF2MmDJyGJ) for discussions and support.
...
*   **[2025.06.05]** 🎯📢 Enhanced multimodal data handling with [RAG-Anything](https://github.com/HKUDS/RAG-Anything) integration.
*   **[2025.03.18]** 🎯📢 Added citation functionality for proper source attribution.
...
*   **[2024.12.31]** 🎯📢 Added support for [deletion by document ID](#delete).
*   **[2024.11.25]** 🎯📢 Added support for [custom knowledge graphs](#insert-custom-kg).
*   **[2024.11.19]** 🎯📢 Comprehensive guide available on [LearnOpenCV](https://learnopencv.com/lightrag).
*   **[2024.11.11]** 🎯📢 Added support for [deleting entities by their names](#delete).
...
*   **[2024.10.29]** 🎯📢 Added support for multiple file types via `textract`.
...
The LightRAG Server provides a Web UI and API support. The Web UI facilitates document indexing, knowledge graph exploration, and a simple RAG query interface. LightRAG Server also provide an Ollama compatible interfaces, aiming to emulate LightRAG as an Ollama chat model. This allows AI chat bot, such as Open WebUI, to access LightRAG easily.
...
| **kv\_storage**          | `str`         | Storage type for documents and text chunks. Supported types: `JsonKVStorage`,`PGKVStorage`,`RedisKVStorage`,`MongoKVStorage`                                                                                          | `JsonKVStorage`                                                                                                                 |
| **vector\_storage**      | `str`         | Storage type for embedding vectors. Supported types: `NanoVectorDBStorage`,`PGVectorStorage`,`MilvusVectorDBStorage`,`ChromaVectorDBStorage`,`FaissVectorDBStorage`,`MongoVectorDBStorage`,`QdrantVectorDBStorage` | `NanoVectorDBStorage`                                                                                                           |
| **graph\_storage**       | `str`         | Storage type for graph edges and nodes. Supported types: `NetworkXStorage`,`Neo4JStorage`,`PGGraphStorage`,`AGEStorage`                                                                                        | `NetworkXStorage`                                                                                                               |
| **doc\_status\_storage** | `str`         | Storage type for documents process status. Supported types: `JsonDocStatusStorage`,`PGDocStatusStorage`,`MongoDocStatusStorage`                                                                                 | `JsonDocStatusStorage`                                                                                                           |
...
| **tiktoken\_model\_name**  | `str`         | If you're using the default Tiktoken tokenizer, this is the name of the specific Tiktoken model to use. This setting is ignored if you provide your own tokenizer.                                          | `gpt-4o-mini`                                                                                                                   |
...
| **summary\_max\_tokens**   | `int`         | Maximum tokens send to LLM to generate entity relation summaries                                                                                                                                            | `32000`（default value changed by env var MAX_TOKENS)                                                                            |
...
| **vector\_db\_storage\_cls\_kwargs** | `dict` | Additional parameters for vector database, like setting the threshold for nodes and relations retrieval                                                                                                       | cosine\_better\_than\_threshold: 0.2（default value changed by env var COSINE\_THRESHOLD)                                         |
...
| **addon\_params**          | `dict`        | Additional parameters, e.g., `{"example_number": 1, "language": "Simplified Chinese", "entity_types": ["organization", "person", "geo", "event"]}`: sets example limit, entiy/relation extraction output language | `example_number: all examples, language: English`                                                                                |
