...
# 🚀 LightRAG: Build Powerful RAG Applications with Speed and Simplicity

LightRAG is a simple yet powerful open-source framework designed to accelerate Retrieval-Augmented Generation (RAG) development.  Effortlessly integrate your knowledge into your LLM workflows.  [Explore the original repository on GitHub](https://github.com/HKUDS/LightRAG).
...
*   **Flexible Storage Options**:  Supports various storage backends (JSON, PostgreSQL, Neo4j, etc.).
*   **Modular Design**: Easily integrate with different LLMs, embedding models, and rerankers.
*   **Knowledge Graph Integration**: Built-in support for creating and managing knowledge graphs.
*   **Multimodal RAG with RAG-Anything**: Seamlessly process text, images, tables, and formulas.
*   **Comprehensive Data Management**: Provides features for inserting, editing, deleting, and merging entities/relations.
...
*   **[2025.06.05]**: LightRAG supports multimodal data handling through [RAG-Anything](https://github.com/HKUDS/RAG-Anything) integration.
...
*   **[2025.01.06]**:  PostgreSQL support added for Storage.
*   **[2024.12.31]**:  Document ID deletion added.
...
*   **[2024.11.11]**:  Entity deletion by name support.
*   **[2024.11.09]**:  Introduced the [LightRAG Gui](https://lightrag-gui.streamlit.app).
*   **[2024.11.04]**:  Neo4J support added for Storage.
*   **[2024.10.29]**:  Multiple file types support with `textract`.
*   **[2024.10.20]**:  Graph Visualization added.
*   **[2024.10.18]**:  Added a [LightRAG Introduction Video](https://youtu.be/oageL-1I0GE).
