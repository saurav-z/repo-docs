# Model Context Protocol Servers: Securely Connect LLMs to Tools and Data

**Unlock the power of Large Language Models by granting them controlled access to external tools and data sources with the Model Context Protocol (MCP).**  This repository provides reference implementations and community-built servers that demonstrate MCP's versatility and extensibility. [Learn more about the Model Context Protocol](https://modelcontextprotocol.io/).

**Get the original repository here: [https://github.com/modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers)**

## Key Features

*   **Reference Implementations:** Explore a variety of example MCP servers for common tasks, including file management, web content retrieval, and Git integration.
*   **Community-Driven:** Discover and leverage a growing ecosystem of community-contributed servers, expanding the capabilities of LLMs across diverse domains.
*   **Language Support:** Utilize readily available SDKs to build your own MCP servers in various languages:
...
*   **Secure and Controlled Access:** Design and implement secure and controlled access to tools and data for LLMs.

## Reference Servers

These servers offer practical examples of MCP implementation.

*   **Everything:** Comprehensive reference server with prompts, resources, and tools.
...
*   **Memory:** Leverages a knowledge graph for persistent memory.
...
The following servers are archived and can be found at the [servers-archived](https://github.com/modelcontextprotocol/servers-archived) repository.
...
These integrations are maintained by partners building production-ready MCP servers for their platforms.
...
*   **[Snyk](https://github.com/snyk/snyk-ls/blob