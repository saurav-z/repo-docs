...
**Unlock AI's potential by giving large language models (LLMs) secure and controlled access to tools and data with the Model Context Protocol (MCP).**  This repository provides reference implementations of MCP servers, offering a versatile framework for integrating LLMs with diverse data sources and services.  Explore the [original repository](https://github.com/modelcontextprotocol/servers) for more details.

## Key Features

*   **Secure Tool Access:** Grant LLMs controlled access to tools and data.
*   **Extensible Architecture:** Build servers for various functionalities using the MCP SDKs.
*   **Community-Driven:** Leverage a growing ecosystem of community-built servers.

## 🛠️ SDKs

Develop MCP servers with the following SDKs:
...
These servers demonstrate core MCP functionalities:

*   **Everything:** Reference and testing server with prompts, resources, and tools
*   **Fetch:** Web content retrieval and conversion for LLM usage
*   **Filesystem:** Secure file operations with access controls
*   **Git:** Git repository interaction (read, search, manipulate)
...
Historical reference implementations are available in the [servers-archived](https://github.com/modelcontextprotocol/servers-archived) repository, including:
...
Explore a growing number of community-contributed servers, including official integrations.
...
*   <img height="12" width="12" src="https://bldbl.dev/favico.png" alt="Buildable Logo" />**[Buildable](https://github.com/chunkydotdev/bldbl-mcp)** (TypeScript)
...
*   <img height="12" width="12" src="https://detailer.ginylil.com/favicon.ico" alt="Detailer Logo" /> **[Detailer](https://detailer.ginylil.com/)**
...
*   <img height="12" width="12" src="https://avatars.githubusercontent.com/u/65421071?s=200&v=4" alt="Drata Logo" /> **[Drata](https://drata.com/mcp)**
