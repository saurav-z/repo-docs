...
**Give your Large Language Models (LLMs) secure, controlled access to tools and data sources with Model Context Protocol (MCP).** This repository provides a collection of reference implementations, community-built servers, and resources to help you harness the power of MCP.

[**View the original repository on GitHub**](https://github.com/modelcontextprotocol/servers)

**Key Features:**

*   **Reference Implementations:** Explore working examples showcasing MCP's versatility.
*   **Community-Built Servers:** Discover a growing ecosystem of servers for diverse applications.
*   **Comprehensive SDKs:** Leverage official SDKs for various languages for easy integration:
    *   C# MCP SDK
    *   Java MCP SDK
    *   Kotlin MCP SDK
    *   Python MCP SDK
    *   Typescript MCP SDK
*   **Secure & Controlled Access:** Grant LLMs safe and managed access to tools and data.

## Getting Started

### Using MCP Servers

To use the reference servers:
...
1.  Use `uvx` (recommended) or `pip`. Install `uv`/`uvx` using the [installation instructions](https://docs.astral.sh/uv/getting-started/installation/) and `pip` from the [official guide](https://pip.pypa.io/en/stable/installation/)
...
Configure your MCP client (e.g., Claude Desktop) with the command to launch a server:
...
These servers demonstrate core MCP features and use the official SDKs:
...
*   <img height="12" width="12" src="https://www.