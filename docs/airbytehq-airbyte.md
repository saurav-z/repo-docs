...
## Airbyte: The Open-Source Data Integration Platform for Any Source to Any Destination

Airbyte is an open-source data integration platform that helps you move data from various sources to your data warehouses, lakes, and databases.  [Explore Airbyte on GitHub](https://github.com/airbytehq/airbyte).

### Key Features

*   **300+ Pre-built Connectors:** Access a vast catalog of connectors for APIs, databases, data warehouses, and data lakes, eliminating the need to build and maintain your own.
*   **Open-Source & Customizable:** Benefit from an open-source solution, allowing you to customize existing connectors and build your own.
*   **ELT Pipelines:** Easily build Extract, Load, and Transform (ELT) pipelines for efficient data integration.
*   **No-Code & Low-Code Options:** Quickly build connectors with the no-code Connector Builder or the low-code CDK.
...
*   **Active Community:** Join a thriving community on Slack and the Airbyte Forum.
