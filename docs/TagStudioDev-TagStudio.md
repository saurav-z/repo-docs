# TagStudio: Organize Your Files with Power and Flexibility

**Tired of disorganized files?** TagStudio is a user-focused document management system that empowers you to take control of your digital life. ([Original Repo](https://github.com/TagStudioDev/TagStudio))
...
TagStudio offers a tag-based system to organize your photos and files. It gives you freedom, flexibility and is not proprietary. It doesn't require sidecar files or disrupt your existing file structure.  Explore the full documentation and more at [docs.tagstud.io](https://docs.tagstud.io)!

> [!NOTE]
> The database backend has migrated from JSON to SQL! The previous warnings about the main branch being experimental and unsupported have now been removed, and any pre-existing library save files created with official TagStudio releases are able to be opened and migrated with the new v9.5+ releases!

> [!IMPORTANT]
> This project is still in an early state. Making frequent backups of your library save data is **always** important, regardless of what state the program is in.
>
...
*   **Tag-Based Organization:**  Create, manage, and apply custom tags to your files for powerful organization.
*   **Custom Metadata:**  Add and edit metadata like titles, descriptions, authors, and notes.
*   **Advanced Search:** Quickly find files using tags, file paths, file types, and media types with boolean operators.
*   **File Preview:** Preview most common file types directly within TagStudio.
*   **Folder to Tag Conversion:** Generate tags automatically from your existing folder structure.

## Goals

*   Achieve a portable, private, extensible, open-format, and feature-rich system for file organization.
*   Provide powerful methods for organization, notably the concept of tag inheritance.
*   Create an implementation of such a system that is resilient against a user’s actions outside the program.
...
1.  **The Concept:** Ensure the core idea of TagStudio persists.
2.  **The System:** Develop an interoperable metadata management system.
3.  **The Application:** Build a user-friendly application demonstrating the system's capabilities.
4.  The name.

## Contributing

Contribute to TagStudio! See the [contribution guidelines](/CONTRIBUTING.md) for more details.
