# TagStudio: Organize Your Files with Powerful, Tag-Based Metadata

**Tired of endless folders? TagStudio offers a user-focused document management system that puts you in control, ensuring your files are easily discoverable with a flexible and powerful tagging system.** ([Original Repo](https://github.com/TagStudioDev/TagStudio))
...
*   **Flexible Tagging:** Create custom tags with names, colors, aliases, and parent tags for powerful organization.
*   **Custom Metadata:** Add detailed information to your files, including names, descriptions, and more.
*   **Powerful Search:** Quickly find files using tags, file paths, types, and boolean operators.
*   **File Preview:** Preview a wide range of file types, including images, videos, and documents.
*   **No File Modification:** TagStudio does not touch, move, or modify your files unless explicitly directed.
*   **File Relinking:** Re-link moved or renamed files.
