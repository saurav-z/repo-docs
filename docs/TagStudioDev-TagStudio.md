...
Tired of clunky file organization? [TagStudio](https://github.com/TagStudioDev/TagStudio) offers a flexible, tag-based document management system that puts you in control.
...
TagStudio empowers you to organize your photos and files using a powerful tag-based system.  No proprietary formats, no messy sidecar files, and no changes to your existing file structure are needed. Explore the documentation at [docs.tagstud.io](https://docs.tagstud.io) to learn more!

> [!NOTE]
>  Thanks to our migration from JSON to SQL, TagStudio is more stable than ever!  Pre-existing library save files from official releases are fully supported in v9.5+.

> [!IMPORTANT]
>  This project is still in an early state and may have quirks. Backups of your data are important. TagStudio will never touch, move, or change your files unless explicitly requested. It also will not force you to recreate your tags with new releases.
...
*   **Tagging:** Organize files with custom tags, tag inheritance (parent tags), and tag groups.
*   **Metadata:** Add custom fields like names, descriptions, and author to your files.
*   **Search:**  Find files efficiently using tags, file paths, file types, and boolean operators.
*   **File Entry Management:** Preview and open files, and delete files from within TagStudio.
*   **Library Management:** Create libraries, refresh them, and relink moved or renamed files.
