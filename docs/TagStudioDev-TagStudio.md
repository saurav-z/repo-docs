...
Tired of endless scrolling and lost files? TagStudio is a user-focused document management system that empowers you to organize and rediscover your files with a flexible, tag-based approach. [Explore TagStudio on GitHub](https://github.com/TagStudioDev/TagStudio)
...
TagStudio offers a user-friendly way to manage your photos and files, avoiding proprietary formats and file structure overhauls.  **Read the documentation and learn more at [docs.tagstud.io](https://docs.tagstud.io)!**

> [!NOTE]
> We have migrated our database backend from JSON to SQL! Pre-existing library save files created with official TagStudio releases can be opened and migrated with the new v9.5+ releases!

> [!IMPORTANT]
> This project is still in an early state. Backups of your library save data are **always** important.
>
...
*   **Tagging and Metadata:** Create custom tags with colors, aliases, and parent tags, plus add descriptive metadata.
*   **Powerful Search:** Find files using tags, file paths, types, media types, and boolean operators.
*   **File Entry Management:** Preview and open files, and delete files from both your library and drive.
*   **Library Management:** Create and manage libraries based on a system directory, linking files to metadata.
...
Contribute to TagStudio! See the [contribution guidelines](/CONTRIBUTING.md) to get started.
...
Download executable builds for **Windows**, **macOS** _(Apple Silicon & Intel)_, and **Linux** from the [Releases](https://github.com/TagStudioDev/TagStudio/releases) page.  Portable releases are also available.
...
You'll need [FFmpeg](https://ffmpeg.org/download.html) installed for video thumbnails and playback. See our [FFmpeg Help](/docs/help/ffmpeg.md) guide if you encounter issues.
