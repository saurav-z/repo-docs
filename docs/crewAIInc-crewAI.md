...
# CrewAI: Build Autonomous AI Agents with Speed, Flexibility, and Control

**Unleash the power of multi-agent AI with CrewAI, the lightning-fast, flexible, and easy-to-use Python framework for building autonomous AI agents!**  [Visit the original repo](https://github.com/crewAIInc/crewAI).

## Key Features

*   **Standalone & Lean:** Independent of LangChain and other agent frameworks for faster execution and lighter resource demands.
*   **Crews**: Optimize for autonomy and collaborative intelligence, enabling agents to work together effectively.
*   **Flows**: Provides granular, event-driven control for precise task orchestration, perfect for complex scenarios.
*   **Deep Customization:** Tailor every aspect, from agent behavior to workflows.
*   **Seamless Integration:** Combine Crews (autonomy) and Flows (precision) for powerful, real-world automations.
*   **Reliable Performance**: Achieve consistent results across simple and complex tasks.
...
*   [Getting Started](#getting-started)
    ...
    *   [Setting Up Your Crew with the YAML Configuration](#getting-started-yaml)
    *   [Running Your Crew](#getting-started-running)
...
CrewAI empowers developers and enterprises to build intelligent automations that bridge the gap between simplicity, flexibility, and performance.
...
Follow the tutorials to set up and run your first CrewAI agents.
...
### <a id="getting-started-yaml"></a>Setting Up Your Crew with the YAML Configuration
...
### <a id="getting-started-running"></a>Running Your Crew
...
Explore real-world use cases in the [CrewAI-examples repo](https://github.com/crewAIInc/crewAI-examples?tab=readme-ov-file):
