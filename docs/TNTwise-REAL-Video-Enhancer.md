...
# REAL Video Enhancer: Enhance Your Videos with AI Power

**Breathe new life into your videos with REAL Video Enhancer, a versatile application for frame interpolation and upscaling, offering superior quality compared to older software.** ([Original Repo](https://github.com/TNTwise/REAL-Video-Enhancer))
...
**REAL Video Enhancer** is a powerful application designed to dramatically improve video quality through frame interpolation (e.g., increasing frame rate from 24fps to 48fps) and upscaling (enhancing resolution). It offers a user-friendly interface and supports various backends for optimal performance across different hardware configurations. It provides a modern alternative to legacy applications like Flowframes and enhancr, with support for Windows, Linux, and macOS.
...
*   ✅ **Cross-Platform Support:** Runs on Windows, Linux (Executable and Flatpak), and macOS.
*   ✅ **Discord Integration:** Includes Discord RPC support.
*   ✅ **Scene Change Detection:** Preserves sharp transitions by detecting scene changes.
*   ✅ **Real-Time Preview:** Shows the latest rendered frame for immediate feedback.
*   ✅ **Multiple Backends:** Supports TensorRT and NCNN for efficient performance on NVIDIA GPUs, Vulkan capable GPUs, and others.
...
| Styler00dollar     | RIFE ncnn models, Sudo Shuffle Span and benchmarking              | [styler00dollar](https://github.com/styler00dollar)        |
...
| ncnn python                     | Python bindings for NCNN Vulkan framework                                                  | [ncnn python](https://pypi.org/project/ncnn)                                                                 |
