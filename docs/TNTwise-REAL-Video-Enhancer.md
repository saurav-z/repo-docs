...
**REAL Video Enhancer** is a user-friendly application designed to bring your videos to life with AI-powered frame interpolation and upscaling.  [Visit the original repo for more details](https://github.com/TNTwise/REAL-Video-Enhancer).
...
*   **Frame Interpolation:** Smooths video by adding extra frames (e.g., 24fps to 48fps).
*   **Video Upscaling:** Enhances video resolution, making it sharper (e.g., 1080p to 4K).
*   **Scene Change Detection:** Preserves sharp transitions for a better viewing experience.
*   **Discord RPC Support:**  Integrates with Discord to showcase your video processing.
*   **Multiple Backends:** Utilize TensorRT, PyTorch (CUDA/ROCm), and NCNN for efficient processing across various GPUs.
*   **Preview Window:** See the latest processed frame instantly.
...
| PyTorch   | CUDA 12.6 and ROCm 6.2 GPUs   |
