...
Enhance the quality and frame rate of your videos with **REAL Video Enhancer**, a powerful and versatile application for Windows, Linux, and macOS.  [See the original repo here](https://github.com/TNTwise/REAL-Video-Enhancer).
...
*   **Frame Interpolation:** Smoothly increase frame rates (e.g., 24fps to 48fps).
*   **Video Upscaling:** Enhance video resolution and detail.
*   **Scene Change Detection:** Preserves sharp transitions.
*   **Real-time Preview:** See rendered frames as they are generated.
*   **Multiple Backends:**  TensorRT, PyTorch (CUDA/ROCm), and NCNN for efficient inference across different GPUs.
*   **Discord RPC Integration:** Display your video enhancement activity on Discord.
...
**REAL Video Enhancer** is a versatile video enhancement tool, offering frame interpolation and upscaling functionalities. It provides a user-friendly experience for improving video quality, and is an alternative to tools like Flowframes and enhancr.
...
| **OS**           | Windows 10/11 64bit / macOS 14+ | Any modern Linux distro (Ubuntu 22.04+) |
