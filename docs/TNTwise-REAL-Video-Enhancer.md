# REAL Video Enhancer: Upscale and Interpolate Your Videos with Ease

**Enhance your videos with cutting-edge AI!**  REAL Video Enhancer is a powerful application for upscaling and interpolating video frames, breathing new life into your old or low-resolution footage. ([Original Repository](https://github.com/TNTwise/REAL-Video-Enhancer))
...
[![Version](https://img.shields.io/badge/Version-2.3.4-blue)](https://github.com/TNTwise/REAL-Video-Enhancer/releases/latest)
[![downloads_total](https://img.shields.io/github/downloads/tntwise/REAL-Video-Enhancer/total.svg?label=downloads%40total)](https://github.com/TNTwise/REAL-Video-Enhancer/releases/latest)
...
*   **Frame Interpolation:** Smoothly increase your video's frame rate (e.g., 24fps to 48fps).
*   **Video Upscaling:** Enhance the resolution of your videos.
*   **Scene Change Detection:** Preserves sharp transitions during processing.
*   **Discord Rich Presence:** Displays your current activity in Discord.
*   **Backend Support:** Supports TensorRT, PyTorch (CUDA/ROCm), and NCNN for efficient inference across various GPUs.
*   **Preview Feature:** See the latest rendered frame in real-time.
*   **Flatpak Availability:** Easy installation and updates on Linux.
...
| Why does the optimization and inference fail?             | The most common reason an optimization can fail is **Limited VRAM**.  There is no fix for this except using CUDA or NCNN instead. |

### ROCm Related Questions

| Question                                       | Answer                                                                  |
|------------------------------------------------|-------------------------------------------------------------------------|
| Why am I getting (Insert Error here)?         | ROCm is buggy, please take a look at the [ROCm Help](https://github.com/TNTwise/REAL-Video-Enhancer/wiki/ROCm-Help). |

### NCNN Related Questions

| Question                                       | Answer                                                                                                |
|------------------------------------------------|-----------------------------------------------------------------------------------------------------|
| Why am I getting (Insert Vulkan Error here)?  | This usually is an OOM (Out Of Memory) error, which can indicate a weak iGPU or very old GPU.  I recommend trying out the [Colab Notebook](https://github.com/TNTwise/REAL-Video-Enhancer-Colab) instead. |
...
REAL Video Enhancer offers three build methods:
...
Explore REAL Video Enhancer with a [Colab Notebook](https://github.com/tntwise/REAL-Video-Enhancer-Colab).
...
| HolyWu            | TensorRT engine generation code, inference optimizations, and RIFE fixes     | https://github.com/HolyWu/               |
...
| rife ncnn vulkan python     | Python bindings for RIFE NCNN Vulkan implementation                         | https://pypi.org/project/rife-ncnn-vulkan                                                                                               |
