...
**Enhance video quality with ease! REAL Video Enhancer provides powerful AI-driven upscaling and frame interpolation, breathing new life into your older or lower-resolution videos.** ([Back to Original Repo](https://github.com/TNTwise/REAL-Video-Enhancer))
...
[![Version](https://img.shields.io/badge/Version-2.3.6-blue)](https://github.com/TNTwise/REAL-Video-Enhancer/releases/tag/2.3.6)
...
<a href="https://discord.gg/hwGHXga8ck">
    <img src="https://img.shields.io/discord/1041502781808328704?label=Discord" alt="Discord Shield"/>
</a>
<br/>
...
**REAL Video Enhancer** is a powerful and user-friendly application designed for video frame interpolation (creating smoother motion) and upscaling (increasing resolution) across multiple operating systems. It offers a modern alternative to outdated software, providing cutting-edge AI-powered video enhancement.
...
*   **Scene Change Detection:** Preserves sharp transitions by intelligently detecting and handling scene changes.
*   **Discord RPC Integration:** Display your video enhancement progress directly in your Discord status.
*   **Performance Optimization:** Utilizes TensorRT and NCNN for efficient inference, maximizing performance across a range of GPUs.
*   **Preview:** Provides a real-time preview of the processed frame.
