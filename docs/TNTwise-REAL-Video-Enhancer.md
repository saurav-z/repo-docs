...
**Transform your videos with AI!** REAL Video Enhancer is a powerful application for upscaling and frame interpolation, offering a user-friendly interface for Windows, Linux, and macOS.  [Explore the original repository](https://github.com/TNTwise/REAL-Video-Enhancer).
...
[![Discord](https://img.shields.io/discord/1041502781808328704?label=Discord)](https://discord.gg/hwGHXga8ck)
...
*   **Enhanced Frame Interpolation:** Smoothly increase frame rates for a cinematic experience.
*   **Advanced Upscaling:** Improve video resolution and detail.
*   **Scene Change Detection:** Preserves sharp transitions in your videos.
*   **Multiple Backend Support:**  Utilizes TensorRT and NCNN for efficient inference on various GPUs.
*   **Discord Rich Presence:** Integrates with Discord to display your video enhancement activity.
...
| Model        | Author    | Link                                                                         |
| :----------- | :-------- | :--------------------------------------------------------------------------- |
| RIFE 4.6-4.25 | Hzwer     | [Practical-RIFE](https://github.com/hzwer/Practical-RIFE)                  |
...
| Why is it failing to recognize installed backends? | REAL Video Enhancer uses PIP and portable python for inference, which can sometimes have installation issues. Please try reinstalling the app before creating an issue. |

### TensorRT Related Questions

| Question                                                                                                            | Answer                                                                                                                                                              |
| :------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Why does it take so long to begin inference?                                                                       | TensorRT uses advanced optimization at the beginning of inference based on your device; this is only done once per resolution of video inputted.                                |
| Why does the optimization and inference fail?                                                                       | The most common way an optimization can fail is **Limited VRAM**. There is no fix for this except using CUDA or NCNN instead.                                                      |
...
| FFMpeg Builds              | Pre-compiled builds of FFMpeg.                                                         | [FFmpeg Builds](https://github.com/BtbN/FFmpeg-Builds) (Windows/Linux), [mpv-mac](https://github.com/eko5624/mpv-mac) (MacOS)     |
...
| GIMM                       | Motion Modeling Realistic VFI                                                         | [GIMM-VFI](https://github.com/GSeanCDAT/GIMM-VFI)                                                                                     |
