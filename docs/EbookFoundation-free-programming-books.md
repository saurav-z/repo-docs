# Free Programming Books and Learning Resources: Your Ultimate Guide

**Looking to learn programming without breaking the bank?** This repository offers a comprehensive, community-driven collection of free programming books, courses, cheat sheets, and more, available in numerous languages. Explore the world of coding with resources for every skill level, from beginner to expert! Find the original repository at: [https://github.com/EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books)
...
*   **Extensive Resource Library:** Access a vast collection of free books, courses, cheat sheets, and interactive tutorials covering a wide array of programming languages and topics.
*   **Multilingual Support:** Explore resources in numerous languages, including English, Spanish, French, German, Chinese, and many more.
*   **Community-Driven & Updated:** Benefit from a constantly evolving resource, thanks to contributions from a global community of developers and educators.
*   **Easy Navigation:** Find resources quickly with a searchable database and well-organized categories.
*   **Actively Maintained:** Get the latest links to free programming resources.
...
*   **Access the static site:** [![https://ebookfoundation.github.io/free-programming-books/](https://img.shields.io/website?style=flat&logo=www&logoColor=whitesmoke&label=Static%20site&down_color=red&down_message=down&up_color=green&up_message=up&url=https%3A%2F%2Febookfoundation.github.io%2Ffree-programming-books%2F)](https://ebookfoundation.github.io/free-programming-books/).
...
This project, originally inspired by a StackOverflow answer, has evolved into one of the most popular repositories on GitHub, offering a treasure trove of free learning resources. The [Free Ebook Foundation](https://ebookfoundation.org) now administers the repo, dedicated to promoting free ebooks.
...
Help us expand this valuable resource! Please read the [CONTRIBUTING](docs/CONTRIBUTING.md) guidelines, and familiarize yourself with our [Code of Conduct](docs/CODE_OF_CONDUCT.md).
...
Find translated documents for contributing and code of conduct.
...
Help us by [contributing a translation](docs/CONTRIBUTING.md#help-out-by-contributing-a-translation)!
