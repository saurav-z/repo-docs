# Free Programming Books & Learning Resources - Your Gateway to Coding Knowledge 

> Unlock your coding potential with this comprehensive, community-curated list of free programming books, courses, cheat sheets, and more, available in multiple languages.
...
**Explore the full resource at:** [https://ebookfoundation.github.io/free-programming-books-search/](https://ebookfoundation.github.io/free-programming-books-search/)

**Access the static website directly at:** [https://ebookfoundation.github.io/free-programming-books/](https://ebookfoundation.github.io/free-programming-books/)

**Search for specific books or authors here:**
...
This project, originally inspired by StackOverflow, evolved into a thriving GitHub repository, now managed by the [Free Ebook Foundation](https://ebookfoundation.org). It's a collaborative effort providing a vast collection of free resources for programmers of all levels.  

**Key Features:**

*   **Extensive Resource Library:** Access books, courses, cheat sheets, and more.
*   **Multi-Language Support:** Find resources in numerous languages, including English, Spanish, French, Chinese, and many more.
*   **Community-Driven:** Contribute to the project and help expand the knowledge base.
*   **Well-Organized:** Resources are categorized by language, subject, and type for easy navigation.
*   **Active Community:** Benefit from a highly active open-source community on Github.
...
We welcome contributions!  Learn how to contribute by reading our [CONTRIBUTING](docs/CONTRIBUTING.md) guide. New to GitHub? Check out [HOWTO](docs/HOWTO.md)!  Please adhere to the [Code of Conduct](docs/CODE_OF_CONDUCT.md).
...
Explore learning materials by category:
...
Find translations for key documents and help us add more!
...
*   ... *[More languages](docs/README.md#translations)* ...
  ...
  Contribute to translations by following the instructions in the [CONTRIBUTING](docs/CONTRIBUTING.md) guide.

## License

All resources in this repository are licensed under the [CC BY License](LICENSE).

[Back to top](#free-programming-books--your-gateway-to-coding-knowledge)