...
**Looking to learn to code? This comprehensive repository, with resources in multiple languages, offers a vast collection of free programming books, courses, and interactive tutorials.**

[Link to Original Repository](https://github.com/EbookFoundation/free-programming-books)
...
Explore the resources with:

*   **Dynamic Search:** [https://ebookfoundation.github.io/free-programming-books-search/](https://ebookfoundation.github.io/free-programming-books-search/)
...
*   **Extensive Collection:** A vast and ever-growing library of free programming resources.
*   **Multilingual Support:** Resources available in numerous languages, breaking down language barriers to learning.
*   **Diverse Formats:** Includes books, online courses, cheat sheets, interactive tutorials, podcasts, and programming playgrounds.
*   **Community Driven:** Powered by a community of contributors, ensuring up-to-date and relevant content.
*   **Easy to Navigate:** Resources are organized by programming language, subject, and format for easy access.
*   **Searchable:**  A dynamic search tool makes it simple to find the specific resources you need.
*   **Actively Maintained:** Regularly updated and improved by the Free Ebook Foundation, a non-profit dedicated to promoting free educational resources.

## History & Organization

This repository started as a clone of a StackOverflow list and was moved to GitHub for collaborative maintenance, growing to be one of the most popular repositories on the platform. The [Free Ebook Foundation](https://ebookfoundation.org) now administers the repo.
...
We encourage your contributions! Read the [CONTRIBUTING](docs/CONTRIBUTING.md) guide.  New to GitHub? See [HOWTO](docs/HOWTO.md).  Adhere to the [Code of Conduct](docs/CODE_OF_CONDUCT.md) (translations available).
...
See translations of the Contributing, How-to, and Code of Conduct documents.
* English
...
Help by [contributing a translation](docs/CONTRIBUTING.md#help-out-by-contributing-a-translation)?
