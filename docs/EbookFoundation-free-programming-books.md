...
Discover a vast collection of **free programming books, courses, cheat sheets, and interactive tutorials** in multiple languages to kickstart your learning journey!  Explore the curated resources at [https://github.com/EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books).
...
**Access the Dynamic Search Site:** [https://ebookfoundation.github.io/free-programming-books-search/](https://ebookfoundation.github.io/free-programming-books-search/)
...
**View the Static Site:** [https://ebookfoundation.github.io/free-programming-books/](https://ebookfoundation.github.io/free-programming-books/)
...
*   **Extensive Collection:** Access a curated list of free programming books, courses, and resources.
*   **Multi-Language Support:** Learn in your preferred language with resources available in numerous languages.
*   **Categorized Content:** Browse resources organized by programming languages, subjects, and other categories.
*   **Interactive Tutorials:** Explore hands-on learning experiences with interactive programming tutorials.
*   **Community-Driven:** Benefit from a constantly updated and community-supported collection.
*   **Searchable Database:** Easily find the resources you need using the search functionality.

## About

This repository, now managed by the [Free Ebook Foundation](https://ebookfoundation.org), is a comprehensive, collaborative effort to provide a centralized and up-to-date resource for anyone seeking free learning materials in programming.  Originally inspired by a StackOverflow answer, it has grown to become one of the most popular repositories on GitHub.
...
We welcome contributions!  Please review the [CONTRIBUTING](docs/CONTRIBUTING.md) guide for details.  New to GitHub?  Check out the [HOWTO](docs/HOWTO.md) guide.  Please adhere to our [Code of Conduct](docs/CODE_OF_CONDUCT.md).
...
Access translated documentation to further your learning experience!
