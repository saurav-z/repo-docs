...
**Llama Stack simplifies AI application development by providing a unified API layer and a plugin architecture for flexible deployment and consistent behavior. Find the source code on [GitHub](https://github.com/meta-llama/llama-stack).**
...
*   **Unified API Layer:** Standardizes Inference, RAG, Agents, Tools, Safety, Evals, and Telemetry for consistent behavior across all your AI applications.
*   **Plugin Architecture:** Supports diverse API implementations across various environments (local, on-premise, cloud, and mobile).
...
*   **Standalone Applications:** Includes examples to help build production-grade AI applications with Llama Stack.

## What's New? - Llama 4 Support!

Llama Stack now fully supports the latest Llama 4 models!
...
Quickly get started with Llama Stack locally using this command:
...
*   **Robust Ecosystem:** Seamless integration with distribution partners.

## API Providers

Llama Stack supports a wide array of API providers, enabling you to choose the best fit for your needs. See the full list on the [Documentation](https://llama-stack.readthedocs.io/en/latest/providers/index.html) page.
...
Explore the full documentation for in-depth information:
