...
verl is a powerful, open-source library initiated by the ByteDance Seed team, designed for **flexible, efficient, and production-ready Reinforcement Learning (RL) training of Large Language Models (LLMs).**  [Check out the original repository!](https://github.com/volcengine/verl)
...
verl, born from the research behind the **[HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/abs/2409.19256v2)** paper, empowers you to train and fine-tune LLMs with RL, making it easier to implement complex dataflows for post-training and integration with existing LLM infrastructures.

**Key Features:**

*   **Flexible RL Algorithm Support**: Easily extend and implement various RL algorithms like PPO, GRPO, ReMax, and more. Build complex dataflows with a few lines of code.
*   **Seamless LLM Integration**: Compatible with existing LLM frameworks (FSDP, Megatron-LM, vLLM, SGLang, etc.) through modular APIs, decoupling computation and data dependencies.
*   **Optimized Resource Utilization**: Flexible device mapping and support for different GPU placements for efficient resource usage and scalability across clusters.
*   **Hugging Face Integration**: Ready to use with popular Hugging Face models.
*   **State-of-the-Art Performance**: Benefit from SOTA LLM training and inference integrations and SOTA RL throughput.
*   **Efficient Actor Model Resharding**: 3D-HybridEngine eliminates memory redundancy and reduces communication overhead.
...
*   **[2025/03]**: [DAPO](https://dapo-sia.github.io/) is the open-sourced SOTA RL algorithm that achieves 50 points on AIME 2024 based on the Qwen2.5-32B pre-trained model.
...
*   **[2025/04]** [VAPO](https://arxiv.org/pdf/2504.05118) (value-based augmented PPO) paper covers our latest RL method for reasoning models.
...
*   **[2025/02]** We presented verl in the <a href="https://lu.ma/ji7atxux">Bytedance/NVIDIA/Anyscale Ray Meetup</a>. See you in San Jose!
...
*   **[2024/12]** verl is presented at Ray Forward 2024. Slides available <a href="https://github.com/eric-haibin-lin/verl-community/blob/main/slides/Ray_Forward_2024_%E5%B7%AB%E9%94%A1%E6%96%8C.pdf">here</a>
*   **[2024/12]** The team presented <a href="https://neurips.cc/Expo/Conferences/2024/workshop/100677">Post-training LLMs: From Algorithms to Infrastructure</a> at NeurIPS 2024. <a href="https://github.com/eric-haibin-lin/verl-data/tree/neurips">Slides</a> and <a href="https://neurips.cc/Expo/Conferences/2024/workshop/100677">video</a> available.
*   **[2024/10]** verl is presented at Ray Summit. <a href="https://www.youtube.com/watch?v=MrhMcXkXvJU&list=PLzTswPQNepXntmT8jr9WaNfqQ60QwW7-U&index=37">Youtube video</a> available.
...
*   **Training Framework Support**: FSDP, FSDP2, and Megatron-LM.
*   **Inference Engine Support**: vLLM, SGLang, and HF Transformers.
*   **Model Compatibility**: Supports Hugging Face Transformers and Modelscope Hub models like Qwen-3, Qwen-2.5, Llama3.1, Gemma2, and DeepSeek-LLM.
*   **Training Methods**: Supervised fine-tuning and Reinforcement Learning with PPO, GRPO, ReMax, REINFORCE++, RLOO, PRIME, DAPO, DrGRPO, KL_Cov, Clip_Cov, etc.
    *   Supports model-based and function-based (verifiable) rewards for math and coding tasks.
    *   Compatible with vision-language models (VLMs) and multi-modal RL.
    *   Multi-turn conversations with tool calling.
*   **LLM Alignment**: Self-play preference optimization (SPPO) recipes.
*   **Performance Enhancements**: Flash attention 2, sequence packing, sequence parallelism (DeepSpeed Ulysses), LoRA, and Liger-kernel.
*   **Scalability**: Supports models up to 671B parameters and hundreds of GPUs with expert parallelism.
*   **Memory Optimization**: Multi-GPU LoRA RL.
*   **Experiment Tracking**: Integrated with wandb, swanlab, mlflow, and tensorboard.
...
Access comprehensive resources to get started with verl:
...
Fine-tune your RL models with the [performance tuning guide](https://verl.readthedocs.io/en/latest/perf/perf_tuning.html).

## Upgrade to vLLM >= v0.8.2

verl now supports vLLM>=0.8.2 when using FSDP as the training backend. Refer to [this document](https://github.com/volcengine/verl/blob/main/docs/README_vllm0.8.md) for the installation guide.

## Use Latest SGLang

SGLang is fully supported with verl, and SGLang RL Group is working extensively on building unique features. Refer to [this document](https://verl.readthedocs.io/en/latest/workers/sglang_worker.html) for the installation guide.
...
Cite the following papers if you use verl:
...
Consult the [contributions guide](CONTRIBUTING.md) to get involved in the project.

## About [ByteDance Seed Team](https://team.doubao.com/)

The ByteDance Seed Team is dedicated to crafting advanced AI foundation models. You can get to know Bytedance Seed better through the following channels👇
<div>
