...
## 🤖 Unlock the Power of LLMs: Build Custom Agents with MCP-Use!

[**MCP-Use**](https://github.com/mcp-use/mcp-use) is your open-source toolkit for connecting Language Learning Models (LLMs) to any Model Context Protocol (MCP) server, enabling you to build powerful, custom agents without relying on closed-source solutions.
...
*   ✅ **Connect Any LLM:** Compatible with any LangChain-supported LLM that supports tool calling (e.g., OpenAI, Anthropic, Groq, Llama).
*   ✅ **Open Source:** Build without relying on closed-source solutions.
*   ✅ **Ease of Use:** Create your first MCP-capable agent in just a few lines of code.
*   ✅ **Web & File Operation Tools:** Equip your agents with tools for web browsing, file operations, and more.
*   ✅ **Code Builder:** Generate starter code and explore MCP capabilities with the interactive code builder on [mcp-use.com](https://mcp-use.com/builder).
*   ✅ **HTTP Support:** Direct connection to MCP servers via HTTP.
*   ✅ **Dynamic Server Selection:** Intelligent agent server selection.
*   ✅ **Multi-Server Support:** Simultaneously use multiple MCP servers in a single agent.
*   ✅ **Tool Restrictions:** Restrict potentially dangerous tools.
*   ✅ **Custom Agents:** Build custom agents using the LangChain adapter.
*   ✅ **Sandboxed Execution:** Run MCP servers in an isolated environment using E2B for enhanced security and ease of setup.
*   ✅ **Direct Tool Calls:** Programmatically call MCP server tools without an LLM.
...
Install the appropriate LangChain provider for your chosen LLM.
...
For other providers, check the [LangChain chat models documentation](https://python.langchain.com/docs/integrations/chat/). Also, add your API keys for the provider you want to use to your `.env` file.
...
See the [Debugging Section](https://github.com/mcp-use/mcp-use#debugging)
