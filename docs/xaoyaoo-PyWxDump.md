# PyWxDump: Your Toolkit for Exploring and Backing Up WeChat Data

**PyWxDump is a powerful Python-based tool for extracting, decrypting, and backing up your WeChat data, providing insights and control over your chat history and account information.**

[View the PyWxDump Repository on GitHub](https://github.com/xaoyaoo/PyWxDump)
...
*   **Account Information Extraction:** Retrieve WeChat account details, including nicknames, accounts, phone numbers, emails, and database keys.
*   **Database Decryption:** Decrypt WeChat databases using the extracted keys.
*   **Chat History Viewing:**  View your chat history through a web interface.
*   **Data Export & Backup:** Export chat logs to HTML and CSV formats for easy backup and archiving.
*   **Remote Viewing:**  Enable remote access to your chat history.
*   **Minimalist Version:** A minimalist version of [pywxdumpmini](https://github.com/xaoyaoo/pywxdumpmini), providing key information.
...
## III. Disclaimer (VERY VERY VERY IMPORTANT ! ! ! ! ! !)
