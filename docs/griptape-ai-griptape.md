...
Griptape is a versatile Python framework designed to simplify the development of Generative AI (GenAI) applications, offering flexible abstractions for LLMs, RAG, and more.

**[Visit the Griptape Repository on GitHub](https://github.com/griptape-ai/griptape)**

**Key Features:**

*   **Modular Architecture:** Build complex applications with Agents, Pipelines, and Workflows.
*   **Flexible Task Management:** Utilize Tasks as building blocks to interact with Engines, Tools, and other Griptape components.
*   **Advanced Memory Management:** Implement Conversation, Task, and Meta Memory for enhanced context and user experience.
*   **Extensive Driver Support:** Integrate with various LLMs, databases, and services through an extensive set of drivers.
...
*   **Powerful Engines:** Leverage Engines like RAG, Extraction, Summary, and Eval for specific use cases.
*   **Extensible Tools:** Utilize built-in tools and create custom tools to interact with data and services.
*   **Additional Components:** Leverage Rulesets, Loaders, Artifacts, Chunkers, and Tokenizers for advanced control.
...
For detailed information on installation and usage, please consult the official [Griptape Documentation](https://docs.griptape.ai/).  You can also explore [Griptape Trade School](https://learn.griptape.ai/) for free online courses.
