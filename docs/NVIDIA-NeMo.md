...
NVIDIA NeMo is a powerful, cloud-native framework empowering researchers and developers to build, customize, and deploy state-of-the-art generative AI models.  [Visit the original repo](https://github.com/NVIDIA/NeMo) for the latest updates and contributions.

## Key Features

*   **Large Language Models (LLMs):** Build and customize powerful language models.
*   **Multimodal Models (MMs):** Explore the intersection of text, images, and more.
...
*   **Modular Design:** Benefit from PyTorch Lightning's modular abstractions for easier experimentation.
*   **Scalability:** Train models on thousands of GPUs with NeMo-Run and other distributed training techniques.
*   **FP8 Training:** Utilize NVIDIA Transformer Engine for FP8 training on NVIDIA Hopper GPUs.
